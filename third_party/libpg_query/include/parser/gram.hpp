...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TARGET_P = 686,                /* TARGET_P  */
    TEMP = 687,                    /* TEMP  */
    TEMPLATE = 688,                /* TEMPLATE  */
    TEMPORARY = 689,               /* TEMPORARY  */
    TEXT_P = 690,                  /* TEXT_P  */
    THEN = 691,                    /* THEN  */
    TIES = 692,                    /* TIES  */
    TIME = 693,                    /* TIME  */
    TIMESTAMP = 694,               /* TIMESTAMP  */
    TO = 695,                      /* TO  */
    TRAILING = 696,                /* TRAILING  */
    TRANSACTION = 697,             /* TRANSACTION  */
    TRANSFORM = 698,               /* TRANSFORM  */
    TREAT = 699,                   /* TREAT  */
    TRIGGER = 700,                 /* TRIGGER  */
    TRIM = 701,                    /* TRIM  */
    TRUE_P = 702,                  /* TRUE_P  */
    TRUNCATE = 703,                /* TRUNCATE  */
    TRUSTED = 704,                 /* TRUSTED  */
    TRY_CAST = 705,                /* TRY_CAST  */
    TYPE_P = 706,                  /* TYPE_P  */
    TYPES_P = 707,                 /* TYPES_P  */
    UNBOUNDED = 708,               /* UNBOUNDED  */
    UNCOMMITTED = 709,             /* UNCOMMITTED  */
    UNENCRYPTED = 710,             /* UNENCRYPTED  */
    UNION = 711,                   /* UNION  */
    UNIQUE = 712,                  /* UNIQUE  */
    UNKNOWN = 713,                 /* UNKNOWN  */
    UNLISTEN = 714,                /* UNLISTEN  */
    UNLOGGED = 715,                /* UNLOGGED  */
    UNPACK = 716,                  /* UNPACK  */
    UNPIVOT = 717,                 /* UNPIVOT  */
    UNTIL = 718,                   /* UNTIL  */
    UPDATE = 719,                  /* UPDATE  */
    ...
    VACUUM = 723,                  /* VACUUM  */
    VALID = 724,                   /* VALID  */
    VALIDATE = 725,                /* VALIDATE  */
    VALIDATOR = 726,               /* VALIDATOR  */
    VALUE_P = 727,                 /* VALUE_P  */
    VALUES = 728,                  /* VALUES  */
    VARCHAR = 729,                 /* VARCHAR  */
    VARIABLE_P = 730,              /* VARIABLE_P  */
