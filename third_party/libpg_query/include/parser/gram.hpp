...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SNAPSHOT = 642,                /* SNAPSHOT  */
    SOME = 643,                    /* SOME  */
    SQL_P = 644,                   /* SQL_P  */
    STABLE = 645,                  /* STABLE  */
    STANDALONE_P = 646,            /* STANDALONE_P  */
    START = 647,                   /* START  */
    STATEMENT = 648,               /* STATEMENT  */
    STATISTICS = 649,              /* STATISTICS  */
    STDIN = 650,                   /* STDIN  */
    STDOUT = 651,                  /* STDOUT  */
    STORAGE = 652,                 /* STORAGE  */
    STORED = 653,                  /* STORED  */
    STRICT_P = 654,                /* STRICT_P  */
    STRIP_P = 655,                 /* STRIP_P  */
    STRUCT = 656,                  /* STRUCT  */
    SUBSCRIPTION = 657,            /* SUBSCRIPTION  */
    SUBSTRING = 658,               /* SUBSTRING  */
    SUMMARIZE = 659,               /* SUMMARIZE  */
    SYMMETRIC = 660,               /* SYMMETRIC  */
    SYSID = 661,                   /* SYSID  */
    SYSTEM_P = 662,                /* SYSTEM_P  */
    TABLE = 663,                   /* TABLE  */
    TABLES = 664,                  /* TABLES  */
    TABLESAMPLE = 665,             /* TABLESAMPLE  */
    TABLESPACE = 666,              /* TABLESPACE  */
    TEMP = 667,                    /* TEMP  */
    TEMPLATE = 668,                /* TEMPLATE  */
    TEMPORARY = 669,               /* TEMPORARY  */
    TEXT_P = 670,                  /* TEXT_P  */
    THEN = 671,                    /* THEN  */
    TIES = 672,                    /* TIES  */
    TIME = 673,                    /* TIME  */
    TIMESTAMP = 674,               /* TIMESTAMP  */
    TO = 675,                      /* TO  */
    TRAILING = 676,                /* TRAILING  */
    TRANSACTION = 677,             /* TRANSACTION  */
    TRANSFORM = 678,               /* TRANSFORM  */
    TREAT = 679,                   /* TREAT  */
    TRIGGER = 680,                 /* TRIGGER  */
    TRIM = 681,                    /* TRIM  */
    TRUE_P = 682,                  /* TRUE_P  */
    TRUNCATE = 683,                /* TRUNCATE  */
    TRUSTED = 684,                 /* TRUSTED  */
    TRY_CAST = 685,                /* TRY_CAST  */
    TYPE_P = 686,                  /* TYPE_P  */
    TYPES_P = 687,                 /* TYPES_P  */
    UNBOUNDED = 688,               /* UNBOUNDED  */
    UNCOMMITTED = 689,             /* UNCOMMITTED  */
    UNENCRYPTED = 690,             /* UNENCRYPTED  */
    UNION = 691,                   /* UNION  */
    UNIQUE = 692,                  /* UNIQUE  */
    UNKNOWN = 693,                 /* UNKNOWN  */
    UNLISTEN = 694,                /* UNLISTEN  */
    UNLOGGED = 695,                /* UNLOGGED  */
    UNPIVOT = 696,                 /* UNPIVOT  */
    UNTIL = 697,                   /* UNTIL  */
    UPDATE = 698,                  /* UPDATE  */
    USE_P = 699,                   /* USE_P  */
    ...
    VACUUM = 702,                  /* VACUUM  */
    VALID = 703,                   /* VALID  */
    VALIDATE = 704,                /* VALIDATE  */
    VALIDATOR = 705,               /* VALIDATOR  */
    VALUE_P = 706,                 /* VALUE_P  */
    VALUES = 707,                  /* VALUES  */
    VARCHAR = 708,                 /* VARCHAR  */
    VARIADIC = 709,                /* VARIADIC  */
    VARYING = 710,                 /* VARYING  */
    VERBOSE = 711,                 /* VERBOSE  */
    VERSION_P = 712,               /* VERSION_P  */
    VIEW = 713,                    /* VIEW  */
    VIEWS = 714,                   /* VIEWS  */
    VIRTUAL = 715,                 /* VIRTUAL  */
    ...
    WRITE_P = 726,                 /* WRITE_P  */
    XML_P = 727,                   /* XML_P  */
    XMLATTRIBUTES = 728,           /* XMLATTRIBUTES  */
    XMLCONCAT = 729,               /* XMLCONCAT  */
    XMLELEMENT = 730,              /* XMLELEMENT  */
    XMLEXISTS = 731,               /* XMLEXISTS  */
    XMLFOREST = 732,               /* XMLFOREST  */
    XMLNAMESPACES = 733,           /* XMLNAMESPACES  */
    XMLPARSE = 734,                /* XMLPARSE  */
    XMLPI = 735,                   /* XMLPI  */
    XMLROOT = 736,                 /* XMLROOT  */
    XMLSERIALIZE = 737,            /* XMLSERIALIZE  */
    XMLTABLE = 738,                /* XMLTABLE  */
    YEAR_P = 739,                  /* YEAR_P  */
    YEARS_P = 740,                 /* YEARS_P  */
    YES_P = 741,                   /* YES_P  */
    ZONE = 742,                    /* ZONE  */
    NOT_LA = 743,                  /* NOT_LA  */
    NULLS_LA = 744,                /* NULLS_LA  */
    WITH_LA = 745,                 /* WITH_LA  */
    POSTFIXOP = 746,               /* POSTFIXOP  */
    UMINUS = 747                   /* UMINUS  */
  };
...
#line 604 "third_party/libpg_query/grammar/grammar_out.hpp"
