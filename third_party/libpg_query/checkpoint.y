 ...
 *
 *****************************************************************************/
stmt: CheckPointStmt VacuumStmt AnalyzeStmt
unreserved_keyword: CHECKPOINT VACUUM
...
%type <list> vacuum_relation_list opt_vacuum_relation_list
%type <boolean> opt_freeze opt_analyze opt_full
