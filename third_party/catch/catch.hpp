...
namespace Catch {
    ...
    struct IExceptionTranslator;
    using ExceptionTranslators = std::vector<duckdb_wrapped::std::unique_ptr<IExceptionTranslator const>>;
...
namespace Catch {
    ...
    namespace Generators {
        ...
        using GeneratorBasePtr = duckdb_wrapped::std::unique_ptr<GeneratorUntypedBase>;
...
namespace Generators {
    ...
    namespace pf{
        ...
        duckdb_wrapped::std::unique_ptr<T> make_unique( Args&&... args ) {
            return duckdb_wrapped::std::unique_ptr<T>(new T(std::forward<Args>(args)...));
        }
    }
    ...
    class GeneratorWrapper final {
        duckdb_wrapped::std::unique_ptr<IGenerator<T>> m_generator;
    public:
        GeneratorWrapper(duckdb_wrapped::std::unique_ptr<IGenerator<T>> generator):
...
namespace Generators {
    ...
    GeneratorWrapper<T> filter(Predicate&& pred, GeneratorWrapper<T>&& generator) {
        return GeneratorWrapper<T>(duckdb_wrapped::std::unique_ptr<IGenerator<T>>(pf::make_unique<FilterGenerator<T, Predicate>>(std::forward<Predicate>(pred), std::move(generator))));
    }
...
#undef CATCH_CONFIG_DEFAULT_REPORTER
    ...
    private:
        ...
        duckdb_wrapped::std::unique_ptr<IStream const> m_stream;
        TestSpec m_testSpec;
...
namespace Catch {
    ...
    using IStreamingReporterPtr = duckdb_wrapped::std::unique_ptr<IStreamingReporter>;
    ...
    struct CumulativeReporterBase : IStreamingReporter {
        ...
        void sectionStarting( SectionInfo const& sectionInfo ) override {
            ...
            if( m_sectionStack.empty() ) {
                if( !m_rootSection )
                    m_rootSection = duckdb_wrapped::std::make_shared<SectionNode>( incompleteStats );
                node = m_rootSection;
            }
            else {
                ...
                if( it == parentNode.childSections.end() ) {
                    node = duckdb_wrapped::std::make_shared<SectionNode>( incompleteStats );
        ...
        void testCaseEnded(TestCaseStats const& testCaseStats) override {
            auto node = duckdb_wrapped::std::make_shared<TestCaseNode>(testCaseStats);
        ...
        void testGroupEnded(TestGroupStats const& testGroupStats) override {
            auto node = duckdb_wrapped::std::make_shared<TestGroupNode>(testGroupStats);
            node->children.swap(m_testCases);
            m_testGroups.push_back(node);
        }
        void testRunEnded(TestRunStats const& testRunStats) override {
            auto node = duckdb_wrapped::std::make_shared<TestRunNode>(testRunStats);
...
namespace Catch {
    ...
    class ReporterRegistrar {
        ...
        class ReporterFactory : public IReporterFactory {
            ...
            IStreamingReporterPtr create( ReporterConfig const& config ) const override {
                return duckdb_wrapped::std::unique_ptr<T>( new T( config ) );
            }
    ...
    public:
        ...
        explicit ReporterRegistrar( std::string const& name ) {
            getMutableRegistryHub().registerReporter( name, duckdb_wrapped::std::make_shared<ReporterFactory>() );
        }
    };
    ...
    public:
        ...
        ListenerRegistrar() {
            getMutableRegistryHub().registerListener( duckdb_wrapped::std::make_shared<ListenerFactory>() );
        }
    };
}
...
namespace Catch {
    ...
    struct ConsoleReporter : StreamingReporterBase<ConsoleReporter> {
        duckdb_wrapped::std::unique_ptr<TablePrinter> m_tablePrinter;
...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            ...
            private:
                duckdb_wrapped::std::unique_ptr<callable> f;
            };
        } // namespace Detail
    } // namespace Benchmark
} // namespace Catch
...
namespace detail {
    ...
    public:
        ...
        :   m_ref( duckdb_wrapped::std::make_shared<BoundValueRef<T>>( ref ) ),
            m_hint( hint )
        {}

        template<typename LambdaT>
        ParserRefImpl( LambdaT const &ref, std::string const &hint )
        :   m_ref( duckdb_wrapped::std::make_shared<BoundLambda<LambdaT>>( ref ) ),
            m_hint(hint)
        {}
    ...
    class ExeName : public ComposableParserImpl<ExeName> {
        ...
        static auto makeRef(LambdaT const &lambda) -> std::shared_ptr<BoundValueRefBase> {
            return duckdb_wrapped::std::make_shared<BoundLambda<LambdaT>>( lambda) ;
        }

    public:
        ExeName() : m_name( duckdb_wrapped::std::make_shared<std::string>( "<executable>" ) ) {}

        explicit ExeName( std::string &ref ) : ExeName() {
            m_ref = duckdb_wrapped::std::make_shared<BoundValueRef<std::string>>( ref );
        }

        template<typename LambdaT>
        explicit ExeName( LambdaT const& lambda ) : ExeName() {
            m_ref = duckdb_wrapped::std::make_shared<BoundLambda<LambdaT>>( lambda );
        }
    ...
    public:
        template<typename LambdaT>
        explicit Opt( LambdaT const &ref ) : ParserRefImpl( duckdb_wrapped::std::make_shared<BoundFlagLambda<LambdaT>>( ref ) ) {}

        explicit Opt( bool &ref ) : ParserRefImpl( duckdb_wrapped::std::make_shared<BoundFlagRef>( ref ) ) {}
...
namespace Catch {
    ...
    namespace Detail {
        ...
        duckdb_wrapped::std::unique_ptr<EnumInfo> makeEnumInfo( StringRef enumName, StringRef allValueNames, std::vector<int> const& values );

        class EnumValuesRegistry : public IMutableEnumValuesRegistry {

            std::vector<duckdb_wrapped::std::unique_ptr<EnumInfo>> m_enumInfos;
...
namespace Catch {
    ...
    namespace Detail {
        ...
        duckdb_wrapped::std::unique_ptr<EnumInfo> makeEnumInfo( StringRef enumName, StringRef allValueNames, std::vector<int> const& values ) {
            duckdb_wrapped::std::unique_ptr<EnumInfo> enumInfo( new EnumInfo );
...
namespace Catch {
    ...
    private:
        std::vector<duckdb_wrapped::std::unique_ptr<IExceptionTranslator const>> m_translators;
    };
}
...
namespace Catch {
    ...
    void ExceptionTranslatorRegistry::registerTranslator( const IExceptionTranslator* translator ) {
        m_translators.push_back( duckdb_wrapped::std::unique_ptr<const IExceptionTranslator>( translator ) );
    }
        ...
        struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker {
            ...
            static GeneratorTracker& acquire( TrackerContext& ctx, TestCaseTracking::NameAndLocation const& nameAndLocation ) {
                ...
                if (currentTracker.nameAndLocation() == nameAndLocation) {
                    ...
                    tracker = duckdb_wrapped::std::make_shared<GeneratorTracker>( nameAndLocation, ctx, &currentTracker );
...
namespace Catch {
    ...
    namespace {
        ...
        IStreamingReporterPtr makeReporter(std::shared_ptr<Config> const& config) {
            ...
            auto ret = duckdb_wrapped::std::unique_ptr<IStreamingReporter>(new ListeningReporter);
    ...
    Config& Session::config() {
        if( !m_config )
            m_config = duckdb_wrapped::std::make_shared<Config>( m_configData );
        return *m_config;
    }
...
namespace Catch {
    ...
    namespace Detail { namespace {
        ...
        class DebugOutStream : public IStream {
            duckdb_wrapped::std::unique_ptr<StreamBufImpl<OutputDebugWriter>> m_streamBuf;
            mutable std::ostream m_os;
        public:
            DebugOutStream()
    ...
    struct StringStreams {
        std::vector<duckdb_wrapped::std::unique_ptr<std::ostringstream>> m_streams;
        std::vector<std::size_t> m_unused;
        std::ostringstream m_referenceStream; // Used for copy state/ flags from

        auto add() -> std::size_t {
            if( m_unused.empty() ) {
                m_streams.push_back( duckdb_wrapped::std::unique_ptr<std::ostringstream>( new std::ostringstream ) );
...
namespace TestCaseTracking {
    ...
    ITracker& TrackerContext::startRun() {
        m_rootTracker = duckdb_wrapped::std::make_shared<SectionTracker>( NameAndLocation( "{root}", CATCH_INTERNAL_LINEINFO ), *this, nullptr );
    ...
    SectionTracker& SectionTracker::acquire( TrackerContext& ctx, NameAndLocation const& nameAndLocation ) {
        ...
        if( ITrackerPtr childTracker = currentTracker.findChild( nameAndLocation ) ) {
            ...
            section = duckdb_wrapped::std::make_shared<SectionTracker>( nameAndLocation, ctx, &currentTracker );
...
namespace Catch {
    ...
    void TestSpecParser::addNamePattern() {
        ...
        if (!token.empty()) {
            TestSpec::PatternPtr pattern = duckdb_wrapped::std::make_shared<TestSpec::NamePattern>(token, m_substring);
            if (m_exclusion)
                pattern = duckdb_wrapped::std::make_shared<TestSpec::ExcludedPattern>(pattern);
    ...
    void TestSpecParser::addTagPattern() {
        ...
        if (!token.empty()) {
            ...
            if (token.size() > 1 && token[0] == '.') {
                ...
                TestSpec::PatternPtr pattern = duckdb_wrapped::std::make_shared<TestSpec::TagPattern>(".", m_substring);
                if (m_exclusion) {
                    pattern = duckdb_wrapped::std::make_shared<TestSpec::ExcludedPattern>(pattern);
                }
                m_currentFilter.m_patterns.push_back(pattern);
            ...
            TestSpec::PatternPtr pattern = duckdb_wrapped::std::make_shared<TestSpec::TagPattern>(token, m_substring);
