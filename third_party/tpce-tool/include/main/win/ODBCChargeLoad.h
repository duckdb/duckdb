...
class CODBCChargeLoad : public CDBLoader<CHARGE_ROW> {
  public:
	CODBCChargeLoad(char *szServer, char *szDatabase, char *szLoaderParams,
	                char *szTable = "CHARGE")
	    : CDBLoader<CHARGE_ROW>(szServer, szDatabase, szLoaderParams,
	                            szTable){};
	...
	virtual void BindColumns() {
		...
		if (bcp_bind(m_hdbc, (BYTE *)&m_row.CH_TT_ID, 0, SQL_VARLEN_DATA,
		             (BYTE *)"", 1, SQLCHARACTER, ++i) != SUCCEED ||
		    bcp_bind(m_hdbc, (BYTE *)&m_row.CH_C_TIER, 0, SQL_VARLEN_DATA, NULL,
		             0, SQLINT4, ++i) != SUCCEED ||
		    bcp_bind(m_hdbc, (BYTE *)&m_row.CH_CHRG, 0, SQL_VARLEN_DATA, NULL,
		             0, SQLFLT8, ++i) != SUCCEED)
