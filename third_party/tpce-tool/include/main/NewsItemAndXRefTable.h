...
namespace TPCE
{
    ...
    public:
            ...
            , m_iNewsItemsGeneratedForCompany(0)
        {
            ...
            //  News items will be dated up to iNewsItemMaxDaysAgo days back from that day.
            //
            ...
            m_iNewsCountForOneLoadUnit = dfm.CompanyFile().CalculateCompanyCount(iDefaultLoadUnitSize) * iNewsItemsPerCompany;
        };
        ...
        */
        ...
        const NEWS_ITEM_ROW &GetNewsItemRow() { return m_row.news_item; }
        const NEWS_XREF_ROW &GetNewsXRefRow() { return m_row.news_xref; }
    };
