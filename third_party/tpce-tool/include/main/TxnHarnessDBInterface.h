...
class CTradeStatusDBInterface {
  public:
	virtual void DoTradeStatusFrame1(const TTradeStatusFrame1Input *pIn,
	                                 TTradeStatusFrame1Output *pOut) = 0;
...
class CCustomerPositionDBInterface {
  public:
	virtual void
	DoCustomerPositionFrame1(const TCustomerPositionFrame1Input *pIn,
	                         TCustomerPositionFrame1Output *pOut) = 0;
	virtual void
	DoCustomerPositionFrame2(const TCustomerPositionFrame2Input *pIn,
...
class CBrokerVolumeDBInterface {
  public:
	virtual void DoBrokerVolumeFrame1(const TBrokerVolumeFrame1Input *pIn,
	                                  TBrokerVolumeFrame1Output *pOut) = 0;
...
class CSecurityDetailDBInterface {
  public:
	virtual void DoSecurityDetailFrame1(const TSecurityDetailFrame1Input *pIn,
	                                    TSecurityDetailFrame1Output *pOut) = 0;
...
class CMarketWatchDBInterface {
  public:
	virtual void DoMarketWatchFrame1(const TMarketWatchFrame1Input *pIn,
	                                 TMarketWatchFrame1Output *pOut) = 0;
...
class CTradeResultDBInterface {
  public:
	...
	virtual void DoTradeResultFrame6(const TTradeResultFrame6Input *pIn,
	                                 TTradeResultFrame6Output *pOut) = 0;
...
class CDataMaintenanceDBInterface {
  public:
	virtual void
	DoDataMaintenanceFrame1(const TDataMaintenanceFrame1Input *pIn) = 0;
