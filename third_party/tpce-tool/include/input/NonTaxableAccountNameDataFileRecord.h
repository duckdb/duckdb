...
namespace TPCE
{
    ...
    public:
        ...
        // NonTaxableAccountNameDataFileRecord(const NonTaxableAccountNameDataFileRecord&);
        // NonTaxableAccountNameDataFileRecord& operator=(const NonTaxableAccountNameDataFileRecord&);
        //
