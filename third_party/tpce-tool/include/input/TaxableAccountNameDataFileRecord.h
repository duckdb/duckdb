...
namespace TPCE
{
    ...
    public:
        ...
        // TaxableAccountNameDataFileRecord(const TaxableAccountNameDataFileRecord&);
        // TaxableAccountNameDataFileRecord& operator=(const TaxableAccountNameDataFileRecord&);
        //
