...
CCE::CCE( CCESUTInterface *pSUT, CBaseLogger *pLogger, const DataFileManager &dfm,
    ...
    , m_TxnInputGenerator( dfm, iConfiguredCustomerCount, iActiveCustomerCount, iScaleFactor, iDaysOfInitialTrades * HoursPerWorkDay, m_pLogger, &m_DriverCETxnSettings )
{
...
CCE::CCE( CCESUTInterface *pSUT, CBaseLogger *pLogger, const DataFileManager &dfm,
    ...
    , m_TxnInputGenerator( dfm, iConfiguredCustomerCount, iActiveCustomerCount, iScaleFactor, iDaysOfInitialTrades * HoursPerWorkDay, TxnInputRNGSeed, m_pLogger, &m_DriverCETxnSettings )
{
    m_pLogger->SendToLogger("CE object constructed using constructor 2 (valid for publication: NO).");
...
CCE::CCE( CCESUTInterface *pSUT, CBaseLogger *pLogger, const DataFileManager &dfm,
    ...
    , m_pLogger ( pLogger )
    , m_TxnMixGenerator( &m_DriverCETxnSettings, m_pLogger )
    , m_TxnInputGenerator(  dfm, iConfiguredCustomerCount, iActiveCustomerCount, iScaleFactor, iDaysOfInitialTrades * HoursPerWorkDay,
...
{
    m_pLogger->SendToLogger("CE object constructed using constructor 4 (valid for publication: NO).");
