...
rng_t Streams[] = {
    ...
    {0, 14, 0, 0, CR_REFUNDED_CUSTOMER_SK, CATALOG_RETURNS,
    ...
    {0, 28, 0, 0, CR_RETURNING_CUSTOMER_SK, CATALOG_RETURNS,
     CR_RETURNING_CUSTOMER_SK},
    {0, 14, 0, 0, CR_RETURNING_CDEMO_SK, CATALOG_RETURNS,
     CR_RETURNING_CDEMO_SK},
    {0, 14, 0, 0, CR_RETURNING_HDEMO_SK, CATALOG_RETURNS,
    ...
    {0, 0, 0, 0, CR_PRICING_NET_PAID_INC_TAX, CATALOG_RETURNS,
     CR_PRICING_NET_PAID_INC_TAX},
    {0, 0, 0, 0, CR_PRICING_FEE, CATALOG_RETURNS, CR_PRICING_FEE},
    {0, 0, 0, 0, CR_PRICING_EXT_SHIP_COST, CATALOG_RETURNS,
     CR_PRICING_EXT_SHIP_COST},
    {0, 0, 0, 0, CR_PRICING_REFUNDED_CASH, CATALOG_RETURNS,
     CR_PRICING_REFUNDED_CASH},
    {0, 0, 0, 0, CR_PRICING_REVERSED_CHARGE, CATALOG_RETURNS,
     CR_PRICING_REVERSED_CHARGE},
    {0, 0, 0, 0, CR_PRICING_STORE_CREDIT, CATALOG_RETURNS,
    ...
    {0, 0, 0, 0, CS_PRICING_WHOLESALE_COST, CATALOG_SALES,
    ...
    {0, 0, 0, 0, CS_PRICING_EXT_SALES_PRICE, CATALOG_SALES,
     CS_PRICING_EXT_SALES_PRICE},
    {0, 0, 0, 0, CS_PRICING_EXT_DISCOUNT_AMOUNT, CATALOG_SALES,
     CS_PRICING_EXT_DISCOUNT_AMOUNT},
    {0, 0, 0, 0, CS_PRICING_EXT_WHOLESALE_COST, CATALOG_SALES,
     CS_PRICING_EXT_WHOLESALE_COST},
    {0, 0, 0, 0, CS_PRICING_EXT_LIST_PRICE, CATALOG_SALES,
     CS_PRICING_EXT_LIST_PRICE},
    {0, 0, 0, 0, CS_PRICING_EXT_TAX, CATALOG_SALES, CS_PRICING_EXT_TAX},
    {0, 0, 0, 0, CS_PRICING_EXT_SHIP_COST, CATALOG_SALES,
     CS_PRICING_EXT_SHIP_COST},
    {0, 0, 0, 0, CS_PRICING_NET_PAID, CATALOG_SALES, CS_PRICING_NET_PAID},
    {0, 0, 0, 0, CS_PRICING_NET_PAID_INC_TAX, CATALOG_SALES,
     CS_PRICING_NET_PAID_INC_TAX},
    {0, 0, 0, 0, CS_PRICING_NET_PAID_INC_SHIP, CATALOG_SALES,
     CS_PRICING_NET_PAID_INC_SHIP},
    {0, 0, 0, 0, CS_PRICING_NET_PAID_INC_SHIP_TAX, CATALOG_SALES,
    ...
    {0, 1, 0, 0, CA_ADDRESS_STREET_NUM, CUSTOMER_ADDRESS,
     CA_ADDRESS_STREET_NUM},
    {0, 1, 0, 0, CA_ADDRESS_STREET_NAME1, CUSTOMER_ADDRESS,
     CA_ADDRESS_STREET_NAME1},
    {0, 1, 0, 0, CA_ADDRESS_STREET_TYPE, CUSTOMER_ADDRESS,
    ...
    {0, 1, 0, 0, CA_ADDRESS_GMT_OFFSET, CUSTOMER_ADDRESS,
    ...
    {0, 1, 0, 0, CA_ADDRESS_STREET_NAME2, CUSTOMER_ADDRESS,
    ...
    {0, 1, 0, 0, CD_EDUCATION_STATUS, CUSTOMER_DEMOGRAPHICS,
     CD_EDUCATION_STATUS},
    {0, 1, 0, 0, CD_PURCHASE_ESTIMATE, CUSTOMER_DEMOGRAPHICS,
    ...
    {0, 1, 0, 0, CD_DEP_EMPLOYED_COUNT, CUSTOMER_DEMOGRAPHICS,
     CD_DEP_EMPLOYED_COUNT},
    {0, 1, 0, 0, CD_DEP_COLLEGE_COUNT, CUSTOMER_DEMOGRAPHICS,
    ...
    {0, 1, 0, 0, W_STORE_ADDRESS_STREET_NAME1, STORE,
     W_STORE_ADDRESS_STREET_NAME1},
    {0, 1, 0, 0, W_STORE_ADDRESS_STREET_TYPE, STORE,
    ...
    {0, 0, 0, 0, SR_PRICING_NET_PAID_INC_TAX, STORE_RETURNS,
     SR_PRICING_NET_PAID_INC_TAX},
    {0, 0, 0, 0, SR_PRICING_FEE, STORE_RETURNS, SR_PRICING_FEE},
    {0, 0, 0, 0, SR_PRICING_EXT_SHIP_COST, STORE_RETURNS,
     SR_PRICING_EXT_SHIP_COST},
    {0, 0, 0, 0, SR_PRICING_REFUNDED_CASH, STORE_RETURNS,
     SR_PRICING_REFUNDED_CASH},
    {0, 0, 0, 0, SR_PRICING_REVERSED_CHARGE, STORE_RETURNS,
     SR_PRICING_REVERSED_CHARGE},
    {0, 0, 0, 0, SR_PRICING_STORE_CREDIT, STORE_RETURNS,
    ...
    {0, 0, 0, 0, SS_PRICING_WHOLESALE_COST, STORE_SALES,
    ...
    {0, 0, 0, 0, SS_PRICING_EXT_SALES_PRICE, STORE_SALES,
     SS_PRICING_EXT_SALES_PRICE},
    {0, 0, 0, 0, SS_PRICING_EXT_WHOLESALE_COST, STORE_SALES,
     SS_PRICING_EXT_WHOLESALE_COST},
    {0, 0, 0, 0, SS_PRICING_EXT_LIST_PRICE, STORE_SALES,
    ...
    {0, 0, 0, 0, SS_PRICING_NET_PAID_INC_TAX, STORE_SALES,
    ...
    {0, 16, 0, 0, WR_REFUNDED_CUSTOMER_SK, WEB_RETURNS,
    ...
    {0, 16, 0, 0, WR_RETURNING_CUSTOMER_SK, WEB_RETURNS,
    ...
    {0, 0, 0, 0, WR_PRICING_NET_PAID_INC_TAX, WEB_RETURNS,
     WR_PRICING_NET_PAID_INC_TAX},
    {0, 0, 0, 0, WR_PRICING_FEE, WEB_RETURNS, WR_PRICING_FEE},
    {0, 0, 0, 0, WR_PRICING_EXT_SHIP_COST, WEB_RETURNS,
     WR_PRICING_EXT_SHIP_COST},
    {0, 0, 0, 0, WR_PRICING_REFUNDED_CASH, WEB_RETURNS,
     WR_PRICING_REFUNDED_CASH},
    {0, 0, 0, 0, WR_PRICING_REVERSED_CHARGE, WEB_RETURNS,
    ...
    {0, 1, 0, 0, WS_PRICING_WHOLESALE_COST, WEB_SALES,
    ...
    {0, 0, 0, 0, WS_PRICING_EXT_DISCOUNT_AMT, WEB_SALES,
     WS_PRICING_EXT_DISCOUNT_AMT},
    {0, 0, 0, 0, WS_PRICING_EXT_SALES_PRICE, WEB_SALES,
     WS_PRICING_EXT_SALES_PRICE},
    {0, 0, 0, 0, WS_PRICING_EXT_WHOLESALE_COST, WEB_SALES,
     WS_PRICING_EXT_WHOLESALE_COST},
    {0, 0, 0, 0, WS_PRICING_EXT_LIST_PRICE, WEB_SALES,
    ...
    {0, 0, 0, 0, WS_PRICING_NET_PAID_INC_TAX, WEB_SALES,
     WS_PRICING_NET_PAID_INC_TAX},
    {0, 0, 0, 0, WS_PRICING_NET_PAID_INC_SHIP, WEB_SALES,
     WS_PRICING_NET_PAID_INC_SHIP},
    {0, 0, 0, 0, WS_PRICING_NET_PAID_INC_SHIP_TAX, WEB_SALES,
    ...
    {0, 1, 0, 0, S_CADR_ADDRESS_STREET_NUMBER, S_CUSTOMER_ADDRESS,
     S_CADR_ADDRESS_STREET_NUMBER},
    {0, 1, 0, 0, S_CADR_ADDRESS_STREET_NAME1, S_CUSTOMER_ADDRESS,
     S_CADR_ADDRESS_STREET_NAME1},
    {0, 1, 0, 0, S_CADR_ADDRESS_STREET_NAME2, S_CUSTOMER_ADDRESS,
     S_CADR_ADDRESS_STREET_NAME2},
    {0, 1, 0, 0, S_CADR_ADDRESS_STREET_TYPE, S_CUSTOMER_ADDRESS,
     S_CADR_ADDRESS_STREET_TYPE},
    {0, 1, 0, 0, S_CADR_ADDRESS_SUITE_NUM, S_CUSTOMER_ADDRESS,
     S_CADR_ADDRESS_SUITE_NUM},
    {0, 1, 0, 0, S_CADR_ADDRESS_CITY, S_CUSTOMER_ADDRESS, S_CADR_ADDRESS_CITY},
    {0, 1, 0, 0, S_CADR_ADDRESS_COUNTY, S_CUSTOMER_ADDRESS,
     S_CADR_ADDRESS_COUNTY},
    {0, 1, 0, 0, S_CADR_ADDRESS_STATE, S_CUSTOMER_ADDRESS,
     S_CADR_ADDRESS_STATE},
    {0, 1, 0, 0, S_CADR_ADDRESS_ZIP, S_CUSTOMER_ADDRESS, S_CADR_ADDRESS_ZIP},
    {0, 1, 0, 0, S_CADR_ADDRESS_COUNTRY, S_CUSTOMER_ADDRESS,
    ...
    {0, 1, 0, 0, S_CALL_CENTER_DIVISION_ID, S_CALL_CENTER,
     S_CALL_CENTER_DIVISION_ID},
    {0, 1, 0, 0, S_CALL_CENTER_OPEN_DATE, S_CALL_CENTER,
     S_CALL_CENTER_OPEN_DATE},
    {0, 0, 0, 0, S_CALL_CENTER_CLOSED_DATE, S_CALL_CENTER,
    ...
    {0, 1, 0, 0, S_CALL_CENTER_EMPLOYEES, S_CALL_CENTER,
    ...
    {0, 1, 0, 0, S_CALL_CENTER_MANAGER_ID, S_CALL_CENTER,
     S_CALL_CENTER_MANAGER_ID},
    {0, 1, 0, 0, S_CALL_CENTER_MARKET_ID, S_CALL_CENTER,
     S_CALL_CENTER_MARKET_ID},
    {0, 1, 0, 0, S_CALL_CENTER_ADDRESS_ID, S_CALL_CENTER,
     S_CALL_CENTER_ADDRESS_ID},
    {0, 1, 0, 0, S_CALL_CENTER_TAX_PERCENTAGE, S_CALL_CENTER,
    ...
    {0, 1, 0, 0, S_CORD_BILL_CUSTOMER_ID, S_CATALOG_ORDER,
     S_CORD_BILL_CUSTOMER_ID},
    {0, 2, 0, 0, S_CORD_SHIP_CUSTOMER_ID, S_CATALOG_ORDER,
    ...
    {0, 0, 0, 0, S_CLIN_LINE_NUMBER, S_CATALOG_ORDER_LINEITEM,
     S_CLIN_LINE_NUMBER},
    {0, 1, 0, 0, S_CLIN_PROMOTION_ID, S_CATALOG_ORDER_LINEITEM,
     S_CLIN_PROMOTION_ID},
    {0, 1, 0, 0, S_CLIN_QUANTITY, S_CATALOG_ORDER_LINEITEM, S_CLIN_QUANTITY},
    {0, 1, 0, 0, S_CLIN_COUPON_AMT, S_CATALOG_ORDER_LINEITEM,
     S_CLIN_COUPON_AMT},
    {0, 1, 0, 0, S_CLIN_WAREHOUSE_ID, S_CATALOG_ORDER_LINEITEM,
     S_CLIN_WAREHOUSE_ID},
    {0, 1, 0, 0, S_CLIN_SHIP_DATE, S_CATALOG_ORDER_LINEITEM, S_CLIN_SHIP_DATE},
    {0, 1, 0, 0, S_CLIN_CATALOG_ID, S_CATALOG_ORDER_LINEITEM,
     S_CLIN_CATALOG_ID},
    {0, 2, 0, 0, S_CLIN_CATALOG_PAGE_ID, S_CATALOG_ORDER_LINEITEM,
    ...
    {0, 1, 0, 0, S_CATALOG_PROMOTIONAL_ITEM_CATALOG_NUMBER,
     S_CATALOG_PROMOTIONAL_ITEM, S_CATALOG_PROMOTIONAL_ITEM_CATALOG_NUMBER},
    {0, 1, 0, 0, S_CATALOG_PROMOTIONAL_ITEM_CATALOG_PAGE_NUMBER,
     S_CATALOG_PROMOTIONAL_ITEM,
     S_CATALOG_PROMOTIONAL_ITEM_CATALOG_PAGE_NUMBER},
    {0, 1, 0, 0, S_CATALOG_PROMOTIONAL_ITEM_ITEM_ID, S_CATALOG_PROMOTIONAL_ITEM,
     S_CATALOG_PROMOTIONAL_ITEM_ITEM_ID},
    {0, 0, 0, 0, S_CATALOG_PROMOTIONAL_ITEM_PROMOTION_ID,
     S_CATALOG_PROMOTIONAL_ITEM, S_CATALOG_PROMOTIONAL_ITEM_PROMOTION_ID},
    {0, 9, 0, 0, S_CRET_CALL_CENTER_ID, S_CATALOG_RETURNS,
    ...
    {0, 0, 0, 0, S_CRET_RETURN_CUSTOMER_ID, S_CATALOG_RETURNS,
     S_CRET_RETURN_CUSTOMER_ID},
    {0, 0, 0, 0, S_CRET_REFUND_CUSTOMER_ID, S_CATALOG_RETURNS,
    ...
    {0, 0, 0, 0, S_CRET_REVERSED_CHARGE, S_CATALOG_RETURNS,
     S_CRET_REVERSED_CHARGE},
    {0, 0, 0, 0, S_CRET_MERCHANT_CREDIT, S_CATALOG_RETURNS,
    ...
    {0, 0, 0, 0, S_CRET_CATALOG_PAGE_ID, S_CATALOG_RETURNS,
    ...
    {0, 1, 0, 0, S_CUST_FIRST_PURCHASE_DATE, S_CUSTOMER,
     S_CUST_FIRST_PURCHASE_DATE},
    {0, 1, 0, 0, S_CUST_FIRST_SHIPTO_DATE, S_CUSTOMER,
    ...
    {0, 4, 0, 0, S_CUST_SECONDARY_MACHINE, S_CUSTOMER,
     S_CUST_SECONDARY_MACHINE},
    {0, 7, 0, 0, S_CUST_ADDRESS, S_CUSTOMER, S_CUST_ADDRESS},
    {0, 1, 0, 0, S_CUST_ADDRESS_STREET_NUM, S_CUSTOMER,
     S_CUST_ADDRESS_STREET_NUM},
    {0, 1, 0, 0, S_CUST_ADDRESS_STREET_NAME1, S_CUSTOMER,
     S_CUST_ADDRESS_STREET_NAME1},
    {0, 1, 0, 0, S_CUST_ADDRESS_STREET_NAME2, S_CUSTOMER,
     S_CUST_ADDRESS_STREET_NAME2},
    {0, 1, 0, 0, S_CUST_ADDRESS_STREET_TYPE, S_CUSTOMER,
     S_CUST_ADDRESS_STREET_TYPE},
    {0, 1, 0, 0, S_CUST_ADDRESS_SUITE_NUM, S_CUSTOMER,
    ...
    {0, 1, 0, 0, S_CUST_PURCHASE_ESTIMATE, S_CUSTOMER,
    ...
    {0, 1, 0, 0, S_PROMOTION_RESPONSE_TARGET, S_PROMOTION,
    ...
    {0, 1, 0, 0, S_PROMOTION_DISCOUNT_ACTIVE, S_PROMOTION,
     S_PROMOTION_DISCOUNT_ACTIVE},
    {0, 1, 0, 0, S_PROMOTION_DISCOUNT_PCT, S_PROMOTION,
    ...
    {0, 12, 0, 0, S_PLINE_PURCHASE_ID, S_PURCHASE_LINEITEM,
     S_PLINE_PURCHASE_ID},
    {0, 12, 0, 0, S_PLINE_NUMBER, S_PURCHASE_LINEITEM, S_PLINE_NUMBER},
    {0, 12, 0, 0, S_PLINE_PROMOTION_ID, S_PURCHASE_LINEITEM,
    ...
    {0, 12, 0, 0, S_PLINE_IS_RETURNED, S_PURCHASE_LINEITEM,
     S_PLINE_IS_RETURNED},
    ...
    {0, 1, 0, 0, S_SITM_PROMOTION_ID, S_STORE_PROMOTIONAL_ITEM,
     S_SITM_PROMOTION_ID},
    ...
    {0, 0, 0, 0, S_SRET_RETURN_QUANTITY, S_STORE_RETURNS,
    ...
    {0, 0, 0, 0, S_SRET_RETURN_SHIP_COST, S_STORE_RETURNS,
     S_SRET_RETURN_SHIP_COST},
    {0, 0, 0, 0, S_SRET_REFUNDED_CASH, S_STORE_RETURNS, S_SRET_REFUNDED_CASH},
    {0, 0, 0, 0, S_SRET_REVERSED_CHARGE, S_STORE_RETURNS,
     S_SRET_REVERSED_CHARGE},
    {0, 0, 0, 0, S_SRET_MERCHANT_CREDIT, S_STORE_RETURNS,
    ...
    {0, 12, 0, 0, S_WLIN_PROMOTION_ID, S_WEB_ORDER_LINEITEM,
     S_WLIN_PROMOTION_ID},
    ...
    {0, 12, 0, 0, S_WLIN_WAREHOUSE_ID, S_WEB_ORDER_LINEITEM,
     S_WLIN_WAREHOUSE_ID},
    ...
    {0, 1, 0, 0, S_WITM_PROMOTION_ID, S_WEB_PROMOTIONAL_ITEM,
     S_WITM_PROMOTION_ID},
