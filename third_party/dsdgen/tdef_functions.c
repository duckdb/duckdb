...
table_func_t w_tdef_funcs[] = {
    ...
    {"catalog_sales",
     ...
     vld_w_catalog_sales},
    {"customer", mk_w_customer, {pr_w_customer, ld_w_customer}, NULL},
    {"customer_address",
    ...
    {"income_band",
     ...
     NULL},
    {"inventory", mk_w_inventory, {pr_w_inventory, ld_w_inventory}, NULL},
    {"item", mk_w_item, {pr_w_item, ld_w_item}, NULL},
    {"promotion", mk_w_promotion, {pr_w_promotion, ld_w_promotion}, NULL},
    {"reason", mk_w_reason, {pr_w_reason, ld_w_reason}, NULL},
    {"ship_mode", mk_w_ship_mode, {pr_w_ship_mode, ld_w_ship_mode}, NULL},
    {"store", mk_w_store, {pr_w_store, ld_w_store}, NULL},
    {"store_returns",
     mk_w_store_returns,
    ...
    {"store_sales",
     ...
     vld_w_store_sales},
    {"time", mk_w_time, {pr_w_time, ld_w_time}, NULL},
    {"warehouse", mk_w_warehouse, {pr_w_warehouse, ld_w_warehouse}, NULL},
    {"web_page", mk_w_web_page, {pr_w_web_page, ld_w_web_page}, NULL},
    {"web_returns",
     mk_w_web_returns,
    ...
    {"web_sales",
     ...
     vld_web_sales},
    {"web_site", mk_w_web_site, {pr_w_web_site, ld_w_web_site}, NULL},
    {"dbgen_version",
     mk_dbgen_version,
