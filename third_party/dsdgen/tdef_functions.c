...
table_func_t s_tdef_funcs[] = {
    ...
    {"s_customer_address",
     mk_w_customer_address,
     {pr_s_customer_address, ld_s_customer_address},
     vld_s_customer_address},
    {"s_call_center",
     mk_s_call_center,
     {pr_s_call_center, ld_s_call_center},
     validateGeneric},
    {"s_catalog", mk_s_catalog, {pr_s_catalog, ld_s_catalog}, validateGeneric},
    {"s_catalog_order",
     mk_s_catalog_order,
     {pr_s_catalog_order, ld_s_catalog_order},
     vld_s_catalog_order},
    {"s_catalog_order_lineitem",
     mk_s_catalog_order_lineitem,
     {pr_s_catalog_order_lineitem, ld_s_catalog_order_lineitem},
     NULL},
    {"s_catalog_page",
     mk_s_catalog_page,
     {pr_s_catalog_page, ld_s_catalog_page},
     vld_s_catalog_page},
    {"s_catalog_promotional_item",
     mk_s_catalog_promotional_item,
     {pr_s_catalog_promotional_item, ld_s_catalog_promotional_item},
     validateGeneric},
    {"s_catalog_returns",
     mk_s_catalog_returns,
     {pr_s_catalog_returns, ld_s_catalog_returns},
     NULL},
    {"s_category",
     mk_s_category,
     {pr_s_category, ld_s_category},
     validateGeneric},
    {"s_class", mk_s_class, {pr_s_class, ld_s_class}, validateGeneric},
    {"s_company", mk_s_company, {pr_s_company, ld_s_company}, validateGeneric},
    {"s_customer",
     mk_s_customer,
     {pr_s_customer, ld_s_customer},
     validateGeneric},
    {"s_division",
     mk_s_division,
     {pr_s_division, ld_s_division},
     validateGeneric},
    {"s_inventory",
     mk_s_inventory,
     {pr_s_inventory, ld_s_inventory},
     validateGeneric},
    {"s_item", mk_s_item, {pr_s_item, ld_s_item}, vld_s_item},
    {"s_manager", mk_s_manager, {pr_s_manager, ld_s_manager}, validateGeneric},
    {"s_manufacturer",
     mk_s_manufacturer,
     {pr_s_manufacturer, ld_s_manufacturer},
     validateGeneric},
    ...
    {"s_promotion",
     mk_s_promotion,
     {pr_s_promotion, ld_s_promotion},
     vld_s_promotion},
    {"s_purchase",
     mk_s_purchase,
     {pr_s_purchase, ld_s_purchase},
     vld_s_purchase},
    ...
    {"s_store_promotional_item",
     mk_s_store_promotional_item,
     {pr_s_store_promotional_item, ld_s_store_promotional_item},
     validateGeneric},
    {"s_store_returns",
     mk_s_store_returns,
     {pr_s_store_returns, ld_s_store_returns},
     NULL},
    {"s_subcategory",
     mk_s_subcategory,
     {pr_s_subcategory, ld_s_subcategory},
     validateGeneric},
    {"s_subclass",
     mk_s_subclass,
     {pr_s_subclass, ld_s_subclass},
     validateGeneric},
    {"s_warehouse",
     mk_s_warehouse,
     {pr_s_warehouse, ld_s_warehouse},
     validateGeneric},
    {"s_web_order",
     mk_s_web_order,
     {pr_s_web_order, ld_s_web_order},
     vld_s_web_order},
    {"s_web_order_lineitem",
     mk_s_web_order_lineitem,
     {pr_s_web_order_lineitem, ld_s_web_order_lineitem},
     NULL},
    {"s_web_page",
     mk_s_web_page,
     {pr_s_web_page, ld_s_web_page},
     vld_s_web_page},
    {"s_web_promotional_item",
     mk_s_web_promotional_item,
     {pr_s_web_promotional_item, ld_s_web_promotional_item},
     validateGeneric},
    {"s_web_returns",
     mk_s_web_return,
     {pr_s_web_return, ld_s_web_return},
     NULL},
    {"s_web_site",
     mk_w_web_site,
     {pr_s_web_site, ld_s_web_site},
     validateGeneric},
