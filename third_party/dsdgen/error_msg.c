    ...
    Errors
        [MAX_ERROR +
         2] = {{
               ...
               {EFLG_NO_ARG,
                "Each workload definition must be in its own file"},
               {EFLG_NO_ARG,
                "Query Class name must be unique within a workload definition"},
               {EFLG_NO_ARG,
                "Query Template must be unique within a query class"},
               {EFLG_STR_ARG | EFLG_SYSTEM, "Open failed on '%s'"},
               {EFLG_STR_ARG,
                "%s  not yet implemented"}, /* QERR_NOT_IMPLEMENTED */
               ...
               {EFLG_STR_ARG,
                "Percentage is out of bounds in substitution '%s'"},
               ...
               {EFLG_NO_ARG,
                "Must set types and weights before defining names"},
               ...
               {EFLG_STR_ARG,
                "Table %s is being joined without an explicit rule"},
