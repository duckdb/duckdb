...
void __fastpackwithoutmask0(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask1(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask2(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask3(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask4(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask5(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask6(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask7(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask8(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask9(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask10(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask11(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask12(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask13(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask14(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask15(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask16(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask17(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask18(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask19(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask20(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask21(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask22(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask23(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask24(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask25(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask26(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask27(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask28(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask29(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask30(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask31(const uint32_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask32(const uint32_t *__restrict in, uint32_t *__restrict out);

void __fastpackwithoutmask0(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask1(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask2(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask3(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask4(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask5(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask6(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask7(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask8(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask9(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask10(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask11(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask12(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask13(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask14(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask15(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask16(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask17(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask18(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask19(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask20(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask21(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask22(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask23(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask24(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask25(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask26(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask27(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask28(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask29(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask30(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask31(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask32(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask33(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask34(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask35(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask36(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask37(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask38(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask39(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask40(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask41(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask42(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask43(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask44(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask45(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask46(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask47(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask48(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask49(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask50(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask51(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask52(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask53(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask54(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask55(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask56(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask57(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask58(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask59(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask60(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask61(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask62(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask63(const uint64_t *__restrict in, uint32_t *__restrict out);
void __fastpackwithoutmask64(const uint64_t *__restrict in, uint32_t *__restrict out);
} // namespace internal
} // namespace duckdb_fastpforlib
