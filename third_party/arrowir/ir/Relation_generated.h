...
enum RelationImpl : uint8_t {
  ...
  RelationImpl_MAX = RelationImpl_Table
};
...
inline const char *EnumNameRelationImpl(RelationImpl e) {
  if (flatbuffers::IsOutRange(e, RelationImpl_NONE, RelationImpl_Table)) return "";
  const size_t index = static_cast<size_t>(e);
...
struct Relation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::computeir::flatbuf::Table *impl_as_Table() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::RelationImpl_Table ? static_cast<const org::apache::arrow::computeir::flatbuf::Table *>(impl()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
