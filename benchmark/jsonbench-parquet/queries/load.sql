...
copy bluesky_raw to 'duckdb_benchmark_data/jsonbench_shredded.parquet' (shredding { j: 'STRUCT(did VARCHAR, kind VARCHAR, commit STRUCT(collection VARCHAR, operation VARCHAR))' });
