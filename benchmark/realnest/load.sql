...
create table run2012B_singleMu as select * from read_json('/Users/zuleykhapavlichenkova/Desktop/RealNest/scripts/tables_524288/hep-adl-ethz-Run2012B_SingleMu/data.jsonl');
...
FROM run2012B_singleMu order by all desc limit 300000; 