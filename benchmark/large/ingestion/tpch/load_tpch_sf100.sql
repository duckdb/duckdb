...
create view partsupp as select * from read_csv('duckdb_benchmark_data/tpch_csv_sf100/partsupp.csv');
create view partsupp as select * from read_parquet('duckdb_benchmark_data/tpch_parquet_sf100/partsupp.parquet');
create view partsupp as select * from partsupp;
