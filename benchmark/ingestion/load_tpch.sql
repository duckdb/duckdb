...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/customer.parquet');
...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/lineitem.parquet');
...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/nation.parquet');
...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/orders.parquet');
...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/part.parquet');
...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/partsupp.parquet');
...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/region.parquet');
...
SELECT *
FROM read_parquet('duckdb_benchmark_data/tpch_parquet/supplier.parquet');
