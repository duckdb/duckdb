CREATE TABLE hep_singleMu AS SELECT * FROM READ_PARQUET('/Users/zuleykhapavlichenkova/Desktop/iris-hep-benchmark-athena/data/Run2012B_SingleMu-restructured-1000.parquet');
