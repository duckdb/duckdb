...
FROM Segment
INNER JOIN
    connectsTo AS ct1 ON Segment.id = ct1.TrackElement1_id
INNER JOIN
    connectsTo AS ct2 ON ct1.TrackElement2_id = ct2.TrackElement1_id
INNER JOIN
    connectsTo AS ct3 ON ct2.TrackElement2_id = ct3.TrackElement1_id
INNER JOIN
    connectsTo AS ct4 ON ct3.TrackElement2_id = ct4.TrackElement1_id
INNER JOIN
    connectsTo AS ct5 ON ct4.TrackElement2_id = ct5.TrackElement1_id
INNER JOIN
