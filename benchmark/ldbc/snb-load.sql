...
COPY forum_person
FROM
    'PATHVAR/dynamic/forum_hasMember_person_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
...
COPY person_email
FROM
    'PATHVAR/dynamic/person_email_emailaddress_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
-- Populate person_tag table

COPY person_tag
FROM
    'PATHVAR/dynamic/person_hasInterest_tag_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
-- Populate knows table

COPY knows(k_creationdate, k_person1id, k_person2id)
FROM
    'PATHVAR/dynamic/person_knows_person_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
COPY knows(k_creationdate, k_person2id, k_person1id)
FROM
    'PATHVAR/dynamic/person_knows_person_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
...
COPY likes
FROM
    'PATHVAR/dynamic/person_likes_post_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
COPY likes
FROM
    'PATHVAR/dynamic/person_likes_comment_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
-- Populate person_language table

COPY person_language
FROM
    'PATHVAR/dynamic/person_speaks_language_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
-- Populate person_university table

COPY person_university
FROM
    'PATHVAR/dynamic/person_studyAt_organisation_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
-- Populate person_company table

COPY person_company
FROM
    'PATHVAR/dynamic/person_workAt_organisation_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
...
COPY message_tag
FROM
    'PATHVAR/dynamic/comment_hasTag_tag_0_0.csv.gz'(DELIMITER '|', HEADER, TIMESTAMPFORMAT '%Y-%m-%dT%H:%M:%S.%g+00:00');
