...
FROM comment;
CREATE TABLE
    forum(f_creationdate timestamp without time zone NOT NULL, --   f_deletiondate timestamp without time zone not null,

f_forumid bigint NOT NULL, f_title varchar NOT NULL, f_moderatorid bigint);
CREATE TABLE
    forum_person(fp_creationdate timestamp without time zone NOT NULL, -- fp_deletiondate timestamp without time zone not null,

fp_forumid bigint NOT NULL, fp_personid bigint NOT NULL);
CREATE TABLE
    forum_tag(ft_creationdate timestamp without time zone NOT NULL, --   ft_deletiondate timestamp without time zone not null,
...
CREATE TABLE
    person(p_creationdate timestamp without time zone NOT NULL, --   p_deletiondate timestamp without time zone not null,
...
CREATE TABLE
    person_email(pe_creationdate timestamp without time zone NOT NULL, --   pe_deletiondate timestamp without time zone not null,

pe_personid bigint NOT NULL, pe_email varchar NOT NULL);
CREATE TABLE
    person_tag(pt_creationdate timestamp without time zone NOT NULL, --   pt_deletiondate timestamp without time zone not null,

pt_personid bigint NOT NULL, pt_tagid bigint NOT NULL);
CREATE TABLE
    knows(k_creationdate timestamp without time zone NOT NULL, --   k_deletiondate timestamp without time zone not null,

k_person1id bigint NOT NULL, k_person2id bigint NOT NULL);
CREATE TABLE
    likes(l_creationdate timestamp without time zone NOT NULL, --   l_deletiondate timestamp without time zone not null,

l_personid bigint NOT NULL, l_messageid bigint NOT NULL);
CREATE TABLE
    person_language(plang_creationdate timestamp without time zone NOT NULL, --   plang_deletiondate timestamp without time zone not null,

plang_personid bigint NOT NULL, plang_language varchar NOT NULL);
CREATE TABLE
    person_university(pu_creationdate timestamp without time zone NOT NULL, --   pu_deletiondate timestamp without time zone not null,

pu_personid bigint NOT NULL, pu_organisationid bigint NOT NULL, pu_classyear int NOT NULL);
CREATE TABLE
    person_company(pc_creationdate timestamp without time zone NOT NULL, --   pc_deletiondate timestamp without time zone not null,
...
CREATE TABLE
    message_tag(mt_creationdate timestamp without time zone NOT NULL, --   mt_deletiondate timestamp without time zone not null,
