WITH top100_popular_forums AS (
        ...
        FROM forum_person fp, person p, place ci -- city
...
SELECT
    au.p_personid AS "person.id",
    au.p_firstname AS "person.firstName",
    au.p_lastname AS "person.lastName",
    au.p_creationdate -- a single person might be member of more than 1 of the top100 forums, so their posts should be DISTINCT counted
