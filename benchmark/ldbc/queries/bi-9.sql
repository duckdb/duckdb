...
FROM person p
LEFT JOIN post_all psa ON (1 = 1 AND p.p_personid = psa.psa_thread_creatorid AND psa_creationdate BETWEEN '2012-06-01T00:00:00' AND '2012-07-01T00:00:00')
