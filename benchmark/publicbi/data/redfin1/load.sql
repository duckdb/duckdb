...
COPY Redfin1_1 FROM 'benchmark/publicbi/Redfin1_1.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Redfin1_4 FROM 'benchmark/publicbi/Redfin1_4.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Redfin1_3 FROM 'benchmark/publicbi/Redfin1_3.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Redfin1_2 FROM 'benchmark/publicbi/Redfin1_2.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );