...
COPY Redfin2_2 FROM 'benchmark/publicbi/Redfin2_2.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Redfin2_3 FROM 'benchmark/publicbi/Redfin2_3.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Redfin2_1 FROM 'benchmark/publicbi/Redfin2_1.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );