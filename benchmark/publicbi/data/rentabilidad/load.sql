...
COPY Rentabilidad_6 FROM 'benchmark/publicbi/Rentabilidad_6.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_4 FROM 'benchmark/publicbi/Rentabilidad_4.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_2 FROM 'benchmark/publicbi/Rentabilidad_2.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_1 FROM 'benchmark/publicbi/Rentabilidad_1.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_9 FROM 'benchmark/publicbi/Rentabilidad_9.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_3 FROM 'benchmark/publicbi/Rentabilidad_3.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_5 FROM 'benchmark/publicbi/Rentabilidad_5.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_8 FROM 'benchmark/publicbi/Rentabilidad_8.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Rentabilidad_7 FROM 'benchmark/publicbi/Rentabilidad_7.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );