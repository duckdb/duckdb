...
COPY Medicare2_2 FROM 'benchmark/publicbi/Medicare2_2.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Medicare2_1 FROM 'benchmark/publicbi/Medicare2_1.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );