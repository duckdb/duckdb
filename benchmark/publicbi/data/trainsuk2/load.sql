...
COPY TrainsUK2_2 FROM 'benchmark/publicbi/TrainsUK2_2.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY TrainsUK2_1 FROM 'benchmark/publicbi/TrainsUK2_1.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );