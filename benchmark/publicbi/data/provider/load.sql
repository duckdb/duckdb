...
COPY Provider_8 FROM 'benchmark/publicbi/Provider_8.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Provider_5 FROM 'benchmark/publicbi/Provider_5.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Provider_6 FROM 'benchmark/publicbi/Provider_6.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Provider_3 FROM 'benchmark/publicbi/Provider_3.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Provider_7 FROM 'benchmark/publicbi/Provider_7.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Provider_1 FROM 'benchmark/publicbi/Provider_1.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Provider_2 FROM 'benchmark/publicbi/Provider_2.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY Provider_4 FROM 'benchmark/publicbi/Provider_4.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );