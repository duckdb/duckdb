...
COPY RealEstate1_1 FROM 'benchmark/publicbi/RealEstate1_1.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );
COPY RealEstate1_2 FROM 'benchmark/publicbi/RealEstate1_2.csv.gz' ( DELIMITER '|', NULL 'null', QUOTE '', ESCAPE '\\n' );