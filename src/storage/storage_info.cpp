...
static const StorageVersionInfo storage_version_info[] = {
    ...
    {"v0.10.3", 64}, {"v1.0.0", 64}, {"v1.1.0", 64}, {"v1.1.1", 64}, {"v1.1.2", 64},  {nullptr, 0}};
...
static const SerializationVersionInfo serialization_version_info[] = {
    {"v0.10.0", 1}, {"v0.10.1", 1}, {"v0.10.2", 1}, {"v0.10.3", 2}, {"v1.0.0", 2},
    {"v1.1.0", 3},  {"v1.1.1", 3},  {"v1.1.2", 3},  {"latest", 3},  {nullptr, 0}};
