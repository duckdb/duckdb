...
// Delete info
//===--------------------------------------------------------------------===//
ChunkDeleteInfo::ChunkDeleteInfo(VersionManager& manager, index_t start_row, ChunkInfoType type) : ChunkInfo(manager, start_row, type) {
...
// Insert info
//===--------------------------------------------------------------------===//
ChunkInsertInfo::ChunkInsertInfo(VersionManager& manager, index_t start_row) : ChunkDeleteInfo(manager, start_row, ChunkInfoType::INSERT_INFO) {
	for(index_t i = 0; i < STANDARD_VECTOR_SIZE; i++) {
