...
ValidityColumnData::ValidityColumnData(DatabaseInstance &db, idx_t column_index, idx_t start_row, ColumnData *parent)
    : ColumnData(db, column_index, start_row, LogicalType(LogicalTypeId::VALIDITY), parent) {
}
