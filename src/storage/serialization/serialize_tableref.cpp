...
void TableRef::FormatSerialize(Serializer &serializer) const {
...
unique_ptr<TableRef> TableRef::FormatDeserialize(Deserializer &deserializer) {
...
void BaseTableRef::FormatSerialize(Serializer &serializer) const {
...
unique_ptr<TableRef> BaseTableRef::FormatDeserialize(Deserializer &deserializer) {
...
void EmptyTableRef::FormatSerialize(Serializer &serializer) const {
	TableRef::FormatSerialize(serializer);
}

unique_ptr<TableRef> EmptyTableRef::FormatDeserialize(Deserializer &deserializer) {
	auto result = duckdb::unique_ptr<EmptyTableRef>(new EmptyTableRef());
	return std::move(result);
}

void ExpressionListRef::FormatSerialize(Serializer &serializer) const {
	TableRef::FormatSerialize(serializer);
...
unique_ptr<TableRef> ExpressionListRef::FormatDeserialize(Deserializer &deserializer) {
...
void JoinRef::FormatSerialize(Serializer &serializer) const {
	TableRef::FormatSerialize(serializer);
...
unique_ptr<TableRef> JoinRef::FormatDeserialize(Deserializer &deserializer) {
...
void PivotRef::FormatSerialize(Serializer &serializer) const {
	TableRef::FormatSerialize(serializer);
...
unique_ptr<TableRef> PivotRef::FormatDeserialize(Deserializer &deserializer) {
...
void SubqueryRef::FormatSerialize(Serializer &serializer) const {
	TableRef::FormatSerialize(serializer);
	serializer.WriteProperty(200, "subquery", subquery);
	serializer.WriteProperty(201, "column_name_alias", column_name_alias);
}

unique_ptr<TableRef> SubqueryRef::FormatDeserialize(Deserializer &deserializer) {
...
void TableFunctionRef::FormatSerialize(Serializer &serializer) const {
	TableRef::FormatSerialize(serializer);
	serializer.WriteProperty(200, "function", function);
	serializer.WriteProperty(201, "column_name_alias", column_name_alias);
}

unique_ptr<TableRef> TableFunctionRef::FormatDeserialize(Deserializer &deserializer) {
