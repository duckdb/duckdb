...
CSVReaderOptions CSVReaderOptions::Deserialize(Deserializer &deserializer) {
	...
	auto maximum_line_size = deserializer.ReadPropertyWithDefault<idx_t>(105, "maximum_line_size");
	...
	auto buffer_size = deserializer.ReadPropertyWithDefault<idx_t>(114, "buffer_size");
...
void MultiFileReaderOptions::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<bool>(107, "cache_union_readers", cache_union_readers);
}
...
MultiFileReaderOptions MultiFileReaderOptions::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<bool>(107, "cache_union_readers", result.cache_union_readers);
	return result;
}
