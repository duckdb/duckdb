...
void CreateSequenceInfo::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<bool>(207, "has_last_value", has_last_value);
	serializer.WritePropertyWithDefault<int64_t>(208, "last_value", last_value);
}
...
unique_ptr<CreateInfo> CreateSequenceInfo::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<bool>(207, "has_last_value", result->has_last_value);
	deserializer.ReadPropertyWithDefault<int64_t>(208, "last_value", result->last_value);
	return std::move(result);
}
