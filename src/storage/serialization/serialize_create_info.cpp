...
void CreateSequenceInfo::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<std::optional<int64_t>>(207, "last_value", last_value);
}
...
unique_ptr<CreateInfo> CreateSequenceInfo::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<std::optional<int64_t>>(207, "last_value", result->last_value);
	return std::move(result);
}
