...
unique_ptr<CreateInfo> CreateFeatureInfo::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithExplicitDefault<interval_t>(212, "schedule_interval", result->schedule_interval,
	                                                         interval_t());
	deserializer.ReadPropertyWithExplicitDefault<bool>(213, "schedule_enabled", result->schedule_enabled, true);
	deserializer.ReadPropertyWithExplicitDefault<interval_t>(214, "window_interval", result->window_interval,
	                                                         interval_t());
