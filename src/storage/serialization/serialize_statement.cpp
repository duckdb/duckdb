...
void SelectStatement::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<case_insensitive_map_t<idx_t>>(101, "param_map", named_param_map);
}
...
unique_ptr<SelectStatement> SelectStatement::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<case_insensitive_map_t<idx_t>>(101, "param_map", result->named_param_map);
	return result;
}
