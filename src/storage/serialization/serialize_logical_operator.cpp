...
void LogicalUpdate::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<idx_t>(208, "old_row_offset", old_row_offset, 0);
}
...
unique_ptr<LogicalOperator> LogicalUpdate::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithExplicitDefault<idx_t>(208, "old_row_offset", result->old_row_offset, 0);
	return std::move(result);
}
