...
void LogicalAggregate::Serialize(Serializer &serializer) const {
	...
	serializer.WriteProperty<TableIndex>(201, "group_index", group_index);
	serializer.WriteProperty<TableIndex>(202, "aggregate_index", aggregate_index);
	serializer.WriteProperty<TableIndex>(203, "groupings_index", groupings_index);
...
unique_ptr<LogicalOperator> LogicalAggregate::Deserialize(Deserializer &deserializer) {
	...
	auto group_index = deserializer.ReadProperty<TableIndex>(201, "group_index");
	auto aggregate_index = deserializer.ReadProperty<TableIndex>(202, "aggregate_index");
	auto result = duckdb::unique_ptr<LogicalAggregate>(new LogicalAggregate(group_index, aggregate_index, std::move(expressions)));
	deserializer.ReadProperty<TableIndex>(203, "groupings_index", result->groupings_index);
...
void LogicalAnyJoin::Serialize(Serializer &serializer) const {
	...
	serializer.WriteProperty<TableIndex>(201, "mark_index", mark_index);
...
unique_ptr<LogicalOperator> LogicalAnyJoin::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadProperty<TableIndex>(201, "mark_index", result->mark_index);
...
void LogicalCTERef::Serialize(Serializer &serializer) const {
	LogicalOperator::Serialize(serializer);
	serializer.WriteProperty<TableIndex>(200, "table_index", table_index);
	serializer.WriteProperty<TableIndex>(201, "cte_index", cte_index);
...
unique_ptr<LogicalOperator> LogicalCTERef::Deserialize(Deserializer &deserializer) {
	auto table_index = deserializer.ReadProperty<TableIndex>(200, "table_index");
	auto cte_index = deserializer.ReadProperty<TableIndex>(201, "cte_index");
...
void LogicalDelete::Serialize(Serializer &serializer) const {
	...
	serializer.WriteProperty<TableIndex>(201, "table_index", table_index);
...
unique_ptr<LogicalOperator> LogicalDelete::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadProperty<TableIndex>(201, "table_index", result->table_index);
...
void LogicalInsert::Serialize(Serializer &serializer) const {
	...
	serializer.WriteProperty<TableIndex>(204, "table_index", table_index);
	...
	serializer.WriteProperty<TableIndex>(214, "excluded_table_index", on_conflict_info.excluded_table_index);
...
unique_ptr<LogicalOperator> LogicalInsert::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadProperty<TableIndex>(204, "table_index", result->table_index);
	...
	deserializer.ReadProperty<TableIndex>(214, "excluded_table_index", result->on_conflict_info.excluded_table_index);
...
unique_ptr<LogicalOperator> LogicalMaterializedCTE::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadProperty<TableIndex>(200, "table_index", result->table_index);
...
void LogicalPivot::Serialize(Serializer &serializer) const {
	LogicalOperator::Serialize(serializer);
	serializer.WriteProperty<TableIndex>(200, "pivot_index", pivot_index);
...
unique_ptr<LogicalOperator> LogicalPivot::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadProperty<TableIndex>(200, "pivot_index", result->pivot_index);
...
void LogicalRecursiveCTE::Serialize(Serializer &serializer) const {
	...
	serializer.WriteProperty<TableIndex>(202, "table_index", table_index);
...
unique_ptr<LogicalOperator> LogicalRecursiveCTE::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadProperty<TableIndex>(202, "table_index", result->table_index);
...
void LogicalUnnest::Serialize(Serializer &serializer) const {
	LogicalOperator::Serialize(serializer);
	serializer.WriteProperty<TableIndex>(200, "unnest_index", unnest_index);
	serializer.WritePropertyWithDefault<vector<unique_ptr<Expression>>>(201, "expressions", expressions);
}

unique_ptr<LogicalOperator> LogicalUnnest::Deserialize(Deserializer &deserializer) {
	auto unnest_index = deserializer.ReadProperty<TableIndex>(200, "unnest_index");
...
void LogicalWindow::Serialize(Serializer &serializer) const {
	LogicalOperator::Serialize(serializer);
	serializer.WriteProperty<TableIndex>(200, "window_index", window_index);
	serializer.WritePropertyWithDefault<vector<unique_ptr<Expression>>>(201, "expressions", expressions);
}

unique_ptr<LogicalOperator> LogicalWindow::Deserialize(Deserializer &deserializer) {
	auto window_index = deserializer.ReadProperty<TableIndex>(200, "window_index");
