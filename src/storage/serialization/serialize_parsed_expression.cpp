...
void WindowExpression::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<WindowExclusion>(214, "exclude_clause", exclude_clause, WindowExclusion::NO_OTHER);
}
...
unique_ptr<ParsedExpression> WindowExpression::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<WindowExclusion>(214, "exclude_clause", result->exclude_clause, WindowExclusion::NO_OTHER);
	return std::move(result);
}
