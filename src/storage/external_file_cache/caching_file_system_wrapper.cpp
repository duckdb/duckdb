...
bool CachingFileSystemWrapper::RemoveDirectoryIfEmpty(const string &directory, optional_ptr<FileOpener> opener) {
	return underlying_file_system.RemoveDirectoryIfEmpty(directory, opener);
}
