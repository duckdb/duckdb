...
// (inlined from the former bitpacking_for_scan_impl.hpp: these scan functions depend on the
// file-local BitpackingScanState / DeltaDecode / metadata helpers defined above)
template <class T>
