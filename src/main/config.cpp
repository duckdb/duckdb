...
static const ConfigurationOption internal_options[] = {
    ...
    DUCKDB_GLOBAL(ArrowArrowLosslessConversionSetting),
    DUCKDB_GLOBAL_ALIAS("arrow_lossless_conversion", ArrowArrowLosslessConversionSetting),
    DUCKDB_GLOBAL_ALIAS("lossless_conversion_arrow", ArrowArrowLosslessConversionSetting),
    DUCKDB_GLOBAL(ArrowOffsetSizeSetting),
    DUCKDB_GLOBAL_ALIAS("arrow_large_buffer_size", ArrowOffsetSizeSetting),
    DUCKDB_GLOBAL(ArrowUseListViewSetting),
    DUCKDB_GLOBAL_ALIAS("arrow_output_list_view", ArrowUseListViewSetting),
    DUCKDB_GLOBAL(AutoinstallExtensionRepoSetting),
    DUCKDB_GLOBAL_ALIAS("autoinstall_extension_repository", AutoinstallExtensionRepoSetting),
    ...
    DUCKDB_GLOBAL(CheckpointAbortSetting),
    DUCKDB_GLOBAL_ALIAS("debug_checkpoint_abort", CheckpointAbortSetting),
    DUCKDB_GLOBAL(CheckpointWalSizeSetting),
    DUCKDB_GLOBAL_ALIAS("wal_autocheckpoint", CheckpointWalSizeSetting),
    DUCKDB_GLOBAL_ALIAS("checkpoint_threshold", CheckpointWalSizeSetting),
    DUCKDB_GLOBAL_LOCAL(CollationSetting),
    DUCKDB_GLOBAL_LOCAL_ALIAS("default_collation", CollationSetting),
    DUCKDB_GLOBAL(CustomExtensionRepoSetting),
    DUCKDB_GLOBAL_ALIAS("custom_extension_repository", CustomExtensionRepoSetting),
    ...
    DUCKDB_GLOBAL(DefaultBlockAllocSizeSetting),
    DUCKDB_GLOBAL_ALIAS("default_block_size", DefaultBlockAllocSizeSetting),
    ...
    DUCKDB_LOCAL(ExplainOutputTypeSetting),
    DUCKDB_LOCAL_ALIAS("explain_output", ExplainOutputTypeSetting),
    DUCKDB_GLOBAL(ExtensionDirectorySetting),
    DUCKDB_GLOBAL_ALIAS("temp_directory", ExtensionDirectorySetting),
    DUCKDB_GLOBAL(ExternalThreadsSetting),
    DUCKDB_LOCAL(FileSearchPathSetting),
    DUCKDB_LOCAL(ForceAsofIejoinSetting),
    DUCKDB_LOCAL_ALIAS("debug_asof_iejoin", ForceAsofIejoinSetting),
    DUCKDB_LOCAL_ALIAS("debug_force_asof_iejoin", ForceAsofIejoinSetting),
    DUCKDB_GLOBAL(ForceBitpackingModeSetting),
    DUCKDB_GLOBAL(ForceCompressionSetting),
    DUCKDB_LOCAL(ForceExternalSetting),
    DUCKDB_LOCAL_ALIAS("debug_force_external", ForceExternalSetting),
    ...
    DUCKDB_GLOBAL_ALIAS("maximum_vacuum_tasks", MaxVacuumTasksSetting),
    DUCKDB_GLOBAL(MaximumMemorySetting),
    DUCKDB_GLOBAL_ALIAS("memory_limit", MaximumMemorySetting),
    DUCKDB_GLOBAL_ALIAS("max_memory", MaximumMemorySetting),
    DUCKDB_GLOBAL(MaximumSwapSpaceSetting),
    DUCKDB_GLOBAL_ALIAS("max_temp_directory_size", MaximumSwapSpaceSetting),
    DUCKDB_GLOBAL_ALIAS("maximum_temp_directory_size", MaximumSwapSpaceSetting),
    DUCKDB_GLOBAL(MaximumThreadsSetting),
    DUCKDB_GLOBAL_ALIAS("worker_threads", MaximumThreadsSetting),
    DUCKDB_GLOBAL_ALIAS("threads", MaximumThreadsSetting),
    ...
    DUCKDB_LOCAL(PrintProgressBarSetting),
    DUCKDB_LOCAL_ALIAS("enable_progress_bar_print", PrintProgressBarSetting),
    DUCKDB_GLOBAL(ProduceArrowStringViewsSetting),
    DUCKDB_GLOBAL_ALIAS("produce_arrow_string_view", ProduceArrowStringViewsSetting),
    DUCKDB_LOCAL(ProfilerSaveLocationSetting),
    DUCKDB_LOCAL_ALIAS("profiling_output", ProfilerSaveLocationSetting),
    DUCKDB_LOCAL_ALIAS("profile_output", ProfilerSaveLocationSetting),
