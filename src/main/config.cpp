...
static const ConfigurationAlias setting_aliases[] = {
    DUCKDB_SETTING_ALIAS("memory_limit", 132),   DUCKDB_SETTING_ALIAS("null_order", 62),
    DUCKDB_SETTING_ALIAS("profile_output", 156), DUCKDB_SETTING_ALIAS("streaming_buffer_size", 133),
    DUCKDB_SETTING_ALIAS("user", 175),           DUCKDB_SETTING_ALIAS("wal_autocheckpoint", 31),
    DUCKDB_SETTING_ALIAS("worker_threads", 173), FINAL_ALIAS};
