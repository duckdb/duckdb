...
Appender::Appender(DuckDBConnection &connection, ClientContext &context, TableCatalogEntry *table_entry)
    : connection(connection), context(context), table_entry(table_entry), column(0) {
