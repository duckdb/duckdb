...
Value KafkaRedoLog::GetSetting(const ClientContext &context) {
	auto &config = DBConfig::GetConfig(context);
...
Value KafkaWriter::GetSetting(const ClientContext &context) {
	auto &config = DBConfig::GetConfig(context);
...
Value KafkaBootstrapServerAndPort::GetSetting(const ClientContext &context) {
	auto &config = DBConfig::GetConfig(context);
...
Value KafkaTopicName::GetSetting(const ClientContext &context) {
	auto &config = DBConfig::GetConfig(context);
...
Value LogExtension::GetSetting(const ClientContext &context) {
	auto &config = DBConfig::GetConfig(context);
