...
duckdb_state duckdb_register_aggregate_function(duckdb_connection connection, duckdb_aggregate_function function) {
	return duckdb_register_aggregate_function_or(connection, function, DUCKDB_ON_CONFLICT_ERROR);
}

duckdb_state duckdb_register_aggregate_function_or(duckdb_connection connection, duckdb_aggregate_function function,
	...
	return duckdb_register_aggregate_function_set_or(connection, reinterpret_cast<duckdb_aggregate_function_set>(&set),
	                                                 on_conflict);
}
...
duckdb_state duckdb_register_aggregate_function_set(duckdb_connection connection,
	...
	return duckdb_register_aggregate_function_set_or(connection, function_set, DUCKDB_ON_CONFLICT_ERROR);
}
duckdb_state duckdb_register_aggregate_function_set_or(duckdb_connection connection,
                                                       duckdb_aggregate_function_set function_set,
                                                       duckdb_on_conflict on_conflict) {
