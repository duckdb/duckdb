...
MetricType MetricsUtils::GetOptimizerMetricByType(OptimizerType type) {
	...
	case OptimizerType::ROW_GROUP_PRUNER:
		return MetricType::OPTIMIZER_ROW_GROUP_PRUNER;
	...
	case OptimizerType::WINDOW_SELF_JOIN:
		return MetricType::OPTIMIZER_WINDOW_SELF_JOIN;
	default:
		throw InternalException("Invalid OptimizerType");
	}
}
...
OptimizerType MetricsUtils::GetOptimizerTypeByMetric(MetricType type) {
	...
	case MetricType::OPTIMIZER_WINDOW_SELF_JOIN:
		return OptimizerType::WINDOW_SELF_JOIN;
	default:
