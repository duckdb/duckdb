...
profiler_settings_t MetricsUtils::GetOptimizerMetrics() {
	return {
	    ...
	    MetricsType::OPTIMIZER_MEASURE_AGG_REWRITER,
	};
}
...
MetricsType MetricsUtils::GetOptimizerMetricByType(OptimizerType type) {
	...
	case OptimizerType::MEASURE_AGG_REWRITER:
		return MetricsType::OPTIMIZER_MEASURE_AGG_REWRITER;
	default:
...
OptimizerType MetricsUtils::GetOptimizerTypeByMetric(MetricsType type) {
	...
	case MetricsType::OPTIMIZER_MEASURE_AGG_REWRITER:
		return OptimizerType::MEASURE_AGG_REWRITER;
	default:
