...
void VectorOperations::Sort(Vector &vector, sel_t *sel_vector, idx_t count, SelectionVector &result) {
// 	if (count == 0) {
// 		return;
// 	}
// 	vector.Normalify();
...
// 		assert(!FlatVector::IsNull(vector, i));
// 	}
// #endif
// 	switch (vector.type) {
// 	case TypeId::INT8:
...
void VectorOperations::Sort(Vector &vector, SelectionVector &result) {
	throw NotImplementedException("FIXME: sort");
	// vector.Normalify();
