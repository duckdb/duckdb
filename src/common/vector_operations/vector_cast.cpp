...
//	}
//	default:
//		return DefaultCasts::TryVectorNullCast(source, result, count, error_message);
//	}
//}
//
// template <class T>
...
// { 	if (result.GetType().id() != LogicalTypeId::BLOB) { 		throw TypeMismatchException(source.GetType(), result.GetType(),
