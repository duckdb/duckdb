...
bool VirtualFileSystem::RemoveDirectoryIfEmpty(const string &directory, optional_ptr<FileOpener> opener) {
	return FindFileSystem(directory, opener).RemoveDirectoryIfEmpty(directory, opener);
}
