...
BufferedDeserializer::BufferedDeserializer(data_t ptr, index_t data_size) : ptr(ptr), endptr(ptr + data_size) {
}
...
void BufferedDeserializer::Read(data_t buffer, index_t read_size) {
