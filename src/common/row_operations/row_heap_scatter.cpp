...
static void ComputeStringEntrySizes(CanonicalFormat &vdata, idx_t entry_sizes[], const idx_t ser_count,
...
static void ComputeListEntrySizes(Vector &v, CanonicalFormat &vdata, idx_t entry_sizes[], idx_t ser_count,
                                  const SelectionVector &sel, idx_t offset) {
...
void RowOperations::ComputeEntrySizes(Vector &v, CanonicalFormat &vdata, idx_t entry_sizes[], idx_t vcount,
...
template <class T>
static void TemplatedHeapScatter(CanonicalFormat &vdata, const SelectionVector &sel, idx_t count, idx_t col_idx,
...
static void HeapScatterListVector(Vector &v, idx_t vcount, const SelectionVector &sel, idx_t ser_count, idx_t col_no,
	...
	CanonicalFormat list_vdata;
	child_vector.ToCanonical(ListVector::GetListSize(v), list_vdata);
...
void RowOperations::HeapScatterVData(CanonicalFormat &vdata, PhysicalType type, const SelectionVector &sel,
