...
static void TemplatedMatchType(CanonicalFormat &col, Vector &rows, SelectionVector &sel, idx_t &count, idx_t col_offset,
...
template <class OP, bool NO_MATCH_SEL>
static void TemplatedMatchOp(Vector &vec, CanonicalFormat &col, const RowLayout &layout, Vector &rows,
...
static void TemplatedMatch(DataChunk &columns, CanonicalFormat col_data[], const RowLayout &layout, Vector &rows,
...
idx_t RowOperations::Match(DataChunk &columns, CanonicalFormat col_data[], const RowLayout &layout, Vector &rows,
                           const Predicates &predicates, SelectionVector &sel, idx_t count, SelectionVector *no_match,
                           idx_t &no_match_count) {
	if (no_match) {
