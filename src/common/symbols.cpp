...
//template class std::unordered_map<std::string, std::unique_ptr<AbstractCatalogEntry>>;
template class std::unordered_map<std::string, size_t>;
template class std::unordered_map<std::string, std::vector<std::string>>;
template class std::unordered_map<std::string, std::pair<size_t, AbstractExpression *>>;
