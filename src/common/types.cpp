...
LogicalType LogicalType::MEASURE_TYPE(const LogicalType &measure_output_type, std::string alias, unique_ptr<Expression> bound_measure_expression) {
	auto info = make_shared_ptr<MeasureTypeInfo>(measure_output_type, std::move(alias), std::move(bound_measure_expression));
