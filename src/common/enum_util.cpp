...
const StringUtil::EnumStringLiteral *GetMetricTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(MetricType::OPTIMIZER_DISTINCT_ON_HASH_JOIN_BUILD), "OPTIMIZER_DISTINCT_ON_HASH_JOIN_BUILD" },
...
const StringUtil::EnumStringLiteral *GetOptimizerTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(OptimizerType::DISTINCT_ON_HASH_JOIN_BUILD), "DISTINCT_ON_HASH_JOIN_BUILD" }
	};
	return values;
}
