...
ARTHandlingResult EnumUtil::FromString<ARTHandlingResult>(const char *value) {
	return static_cast<ARTHandlingResult>(
	    StringUtil::StringToEnum(GetARTHandlingResultValues(), 3, "ARTHandlingResult", value));
}
...
const char *EnumUtil::ToChars<DebugVectorVerification>(DebugVectorVerification value) {
	return StringUtil::EnumToString(GetDebugVectorVerificationValues(), 6, "DebugVectorVerification",
	                                static_cast<uint32_t>(value));
}
...
DebugVectorVerification EnumUtil::FromString<DebugVectorVerification>(const char *value) {
	return static_cast<DebugVectorVerification>(
	    StringUtil::StringToEnum(GetDebugVectorVerificationValues(), 6, "DebugVectorVerification", value));
}
...
const char *EnumUtil::ToChars<ExtraTypeInfoType>(ExtraTypeInfoType value) {
	return StringUtil::EnumToString(GetExtraTypeInfoTypeValues(), 13, "ExtraTypeInfoType",
	                                static_cast<uint32_t>(value));
}
...
ExtraTypeInfoType EnumUtil::FromString<ExtraTypeInfoType>(const char *value) {
	return static_cast<ExtraTypeInfoType>(
	    StringUtil::StringToEnum(GetExtraTypeInfoTypeValues(), 13, "ExtraTypeInfoType", value));
}
...
FileGlobOptions EnumUtil::FromString<FileGlobOptions>(const char *value) {
	return static_cast<FileGlobOptions>(
	    StringUtil::StringToEnum(GetFileGlobOptionsValues(), 2, "FileGlobOptions", value));
}
...
const StringUtil::EnumStringLiteral *GetOptimizerTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
	    ...
	    {static_cast<uint32_t>(OptimizerType::MEASURE_AGG_REWRITER), "MEASURE_AGG_REWRITER"}};
	return values;
}
...
const char *EnumUtil::ToChars<PartitionSortStage>(PartitionSortStage value) {
	return StringUtil::EnumToString(GetPartitionSortStageValues(), 6, "PartitionSortStage",
	                                static_cast<uint32_t>(value));
}

template <>
PartitionSortStage EnumUtil::FromString<PartitionSortStage>(const char *value) {
	return static_cast<PartitionSortStage>(
	    StringUtil::StringToEnum(GetPartitionSortStageValues(), 6, "PartitionSortStage", value));
}
...
ProfilerPrintFormat EnumUtil::FromString<ProfilerPrintFormat>(const char *value) {
	return static_cast<ProfilerPrintFormat>(
	    StringUtil::StringToEnum(GetProfilerPrintFormatValues(), 6, "ProfilerPrintFormat", value));
}
