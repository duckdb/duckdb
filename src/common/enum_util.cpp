...
const StringUtil::EnumStringLiteral *GetMetricTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(MetricType::OPTIMIZER_DISJUNCTIVE_JOIN_REWRITER), "OPTIMIZER_DISJUNCTIVE_JOIN_REWRITER" },
...
const char* EnumUtil::ToChars<MetricType>(MetricType value) {
	return StringUtil::EnumToString(GetMetricTypeValues(), 79, "MetricType", static_cast<uint32_t>(value));
}

template<>
MetricType EnumUtil::FromString<MetricType>(const char *value) {
	return static_cast<MetricType>(StringUtil::StringToEnum(GetMetricTypeValues(), 79, "MetricType", value));
}
