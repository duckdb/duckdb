...
SampleMethod EnumUtil::StringToEnum<SampleMethod>(const char *value) {
	if (StringUtil::Equals(value, "SYSTEM_SAMPLE")) {
		return SampleMethod::SYSTEM_SAMPLE;
	}
	if (StringUtil::Equals(value, "BERNOULLI_SAMPLE")) {
...
LogicalTypeId EnumUtil::StringToEnum<LogicalTypeId>(const char *value) {
	...
	if (StringUtil::Equals(value, "SQLNULL")) {
	...
	if (StringUtil::Equals(value, "TIMESTAMP_SEC")) {
	...
	if (StringUtil::Equals(value, "TIMESTAMP_TZ")) {
		return LogicalTypeId::TIMESTAMP_TZ;
	}
	if (StringUtil::Equals(value, "TIME_TZ")) {
...
JoinType EnumUtil::StringToEnum<JoinType>(const char *value) {
	...
	if (StringUtil::Equals(value, "OUTER")) {
...
OrderType EnumUtil::StringToEnum<OrderType>(const char *value) {
	...
	if (StringUtil::Equals(value, "ORDER_DEFAULT")) {
		return OrderType::ORDER_DEFAULT;
	}
	if (StringUtil::Equals(value, "ASCENDING")) {
		return OrderType::ASCENDING;
	}
	if (StringUtil::Equals(value, "DESCENDING")) {
