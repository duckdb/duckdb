...
namespace duckdb {
    ...
    ARTConflictType EnumUtil::FromString<ARTConflictType>(const char *value) {
        return static_cast<ARTConflictType>(StringUtil::StringToEnum(GetARTConflictTypeValues(), 3, "ARTConflictType",
                                                                     value));
    }
    ...
    const char *EnumUtil::ToChars<ARTHandlingResult>(ARTHandlingResult value) {
        return StringUtil::EnumToString(GetARTHandlingResultValues(), 4, "ARTHandlingResult",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ARTHandlingResult EnumUtil::FromString<ARTHandlingResult>(const char *value) {
        return static_cast<ARTHandlingResult>(StringUtil::StringToEnum(GetARTHandlingResultValues(), 4,
                                                                       "ARTHandlingResult", value));
    }
    ...
    ARTScanHandling EnumUtil::FromString<ARTScanHandling>(const char *value) {
        return static_cast<ARTScanHandling>(StringUtil::StringToEnum(GetARTScanHandlingValues(), 2, "ARTScanHandling",
                                                                     value));
    }
    ...
    AggregateCombineType EnumUtil::FromString<AggregateCombineType>(const char *value) {
        return static_cast<AggregateCombineType>(StringUtil::StringToEnum(
            GetAggregateCombineTypeValues(), 2, "AggregateCombineType", value));
    }
    ...
    AggregateDistinctDependent EnumUtil::FromString<AggregateDistinctDependent>(const char *value) {
        return static_cast<AggregateDistinctDependent>(StringUtil::StringToEnum(
            GetAggregateDistinctDependentValues(), 2, "AggregateDistinctDependent", value));
    }
    ...
    const char *EnumUtil::ToChars<AggregateHandling>(AggregateHandling value) {
        return StringUtil::EnumToString(GetAggregateHandlingValues(), 3, "AggregateHandling",
                                        static_cast<uint32_t>(value));
    }

    template<>
    AggregateHandling EnumUtil::FromString<AggregateHandling>(const char *value) {
        return static_cast<AggregateHandling>(StringUtil::StringToEnum(GetAggregateHandlingValues(), 3,
                                                                       "AggregateHandling", value));
    }
    ...
    AggregateOrderDependent EnumUtil::FromString<AggregateOrderDependent>(const char *value) {
        return static_cast<AggregateOrderDependent>(StringUtil::StringToEnum(
            GetAggregateOrderDependentValues(), 2, "AggregateOrderDependent", value));
    }
    ...
    AggregateType EnumUtil::FromString<AggregateType>(const char *value) {
        return static_cast<AggregateType>(
            StringUtil::StringToEnum(GetAggregateTypeValues(), 2, "AggregateType", value));
    }
    ...
    const char *EnumUtil::ToChars<AlterDatabaseType>(AlterDatabaseType value) {
        return StringUtil::EnumToString(GetAlterDatabaseTypeValues(), 1, "AlterDatabaseType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    AlterDatabaseType EnumUtil::FromString<AlterDatabaseType>(const char *value) {
        return static_cast<AlterDatabaseType>(StringUtil::StringToEnum(GetAlterDatabaseTypeValues(), 1,
                                                                       "AlterDatabaseType", value));
    }
    ...
    AlterForeignKeyType EnumUtil::FromString<AlterForeignKeyType>(const char *value) {
        return static_cast<AlterForeignKeyType>(StringUtil::StringToEnum(
            GetAlterForeignKeyTypeValues(), 2, "AlterForeignKeyType", value));
    }
    ...
    AlterScalarFunctionType EnumUtil::FromString<AlterScalarFunctionType>(const char *value) {
        return static_cast<AlterScalarFunctionType>(StringUtil::StringToEnum(
            GetAlterScalarFunctionTypeValues(), 2, "AlterScalarFunctionType", value));
    }
    ...
    AlterTableFunctionType EnumUtil::FromString<AlterTableFunctionType>(const char *value) {
        return static_cast<AlterTableFunctionType>(StringUtil::StringToEnum(
            GetAlterTableFunctionTypeValues(), 2, "AlterTableFunctionType", value));
    }
    ...
    AlterTableType EnumUtil::FromString<AlterTableType>(const char *value) {
        return static_cast<AlterTableType>(StringUtil::StringToEnum(GetAlterTableTypeValues(), 17, "AlterTableType",
                                                                    value));
    }
    ...
    AlterViewType EnumUtil::FromString<AlterViewType>(const char *value) {
        return static_cast<AlterViewType>(
            StringUtil::StringToEnum(GetAlterViewTypeValues(), 2, "AlterViewType", value));
    }
    ...
    ArrowArrayPhysicalType EnumUtil::FromString<ArrowArrayPhysicalType>(const char *value) {
        return static_cast<ArrowArrayPhysicalType>(StringUtil::StringToEnum(
            GetArrowArrayPhysicalTypeValues(), 3, "ArrowArrayPhysicalType", value));
    }
    ...
    const char *EnumUtil::ToChars<ArrowDateTimeType>(ArrowDateTimeType value) {
        return StringUtil::EnumToString(GetArrowDateTimeTypeValues(), 7, "ArrowDateTimeType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ArrowDateTimeType EnumUtil::FromString<ArrowDateTimeType>(const char *value) {
        return static_cast<ArrowDateTimeType>(StringUtil::StringToEnum(GetArrowDateTimeTypeValues(), 7,
                                                                       "ArrowDateTimeType", value));
    }
    ...
    ArrowFormatVersion EnumUtil::FromString<ArrowFormatVersion>(const char *value) {
        return static_cast<ArrowFormatVersion>(StringUtil::StringToEnum(GetArrowFormatVersionValues(), 6,
                                                                        "ArrowFormatVersion", value));
    }
    ...
    ArrowOffsetSize EnumUtil::FromString<ArrowOffsetSize>(const char *value) {
        return static_cast<ArrowOffsetSize>(StringUtil::StringToEnum(GetArrowOffsetSizeValues(), 2, "ArrowOffsetSize",
                                                                     value));
    }
    ...
    const char *EnumUtil::ToChars<ArrowTypeInfoType>(ArrowTypeInfoType value) {
        return StringUtil::EnumToString(GetArrowTypeInfoTypeValues(), 6, "ArrowTypeInfoType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ArrowTypeInfoType EnumUtil::FromString<ArrowTypeInfoType>(const char *value) {
        return static_cast<ArrowTypeInfoType>(StringUtil::StringToEnum(GetArrowTypeInfoTypeValues(), 6,
                                                                       "ArrowTypeInfoType", value));
    }
    ...
    ArrowVariableSizeType EnumUtil::FromString<ArrowVariableSizeType>(const char *value) {
        return static_cast<ArrowVariableSizeType>(StringUtil::StringToEnum(
            GetArrowVariableSizeTypeValues(), 4, "ArrowVariableSizeType", value));
    }
    ...
    BitpackingMode EnumUtil::FromString<BitpackingMode>(const char *value) {
        return static_cast<BitpackingMode>(StringUtil::StringToEnum(GetBitpackingModeValues(), 6, "BitpackingMode",
                                                                    value));
    }
    ...
    BlockIteratorStateType EnumUtil::FromString<BlockIteratorStateType>(const char *value) {
        return static_cast<BlockIteratorStateType>(StringUtil::StringToEnum(
            GetBlockIteratorStateTypeValues(), 2, "BlockIteratorStateType", value));
    }
    ...
    const char *EnumUtil::ToChars<CAPIResultSetType>(CAPIResultSetType value) {
        return StringUtil::EnumToString(GetCAPIResultSetTypeValues(), 4, "CAPIResultSetType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    CAPIResultSetType EnumUtil::FromString<CAPIResultSetType>(const char *value) {
        return static_cast<CAPIResultSetType>(StringUtil::StringToEnum(GetCAPIResultSetTypeValues(), 4,
                                                                       "CAPIResultSetType", value));
    }
    ...
    CTEMaterialize EnumUtil::FromString<CTEMaterialize>(const char *value) {
        return static_cast<CTEMaterialize>(StringUtil::StringToEnum(GetCTEMaterializeValues(), 3, "CTEMaterialize",
                                                                    value));
    }
    ...
    CatalogLookupBehavior EnumUtil::FromString<CatalogLookupBehavior>(const char *value) {
        return static_cast<CatalogLookupBehavior>(StringUtil::StringToEnum(
            GetCatalogLookupBehaviorValues(), 3, "CatalogLookupBehavior", value));
    }
    ...
    CheckpointAbort EnumUtil::FromString<CheckpointAbort>(const char *value) {
        return static_cast<CheckpointAbort>(StringUtil::StringToEnum(GetCheckpointAbortValues(), 4, "CheckpointAbort",
                                                                     value));
    }
    ...
    ChunkInfoType EnumUtil::FromString<ChunkInfoType>(const char *value) {
        return static_cast<ChunkInfoType>(
            StringUtil::StringToEnum(GetChunkInfoTypeValues(), 3, "ChunkInfoType", value));
    }
    ...
    ColumnDataAllocatorType EnumUtil::FromString<ColumnDataAllocatorType>(const char *value) {
        return static_cast<ColumnDataAllocatorType>(StringUtil::StringToEnum(
            GetColumnDataAllocatorTypeValues(), 3, "ColumnDataAllocatorType", value));
    }
    ...
    ColumnDataScanProperties EnumUtil::FromString<ColumnDataScanProperties>(const char *value) {
        return static_cast<ColumnDataScanProperties>(StringUtil::StringToEnum(
            GetColumnDataScanPropertiesValues(), 3, "ColumnDataScanProperties", value));
    }
    ...
    const char *EnumUtil::ToChars<ColumnSegmentType>(ColumnSegmentType value) {
        return StringUtil::EnumToString(GetColumnSegmentTypeValues(), 2, "ColumnSegmentType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ColumnSegmentType EnumUtil::FromString<ColumnSegmentType>(const char *value) {
        return static_cast<ColumnSegmentType>(StringUtil::StringToEnum(GetColumnSegmentTypeValues(), 2,
                                                                       "ColumnSegmentType", value));
    }
    ...
    const char *EnumUtil::ToChars<CompressionType>(CompressionType value) {
        return StringUtil::EnumToString(GetCompressionTypeValues(), 17, "CompressionType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    CompressionType EnumUtil::FromString<CompressionType>(const char *value) {
        return static_cast<CompressionType>(StringUtil::StringToEnum(GetCompressionTypeValues(), 17, "CompressionType",
                                                                     value));
    }
    ...
    CompressionValidity EnumUtil::FromString<CompressionValidity>(const char *value) {
        return static_cast<CompressionValidity>(StringUtil::StringToEnum(
            GetCompressionValidityValues(), 2, "CompressionValidity", value));
    }
    ...
    ConflictManagerMode EnumUtil::FromString<ConflictManagerMode>(const char *value) {
        return static_cast<ConflictManagerMode>(StringUtil::StringToEnum(
            GetConflictManagerModeValues(), 2, "ConflictManagerMode", value));
    }
    ...
    ConstraintType EnumUtil::FromString<ConstraintType>(const char *value) {
        return static_cast<ConstraintType>(StringUtil::StringToEnum(GetConstraintTypeValues(), 5, "ConstraintType",
                                                                    value));
    }
    ...
    CopyFunctionReturnType EnumUtil::FromString<CopyFunctionReturnType>(const char *value) {
        return static_cast<CopyFunctionReturnType>(StringUtil::StringToEnum(
            GetCopyFunctionReturnTypeValues(), 3, "CopyFunctionReturnType", value));
    }
    ...
    const char *EnumUtil::ToChars<CopyOverwriteMode>(CopyOverwriteMode value) {
        return StringUtil::EnumToString(GetCopyOverwriteModeValues(), 4, "CopyOverwriteMode",
                                        static_cast<uint32_t>(value));
    }

    template<>
    CopyOverwriteMode EnumUtil::FromString<CopyOverwriteMode>(const char *value) {
        return static_cast<CopyOverwriteMode>(StringUtil::StringToEnum(GetCopyOverwriteModeValues(), 4,
                                                                       "CopyOverwriteMode", value));
    }
    ...
    DateCastResult EnumUtil::FromString<DateCastResult>(const char *value) {
        return static_cast<DateCastResult>(StringUtil::StringToEnum(GetDateCastResultValues(), 3, "DateCastResult",
                                                                    value));
    }
    ...
    DatePartSpecifier EnumUtil::FromString<DatePartSpecifier>(const char *value) {
        return static_cast<DatePartSpecifier>(StringUtil::StringToEnum(GetDatePartSpecifierValues(), 25,
                                                                       "DatePartSpecifier", value));
    }
    ...
    DebugInitialize EnumUtil::FromString<DebugInitialize>(const char *value) {
        return static_cast<DebugInitialize>(StringUtil::StringToEnum(GetDebugInitializeValues(), 3, "DebugInitialize",
                                                                     value));
    }
    ...
    DebugVectorVerification EnumUtil::FromString<DebugVectorVerification>(const char *value) {
        return static_cast<DebugVectorVerification>(StringUtil::StringToEnum(
            GetDebugVectorVerificationValues(), 7, "DebugVectorVerification", value));
    }
    ...
    DecimalBitWidth EnumUtil::FromString<DecimalBitWidth>(const char *value) {
        return static_cast<DecimalBitWidth>(StringUtil::StringToEnum(GetDecimalBitWidthValues(), 4, "DecimalBitWidth",
                                                                     value));
    }
    ...
    DefaultOrderByNullType EnumUtil::FromString<DefaultOrderByNullType>(const char *value) {
        return static_cast<DefaultOrderByNullType>(StringUtil::StringToEnum(
            GetDefaultOrderByNullTypeValues(), 5, "DefaultOrderByNullType", value));
    }
    ...
    DependencyEntryType EnumUtil::FromString<DependencyEntryType>(const char *value) {
        return static_cast<DependencyEntryType>(StringUtil::StringToEnum(
            GetDependencyEntryTypeValues(), 2, "DependencyEntryType", value));
    }
    ...
    DeprecatedIndexType EnumUtil::FromString<DeprecatedIndexType>(const char *value) {
        return static_cast<DeprecatedIndexType>(StringUtil::StringToEnum(
            GetDeprecatedIndexTypeValues(), 3, "DeprecatedIndexType", value));
    }
    ...
    const char *EnumUtil::ToChars<DestroyBufferUpon>(DestroyBufferUpon value) {
        return StringUtil::EnumToString(GetDestroyBufferUponValues(), 3, "DestroyBufferUpon",
                                        static_cast<uint32_t>(value));
    }

    template<>
    DestroyBufferUpon EnumUtil::FromString<DestroyBufferUpon>(const char *value) {
        return static_cast<DestroyBufferUpon>(StringUtil::StringToEnum(GetDestroyBufferUponValues(), 3,
                                                                       "DestroyBufferUpon", value));
    }
    ...
    ExceptionFormatValueType EnumUtil::FromString<ExceptionFormatValueType>(const char *value) {
        return static_cast<ExceptionFormatValueType>(StringUtil::StringToEnum(
            GetExceptionFormatValueTypeValues(), 3, "ExceptionFormatValueType", value));
    }
    ...
    ExceptionType EnumUtil::FromString<ExceptionType>(const char *value) {
        return static_cast<ExceptionType>(
            StringUtil::StringToEnum(GetExceptionTypeValues(), 43, "ExceptionType", value));
    }
    ...
    ExplainFormat EnumUtil::FromString<ExplainFormat>(const char *value) {
        return static_cast<ExplainFormat>(
            StringUtil::StringToEnum(GetExplainFormatValues(), 6, "ExplainFormat", value));
    }
    ...
    const char *EnumUtil::ToChars<ExplainOutputType>(ExplainOutputType value) {
        return StringUtil::EnumToString(GetExplainOutputTypeValues(), 3, "ExplainOutputType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ExplainOutputType EnumUtil::FromString<ExplainOutputType>(const char *value) {
        return static_cast<ExplainOutputType>(StringUtil::StringToEnum(GetExplainOutputTypeValues(), 3,
                                                                       "ExplainOutputType", value));
    }
    ...
    const char *EnumUtil::ToChars<ExpressionClass>(ExpressionClass value) {
        return StringUtil::EnumToString(GetExpressionClassValues(), 40, "ExpressionClass",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ExpressionClass EnumUtil::FromString<ExpressionClass>(const char *value) {
        return static_cast<ExpressionClass>(StringUtil::StringToEnum(GetExpressionClassValues(), 40, "ExpressionClass",
                                                                     value));
    }
    ...
    ExpressionType EnumUtil::FromString<ExpressionType>(const char *value) {
        return static_cast<ExpressionType>(StringUtil::StringToEnum(GetExpressionTypeValues(), 72, "ExpressionType",
                                                                    value));
    }
    ...
    const char *EnumUtil::ToChars<ExtensionABIType>(ExtensionABIType value) {
        return StringUtil::EnumToString(GetExtensionABITypeValues(), 4, "ExtensionABIType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ExtensionABIType EnumUtil::FromString<ExtensionABIType>(const char *value) {
        return static_cast<ExtensionABIType>(StringUtil::StringToEnum(GetExtensionABITypeValues(), 4,
                                                                      "ExtensionABIType", value));
    }
    ...
    ExtensionInstallMode EnumUtil::FromString<ExtensionInstallMode>(const char *value) {
        return static_cast<ExtensionInstallMode>(StringUtil::StringToEnum(
            GetExtensionInstallModeValues(), 5, "ExtensionInstallMode", value));
    }
    ...
    ExtensionLoadResult EnumUtil::FromString<ExtensionLoadResult>(const char *value) {
        return static_cast<ExtensionLoadResult>(StringUtil::StringToEnum(
            GetExtensionLoadResultValues(), 3, "ExtensionLoadResult", value));
    }
    ...
    ExtensionUpdateResultTag EnumUtil::FromString<ExtensionUpdateResultTag>(const char *value) {
        return static_cast<ExtensionUpdateResultTag>(StringUtil::StringToEnum(
            GetExtensionUpdateResultTagValues(), 8, "ExtensionUpdateResultTag", value));
    }
    ...
    const char *EnumUtil::ToChars<ExtraDropInfoType>(ExtraDropInfoType value) {
        return StringUtil::EnumToString(GetExtraDropInfoTypeValues(), 2, "ExtraDropInfoType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ExtraDropInfoType EnumUtil::FromString<ExtraDropInfoType>(const char *value) {
        return static_cast<ExtraDropInfoType>(StringUtil::StringToEnum(GetExtraDropInfoTypeValues(), 2,
                                                                       "ExtraDropInfoType", value));
    }
    ...
    const char *EnumUtil::ToChars<ExtraTypeInfoType>(ExtraTypeInfoType value) {
        return StringUtil::EnumToString(GetExtraTypeInfoTypeValues(), 14, "ExtraTypeInfoType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ExtraTypeInfoType EnumUtil::FromString<ExtraTypeInfoType>(const char *value) {
        return static_cast<ExtraTypeInfoType>(StringUtil::StringToEnum(GetExtraTypeInfoTypeValues(), 14,
                                                                       "ExtraTypeInfoType", value));
    }
    ...
    FileBufferType EnumUtil::FromString<FileBufferType>(const char *value) {
        return static_cast<FileBufferType>(StringUtil::StringToEnum(GetFileBufferTypeValues(), 4, "FileBufferType",
                                                                    value));
    }
    ...
    FileCompressionType EnumUtil::FromString<FileCompressionType>(const char *value) {
        return static_cast<FileCompressionType>(StringUtil::StringToEnum(
            GetFileCompressionTypeValues(), 4, "FileCompressionType", value));
    }
    ...
    const char *EnumUtil::ToChars<FileExpandResult>(FileExpandResult value) {
        return StringUtil::EnumToString(GetFileExpandResultValues(), 3, "FileExpandResult",
                                        static_cast<uint32_t>(value));
    }

    template<>
    FileExpandResult EnumUtil::FromString<FileExpandResult>(const char *value) {
        return static_cast<FileExpandResult>(StringUtil::StringToEnum(GetFileExpandResultValues(), 3,
                                                                      "FileExpandResult", value));
    }
    ...
    FileGlobOptions EnumUtil::FromString<FileGlobOptions>(const char *value) {
        return static_cast<FileGlobOptions>(StringUtil::StringToEnum(GetFileGlobOptionsValues(), 3, "FileGlobOptions",
                                                                     value));
    }
    ...
    FileNameSegmentType EnumUtil::FromString<FileNameSegmentType>(const char *value) {
        return static_cast<FileNameSegmentType>(StringUtil::StringToEnum(
            GetFileNameSegmentTypeValues(), 4, "FileNameSegmentType", value));
    }
    ...
    FilterPropagateResult EnumUtil::FromString<FilterPropagateResult>(const char *value) {
        return static_cast<FilterPropagateResult>(StringUtil::StringToEnum(
            GetFilterPropagateResultValues(), 5, "FilterPropagateResult", value));
    }
    ...
    ForeignKeyType EnumUtil::FromString<ForeignKeyType>(const char *value) {
        return static_cast<ForeignKeyType>(StringUtil::StringToEnum(GetForeignKeyTypeValues(), 3, "ForeignKeyType",
                                                                    value));
    }
    ...
    const StringUtil::EnumStringLiteral *GetFunctionCollationHandlingValues() {
        static constexpr StringUtil::EnumStringLiteral values[]{
            ...
            {
                static_cast<uint32_t>(FunctionCollationHandling::PUSH_COMBINABLE_COLLATIONS),
                "PUSH_COMBINABLE_COLLATIONS"
            },
    ...
    FunctionCollationHandling EnumUtil::FromString<FunctionCollationHandling>(const char *value) {
        return static_cast<FunctionCollationHandling>(StringUtil::StringToEnum(
            GetFunctionCollationHandlingValues(), 3, "FunctionCollationHandling", value));
    }
    ...
    FunctionErrors EnumUtil::FromString<FunctionErrors>(const char *value) {
        return static_cast<FunctionErrors>(StringUtil::StringToEnum(GetFunctionErrorsValues(), 2, "FunctionErrors",
                                                                    value));
    }
    ...
    FunctionNullHandling EnumUtil::FromString<FunctionNullHandling>(const char *value) {
        return static_cast<FunctionNullHandling>(StringUtil::StringToEnum(
            GetFunctionNullHandlingValues(), 2, "FunctionNullHandling", value));
    }
    ...
    const char *EnumUtil::ToChars<FunctionStability>(FunctionStability value) {
        return StringUtil::EnumToString(GetFunctionStabilityValues(), 3, "FunctionStability",
                                        static_cast<uint32_t>(value));
    }

    template<>
    FunctionStability EnumUtil::FromString<FunctionStability>(const char *value) {
        return static_cast<FunctionStability>(StringUtil::StringToEnum(GetFunctionStabilityValues(), 3,
                                                                       "FunctionStability", value));
    }
    ...
    HLLStorageType EnumUtil::FromString<HLLStorageType>(const char *value) {
        return static_cast<HLLStorageType>(StringUtil::StringToEnum(GetHLLStorageTypeValues(), 2, "HLLStorageType",
                                                                    value));
    }
    ...
    HTTPStatusCode EnumUtil::FromString<HTTPStatusCode>(const char *value) {
        return static_cast<HTTPStatusCode>(StringUtil::StringToEnum(GetHTTPStatusCodeValues(), 64, "HTTPStatusCode",
                                                                    value));
    }
    ...
    IndexAppendMode EnumUtil::FromString<IndexAppendMode>(const char *value) {
        return static_cast<IndexAppendMode>(StringUtil::StringToEnum(GetIndexAppendModeValues(), 3, "IndexAppendMode",
                                                                     value));
    }
    ...
    IndexBindState EnumUtil::FromString<IndexBindState>(const char *value) {
        return static_cast<IndexBindState>(StringUtil::StringToEnum(GetIndexBindStateValues(), 3, "IndexBindState",
                                                                    value));
    }
    ...
    IndexConstraintType EnumUtil::FromString<IndexConstraintType>(const char *value) {
        return static_cast<IndexConstraintType>(StringUtil::StringToEnum(
            GetIndexConstraintTypeValues(), 4, "IndexConstraintType", value));
    }
    ...
    const char *EnumUtil::ToChars<InsertColumnOrder>(InsertColumnOrder value) {
        return StringUtil::EnumToString(GetInsertColumnOrderValues(), 2, "InsertColumnOrder",
                                        static_cast<uint32_t>(value));
    }

    template<>
    InsertColumnOrder EnumUtil::FromString<InsertColumnOrder>(const char *value) {
        return static_cast<InsertColumnOrder>(StringUtil::StringToEnum(GetInsertColumnOrderValues(), 2,
                                                                       "InsertColumnOrder", value));
    }
    ...
    InterruptMode EnumUtil::FromString<InterruptMode>(const char *value) {
        return static_cast<InterruptMode>(
            StringUtil::StringToEnum(GetInterruptModeValues(), 3, "InterruptMode", value));
    }
    ...
    KeywordCategory EnumUtil::FromString<KeywordCategory>(const char *value) {
        return static_cast<KeywordCategory>(StringUtil::StringToEnum(GetKeywordCategoryValues(), 5, "KeywordCategory",
                                                                     value));
    }
    ...
    const char *EnumUtil::ToChars<LambdaSyntaxType>(LambdaSyntaxType value) {
        return StringUtil::EnumToString(GetLambdaSyntaxTypeValues(), 3, "LambdaSyntaxType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    LambdaSyntaxType EnumUtil::FromString<LambdaSyntaxType>(const char *value) {
        return static_cast<LambdaSyntaxType>(StringUtil::StringToEnum(GetLambdaSyntaxTypeValues(), 3,
                                                                      "LambdaSyntaxType", value));
    }
    ...
    LimitNodeType EnumUtil::FromString<LimitNodeType>(const char *value) {
        return static_cast<LimitNodeType>(
            StringUtil::StringToEnum(GetLimitNodeTypeValues(), 5, "LimitNodeType", value));
    }
    ...
    LogContextScope EnumUtil::FromString<LogContextScope>(const char *value) {
        return static_cast<LogContextScope>(StringUtil::StringToEnum(GetLogContextScopeValues(), 3, "LogContextScope",
                                                                     value));
    }
    ...
    LoggingTargetTable EnumUtil::FromString<LoggingTargetTable>(const char *value) {
        return static_cast<LoggingTargetTable>(StringUtil::StringToEnum(GetLoggingTargetTableValues(), 3,
                                                                        "LoggingTargetTable", value));
    }
    ...
    const StringUtil::EnumStringLiteral *GetLogicalOperatorTypeValues() {
        static constexpr StringUtil::EnumStringLiteral values[]{
            ...
            {
                static_cast<uint32_t>(LogicalOperatorType::LOGICAL_AGGREGATE_AND_GROUP_BY),
    ...
    LogicalOperatorType EnumUtil::FromString<LogicalOperatorType>(const char *value) {
        return static_cast<LogicalOperatorType>(StringUtil::StringToEnum(
            GetLogicalOperatorTypeValues(), 62, "LogicalOperatorType", value));
    }
    ...
    LogicalTypeId EnumUtil::FromString<LogicalTypeId>(const char *value) {
        return static_cast<LogicalTypeId>(
            StringUtil::StringToEnum(GetLogicalTypeIdValues(), 51, "LogicalTypeId", value));
    }
    ...
    const char *EnumUtil::ToChars<LookupResultType>(LookupResultType value) {
        return StringUtil::EnumToString(GetLookupResultTypeValues(), 3, "LookupResultType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    LookupResultType EnumUtil::FromString<LookupResultType>(const char *value) {
        return static_cast<LookupResultType>(StringUtil::StringToEnum(GetLookupResultTypeValues(), 3,
                                                                      "LookupResultType", value));
    }
    ...
    const char *EnumUtil::ToChars<MapInvalidReason>(MapInvalidReason value) {
        return StringUtil::EnumToString(GetMapInvalidReasonValues(), 5, "MapInvalidReason",
                                        static_cast<uint32_t>(value));
    }

    template<>
    MapInvalidReason EnumUtil::FromString<MapInvalidReason>(const char *value) {
        return static_cast<MapInvalidReason>(StringUtil::StringToEnum(GetMapInvalidReasonValues(), 5,
                                                                      "MapInvalidReason", value));
    }
    ...
    MergeActionCondition EnumUtil::FromString<MergeActionCondition>(const char *value) {
        return static_cast<MergeActionCondition>(StringUtil::StringToEnum(
            GetMergeActionConditionValues(), 3, "MergeActionCondition", value));
    }
    ...
    MergeActionType EnumUtil::FromString<MergeActionType>(const char *value) {
        return static_cast<MergeActionType>(StringUtil::StringToEnum(GetMergeActionTypeValues(), 5, "MergeActionType",
                                                                     value));
    }
    ...
    const char *EnumUtil::ToChars<MetaPipelineType>(MetaPipelineType value) {
        return StringUtil::EnumToString(GetMetaPipelineTypeValues(), 2, "MetaPipelineType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    MetaPipelineType EnumUtil::FromString<MetaPipelineType>(const char *value) {
        return static_cast<MetaPipelineType>(StringUtil::StringToEnum(GetMetaPipelineTypeValues(), 2,
                                                                      "MetaPipelineType", value));
    }
    ...
    const StringUtil::EnumStringLiteral *GetMetricsTypeValues() {
        static constexpr StringUtil::EnumStringLiteral values[]{
            ...
            {
                static_cast<uint32_t>(MetricsType::OPTIMIZER_COMPRESSED_MATERIALIZATION),
            ...
            {
                static_cast<uint32_t>(MetricsType::OPTIMIZER_TOP_N_WINDOW_ELIMINATION),
    ...
    MultiFileColumnMappingMode EnumUtil::FromString<MultiFileColumnMappingMode>(const char *value) {
        return static_cast<MultiFileColumnMappingMode>(StringUtil::StringToEnum(
            GetMultiFileColumnMappingModeValues(), 2, "MultiFileColumnMappingMode", value));
    }
    ...
    MultiFileFileState EnumUtil::FromString<MultiFileFileState>(const char *value) {
        return static_cast<MultiFileFileState>(StringUtil::StringToEnum(GetMultiFileFileStateValues(), 5,
                                                                        "MultiFileFileState", value));
    }
    ...
    const char *EnumUtil::ToChars<NewLineIdentifier>(NewLineIdentifier value) {
        return StringUtil::EnumToString(GetNewLineIdentifierValues(), 4, "NewLineIdentifier",
                                        static_cast<uint32_t>(value));
    }

    template<>
    NewLineIdentifier EnumUtil::FromString<NewLineIdentifier>(const char *value) {
        return static_cast<NewLineIdentifier>(StringUtil::StringToEnum(GetNewLineIdentifierValues(), 4,
                                                                       "NewLineIdentifier", value));
    }
    ...
    const char *EnumUtil::ToChars<OnConflictAction>(OnConflictAction value) {
        return StringUtil::EnumToString(GetOnConflictActionValues(), 4, "OnConflictAction",
                                        static_cast<uint32_t>(value));
    }

    template<>
    OnConflictAction EnumUtil::FromString<OnConflictAction>(const char *value) {
        return static_cast<OnConflictAction>(StringUtil::StringToEnum(GetOnConflictActionValues(), 4,
                                                                      "OnConflictAction", value));
    }
    ...
    const char *EnumUtil::ToChars<OnCreateConflict>(OnCreateConflict value) {
        return StringUtil::EnumToString(GetOnCreateConflictValues(), 4, "OnCreateConflict",
                                        static_cast<uint32_t>(value));
    }

    template<>
    OnCreateConflict EnumUtil::FromString<OnCreateConflict>(const char *value) {
        return static_cast<OnCreateConflict>(StringUtil::StringToEnum(GetOnCreateConflictValues(), 4,
                                                                      "OnCreateConflict", value));
    }
    ...
    OnEntryNotFound EnumUtil::FromString<OnEntryNotFound>(const char *value) {
        return static_cast<OnEntryNotFound>(StringUtil::StringToEnum(GetOnEntryNotFoundValues(), 2, "OnEntryNotFound",
                                                                     value));
    }
    ...
    OperatorFinalResultType EnumUtil::FromString<OperatorFinalResultType>(const char *value) {
        return static_cast<OperatorFinalResultType>(StringUtil::StringToEnum(
            GetOperatorFinalResultTypeValues(), 2, "OperatorFinalResultType", value));
    }
    ...
    OperatorFinalizeResultType EnumUtil::FromString<OperatorFinalizeResultType>(const char *value) {
        return static_cast<OperatorFinalizeResultType>(StringUtil::StringToEnum(
            GetOperatorFinalizeResultTypeValues(), 2, "OperatorFinalizeResultType", value));
    }
    ...
    OperatorResultType EnumUtil::FromString<OperatorResultType>(const char *value) {
        return static_cast<OperatorResultType>(StringUtil::StringToEnum(GetOperatorResultTypeValues(), 4,
    ...
    OptimizerType EnumUtil::FromString<OptimizerType>(const char *value) {
        return static_cast<OptimizerType>(
            StringUtil::StringToEnum(GetOptimizerTypeValues(), 31, "OptimizerType", value));
    }
    ...
    OrderByNullType EnumUtil::FromString<OrderByNullType>(const char *value) {
        return static_cast<OrderByNullType>(StringUtil::StringToEnum(GetOrderByNullTypeValues(), 7, "OrderByNullType",
                                                                     value));
    }
    ...
    OrderPreservationType EnumUtil::FromString<OrderPreservationType>(const char *value) {
        return static_cast<OrderPreservationType>(StringUtil::StringToEnum(
            GetOrderPreservationTypeValues(), 3, "OrderPreservationType", value));
    }
    ...
    OrdinalityType EnumUtil::FromString<OrdinalityType>(const char *value) {
        return static_cast<OrdinalityType>(StringUtil::StringToEnum(GetOrdinalityTypeValues(), 2, "OrdinalityType",
                                                                    value));
    }
    ...
    ParseInfoType EnumUtil::FromString<ParseInfoType>(const char *value) {
        return static_cast<ParseInfoType>(
            StringUtil::StringToEnum(GetParseInfoTypeValues(), 17, "ParseInfoType", value));
    }
    ...
    ParserExtensionResultType EnumUtil::FromString<ParserExtensionResultType>(const char *value) {
        return static_cast<ParserExtensionResultType>(StringUtil::StringToEnum(
            GetParserExtensionResultTypeValues(), 3, "ParserExtensionResultType", value));
    }
    ...
    PartitionedColumnDataType EnumUtil::FromString<PartitionedColumnDataType>(const char *value) {
        return static_cast<PartitionedColumnDataType>(StringUtil::StringToEnum(
            GetPartitionedColumnDataTypeValues(), 3, "PartitionedColumnDataType", value));
    }
    ...
    PartitionedTupleDataType EnumUtil::FromString<PartitionedTupleDataType>(const char *value) {
        return static_cast<PartitionedTupleDataType>(StringUtil::StringToEnum(
            GetPartitionedTupleDataTypeValues(), 2, "PartitionedTupleDataType", value));
    }
    ...
    PendingExecutionResult EnumUtil::FromString<PendingExecutionResult>(const char *value) {
        return static_cast<PendingExecutionResult>(StringUtil::StringToEnum(
            GetPendingExecutionResultValues(), 6, "PendingExecutionResult", value));
    }
    ...
    const char *EnumUtil::ToChars<PhysicalOperatorType>(PhysicalOperatorType value) {
        return StringUtil::EnumToString(GetPhysicalOperatorTypeValues(), 82, "PhysicalOperatorType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    PhysicalOperatorType EnumUtil::FromString<PhysicalOperatorType>(const char *value) {
        return static_cast<PhysicalOperatorType>(StringUtil::StringToEnum(
            GetPhysicalOperatorTypeValues(), 82, "PhysicalOperatorType", value));
    }
    ...
    const char *EnumUtil::ToChars<PreparedParamType>(PreparedParamType value) {
        return StringUtil::EnumToString(GetPreparedParamTypeValues(), 4, "PreparedParamType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    PreparedParamType EnumUtil::FromString<PreparedParamType>(const char *value) {
        return static_cast<PreparedParamType>(StringUtil::StringToEnum(GetPreparedParamTypeValues(), 4,
                                                                       "PreparedParamType", value));
    }
    ...
    PreparedStatementMode EnumUtil::FromString<PreparedStatementMode>(const char *value) {
        return static_cast<PreparedStatementMode>(StringUtil::StringToEnum(
            GetPreparedStatementModeValues(), 2, "PreparedStatementMode", value));
    }
    ...
    const char *EnumUtil::ToChars<PreserveOrderType>(PreserveOrderType value) {
        return StringUtil::EnumToString(GetPreserveOrderTypeValues(), 3, "PreserveOrderType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    PreserveOrderType EnumUtil::FromString<PreserveOrderType>(const char *value) {
        return static_cast<PreserveOrderType>(StringUtil::StringToEnum(GetPreserveOrderTypeValues(), 3,
                                                                       "PreserveOrderType", value));
    }
    ...
    const char *EnumUtil::ToChars<ProfilerPrintFormat>(ProfilerPrintFormat value) {
        return StringUtil::EnumToString(GetProfilerPrintFormatValues(), 6, "ProfilerPrintFormat",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ProfilerPrintFormat EnumUtil::FromString<ProfilerPrintFormat>(const char *value) {
        return static_cast<ProfilerPrintFormat>(StringUtil::StringToEnum(
            GetProfilerPrintFormatValues(), 6, "ProfilerPrintFormat", value));
    }
    ...
    const char *EnumUtil::ToChars<ProfilingCoverage>(ProfilingCoverage value) {
        return StringUtil::EnumToString(GetProfilingCoverageValues(), 2, "ProfilingCoverage",
                                        static_cast<uint32_t>(value));
    }

    template<>
    ProfilingCoverage EnumUtil::FromString<ProfilingCoverage>(const char *value) {
        return static_cast<ProfilingCoverage>(StringUtil::StringToEnum(GetProfilingCoverageValues(), 2,
                                                                       "ProfilingCoverage", value));
    }
    ...
    QuantileSerializationType EnumUtil::FromString<QuantileSerializationType>(const char *value) {
        return static_cast<QuantileSerializationType>(StringUtil::StringToEnum(
            GetQuantileSerializationTypeValues(), 5, "QuantileSerializationType", value));
    }
    ...
    QueryNodeType EnumUtil::FromString<QueryNodeType>(const char *value) {
        return static_cast<QueryNodeType>(
            StringUtil::StringToEnum(GetQueryNodeTypeValues(), 6, "QueryNodeType", value));
    }
    ...
    QueryResultType EnumUtil::FromString<QueryResultType>(const char *value) {
        return static_cast<QueryResultType>(StringUtil::StringToEnum(GetQueryResultTypeValues(), 4, "QueryResultType",
                                                                     value));
    }
    ...
    ResultModifierType EnumUtil::FromString<ResultModifierType>(const char *value) {
        return static_cast<ResultModifierType>(StringUtil::StringToEnum(GetResultModifierTypeValues(), 4,
                                                                        "ResultModifierType", value));
    }
    ...
    SamplingState EnumUtil::FromString<SamplingState>(const char *value) {
        return static_cast<SamplingState>(
            StringUtil::StringToEnum(GetSamplingStateValues(), 2, "SamplingState", value));
    }
    ...
    const char *EnumUtil::ToChars<SecretDisplayType>(SecretDisplayType value) {
        return StringUtil::EnumToString(GetSecretDisplayTypeValues(), 2, "SecretDisplayType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    SecretDisplayType EnumUtil::FromString<SecretDisplayType>(const char *value) {
        return static_cast<SecretDisplayType>(StringUtil::StringToEnum(GetSecretDisplayTypeValues(), 2,
                                                                       "SecretDisplayType", value));
    }
    ...
    const char *EnumUtil::ToChars<SecretPersistType>(SecretPersistType value) {
        return StringUtil::EnumToString(GetSecretPersistTypeValues(), 3, "SecretPersistType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    SecretPersistType EnumUtil::FromString<SecretPersistType>(const char *value) {
        return static_cast<SecretPersistType>(StringUtil::StringToEnum(GetSecretPersistTypeValues(), 3,
                                                                       "SecretPersistType", value));
    }
    ...
    SecretSerializationType EnumUtil::FromString<SecretSerializationType>(const char *value) {
        return static_cast<SecretSerializationType>(StringUtil::StringToEnum(
            GetSecretSerializationTypeValues(), 2, "SecretSerializationType", value));
    }
    ...
    const char *EnumUtil::ToChars<SetOperationType>(SetOperationType value) {
        return StringUtil::EnumToString(GetSetOperationTypeValues(), 5, "SetOperationType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    SetOperationType EnumUtil::FromString<SetOperationType>(const char *value) {
        return static_cast<SetOperationType>(StringUtil::StringToEnum(GetSetOperationTypeValues(), 5,
    ...
    const char *EnumUtil::ToChars<SimplifiedTokenType>(SimplifiedTokenType value) {
        return StringUtil::EnumToString(GetSimplifiedTokenTypeValues(), 7, "SimplifiedTokenType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    SimplifiedTokenType EnumUtil::FromString<SimplifiedTokenType>(const char *value) {
        return static_cast<SimplifiedTokenType>(StringUtil::StringToEnum(
    ...
    SinkCombineResultType EnumUtil::FromString<SinkCombineResultType>(const char *value) {
        return static_cast<SinkCombineResultType>(StringUtil::StringToEnum(
            GetSinkCombineResultTypeValues(), 2, "SinkCombineResultType", value));
    }
    ...
    const char *EnumUtil::ToChars<SinkFinalizeType>(SinkFinalizeType value) {
        return StringUtil::EnumToString(GetSinkFinalizeTypeValues(), 3, "SinkFinalizeType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    SinkFinalizeType EnumUtil::FromString<SinkFinalizeType>(const char *value) {
        return static_cast<SinkFinalizeType>(StringUtil::StringToEnum(GetSinkFinalizeTypeValues(), 3,
                                                                      "SinkFinalizeType", value));
    }
    ...
    const char *EnumUtil::ToChars<SinkNextBatchType>(SinkNextBatchType value) {
        return StringUtil::EnumToString(GetSinkNextBatchTypeValues(), 2, "SinkNextBatchType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    SinkNextBatchType EnumUtil::FromString<SinkNextBatchType>(const char *value) {
        return static_cast<SinkNextBatchType>(StringUtil::StringToEnum(GetSinkNextBatchTypeValues(), 2,
                                                                       "SinkNextBatchType", value));
    }
    ...
    SinkResultType EnumUtil::FromString<SinkResultType>(const char *value) {
        return static_cast<SinkResultType>(StringUtil::StringToEnum(GetSinkResultTypeValues(), 3, "SinkResultType",
                                                                    value));
    }
    ...
    const char *EnumUtil::ToChars<SourceResultType>(SourceResultType value) {
        return StringUtil::EnumToString(GetSourceResultTypeValues(), 3, "SourceResultType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    SourceResultType EnumUtil::FromString<SourceResultType>(const char *value) {
        return static_cast<SourceResultType>(StringUtil::StringToEnum(GetSourceResultTypeValues(), 3,
                                                                      "SourceResultType", value));
    }
    ...
    StarExpressionType EnumUtil::FromString<StarExpressionType>(const char *value) {
        return static_cast<StarExpressionType>(StringUtil::StringToEnum(GetStarExpressionTypeValues(), 4,
                                                                        "StarExpressionType", value));
    }
    ...
    StatementReturnType EnumUtil::FromString<StatementReturnType>(const char *value) {
        return static_cast<StatementReturnType>(StringUtil::StringToEnum(
            GetStatementReturnTypeValues(), 3, "StatementReturnType", value));
    }
    ...
    StatementType EnumUtil::FromString<StatementType>(const char *value) {
        return static_cast<StatementType>(
            StringUtil::StringToEnum(GetStatementTypeValues(), 31, "StatementType", value));
    }
    ...
    StatisticsType EnumUtil::FromString<StatisticsType>(const char *value) {
        return static_cast<StatisticsType>(StringUtil::StringToEnum(GetStatisticsTypeValues(), 7, "StatisticsType",
                                                                    value));
    }
    ...
    StorageBlockPrefetch EnumUtil::FromString<StorageBlockPrefetch>(const char *value) {
        return static_cast<StorageBlockPrefetch>(StringUtil::StringToEnum(
            GetStorageBlockPrefetchValues(), 4, "StorageBlockPrefetch", value));
    }
    ...
    const StringUtil::EnumStringLiteral *GetStrTimeSpecifierValues() {
        static constexpr StringUtil::EnumStringLiteral values[]{
            ...
            {
                static_cast<uint32_t>(StrTimeSpecifier::LOCALE_APPROPRIATE_DATE_AND_TIME),
    ...
    const char *EnumUtil::ToChars<StrTimeSpecifier>(StrTimeSpecifier value) {
        return StringUtil::EnumToString(GetStrTimeSpecifierValues(), 36, "StrTimeSpecifier",
                                        static_cast<uint32_t>(value));
    }

    template<>
    StrTimeSpecifier EnumUtil::FromString<StrTimeSpecifier>(const char *value) {
        return static_cast<StrTimeSpecifier>(StringUtil::StringToEnum(GetStrTimeSpecifierValues(), 36,
                                                                      "StrTimeSpecifier", value));
    }
    ...
    StreamExecutionResult EnumUtil::FromString<StreamExecutionResult>(const char *value) {
        return static_cast<StreamExecutionResult>(StringUtil::StringToEnum(
            GetStreamExecutionResultValues(), 7, "StreamExecutionResult", value));
    }
    ...
    TableColumnType EnumUtil::FromString<TableColumnType>(const char *value) {
        return static_cast<TableColumnType>(StringUtil::StringToEnum(GetTableColumnTypeValues(), 2, "TableColumnType",
                                                                     value));
    }
    ...
    const char *EnumUtil::ToChars<TableFilterType>(TableFilterType value) {
        return StringUtil::EnumToString(GetTableFilterTypeValues(), 10, "TableFilterType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    TableFilterType EnumUtil::FromString<TableFilterType>(const char *value) {
        return static_cast<TableFilterType>(StringUtil::StringToEnum(GetTableFilterTypeValues(), 10, "TableFilterType",
                                                                     value));
    }
    ...
    TablePartitionInfo EnumUtil::FromString<TablePartitionInfo>(const char *value) {
        return static_cast<TablePartitionInfo>(StringUtil::StringToEnum(GetTablePartitionInfoValues(), 4,
                                                                        "TablePartitionInfo", value));
    }
    ...
    TableReferenceType EnumUtil::FromString<TableReferenceType>(const char *value) {
        return static_cast<TableReferenceType>(StringUtil::StringToEnum(GetTableReferenceTypeValues(), 13,
                                                                        "TableReferenceType", value));
    }
    ...
    const StringUtil::EnumStringLiteral *GetTableScanTypeValues() {
        static constexpr StringUtil::EnumStringLiteral values[]{
            ...
            {
                static_cast<uint32_t>(TableScanType::TABLE_SCAN_COMMITTED_ROWS_DISALLOW_UPDATES),
                "TABLE_SCAN_COMMITTED_ROWS_DISALLOW_UPDATES"
            },
            {
                static_cast<uint32_t>(TableScanType::TABLE_SCAN_COMMITTED_ROWS_OMIT_PERMANENTLY_DELETED),
    ...
    TableScanType EnumUtil::FromString<TableScanType>(const char *value) {
        return static_cast<TableScanType>(
            StringUtil::StringToEnum(GetTableScanTypeValues(), 5, "TableScanType", value));
    }
    ...
    const char *EnumUtil::ToChars<TaskExecutionMode>(TaskExecutionMode value) {
        return StringUtil::EnumToString(GetTaskExecutionModeValues(), 2, "TaskExecutionMode",
                                        static_cast<uint32_t>(value));
    }

    template<>
    TaskExecutionMode EnumUtil::FromString<TaskExecutionMode>(const char *value) {
        return static_cast<TaskExecutionMode>(StringUtil::StringToEnum(GetTaskExecutionModeValues(), 2,
    ...
    TaskExecutionResult EnumUtil::FromString<TaskExecutionResult>(const char *value) {
        return static_cast<TaskExecutionResult>(StringUtil::StringToEnum(
            GetTaskExecutionResultValues(), 4, "TaskExecutionResult", value));
    }
    ...
    TemporaryBufferSize EnumUtil::FromString<TemporaryBufferSize>(const char *value) {
        return static_cast<TemporaryBufferSize>(StringUtil::StringToEnum(
    ...
    TemporaryCompressionLevel EnumUtil::FromString<TemporaryCompressionLevel>(const char *value) {
        return static_cast<TemporaryCompressionLevel>(StringUtil::StringToEnum(
            GetTemporaryCompressionLevelValues(), 7, "TemporaryCompressionLevel", value));
    }
    ...
    ThreadPinMode EnumUtil::FromString<ThreadPinMode>(const char *value) {
        return static_cast<ThreadPinMode>(
            StringUtil::StringToEnum(GetThreadPinModeValues(), 3, "ThreadPinMode", value));
    }
    ...
    TimestampCastResult EnumUtil::FromString<TimestampCastResult>(const char *value) {
        return static_cast<TimestampCastResult>(StringUtil::StringToEnum(
            GetTimestampCastResultValues(), 5, "TimestampCastResult", value));
    }

    const StringUtil::EnumStringLiteral *GetTransactionModifierTypeValues() {
        static constexpr StringUtil::EnumStringLiteral values[]{
            {
                static_cast<uint32_t>(TransactionModifierType::TRANSACTION_DEFAULT_MODIFIER),
    ...
    TransactionModifierType EnumUtil::FromString<TransactionModifierType>(const char *value) {
        return static_cast<TransactionModifierType>(StringUtil::StringToEnum(
    ...
    TransactionType EnumUtil::FromString<TransactionType>(const char *value) {
        return static_cast<TransactionType>(StringUtil::StringToEnum(GetTransactionTypeValues(), 4, "TransactionType",
                                                                     value));
    }
    ...
    TupleDataNestednessType EnumUtil::FromString<TupleDataNestednessType>(const char *value) {
        return static_cast<TupleDataNestednessType>(StringUtil::StringToEnum(
            GetTupleDataNestednessTypeValues(), 2, "TupleDataNestednessType", value));
    }
    ...
    TupleDataPinProperties EnumUtil::FromString<TupleDataPinProperties>(const char *value) {
        return static_cast<TupleDataPinProperties>(StringUtil::StringToEnum(
            GetTupleDataPinPropertiesValues(), 5, "TupleDataPinProperties", value));
    }
    ...
    TupleDataValidityType EnumUtil::FromString<TupleDataValidityType>(const char *value) {
        return static_cast<TupleDataValidityType>(StringUtil::StringToEnum(
            GetTupleDataValidityTypeValues(), 2, "TupleDataValidityType", value));
    }
    ...
    UnionInvalidReason EnumUtil::FromString<UnionInvalidReason>(const char *value) {
        return static_cast<UnionInvalidReason>(StringUtil::StringToEnum(GetUnionInvalidReasonValues(), 6,
                                                                        "UnionInvalidReason", value));
    }
    ...
    const char *EnumUtil::ToChars<VariantChildLookupMode>(VariantChildLookupMode value) {
        return StringUtil::EnumToString(GetVariantChildLookupModeValues(), 2, "VariantChildLookupMode",
                                        static_cast<uint32_t>(value));
    }

    template<>
    VariantChildLookupMode EnumUtil::FromString<VariantChildLookupMode>(const char *value) {
        return static_cast<VariantChildLookupMode>(StringUtil::StringToEnum(
            GetVariantChildLookupModeValues(), 2, "VariantChildLookupMode", value));
    }
    ...
    const char *EnumUtil::ToChars<VariantLogicalType>(VariantLogicalType value) {
        return StringUtil::EnumToString(GetVariantLogicalTypeValues(), 35, "VariantLogicalType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    VariantLogicalType EnumUtil::FromString<VariantLogicalType>(const char *value) {
        return static_cast<VariantLogicalType>(StringUtil::StringToEnum(GetVariantLogicalTypeValues(), 35,
                                                                        "VariantLogicalType", value));
    }
    ...
    const char *EnumUtil::ToChars<VectorAuxiliaryDataType>(VectorAuxiliaryDataType value) {
        return StringUtil::EnumToString(GetVectorAuxiliaryDataTypeValues(), 1, "VectorAuxiliaryDataType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    VectorAuxiliaryDataType EnumUtil::FromString<VectorAuxiliaryDataType>(const char *value) {
        return static_cast<VectorAuxiliaryDataType>(StringUtil::StringToEnum(
            GetVectorAuxiliaryDataTypeValues(), 1, "VectorAuxiliaryDataType", value));
    }
    ...
    const char *EnumUtil::ToChars<VectorBufferType>(VectorBufferType value) {
        return StringUtil::EnumToString(GetVectorBufferTypeValues(), 10, "VectorBufferType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    VectorBufferType EnumUtil::FromString<VectorBufferType>(const char *value) {
        return static_cast<VectorBufferType>(StringUtil::StringToEnum(GetVectorBufferTypeValues(), 10,
                                                                      "VectorBufferType", value));
    }
    ...
    const char *EnumUtil::ToChars<VerificationType>(VerificationType value) {
        return StringUtil::EnumToString(GetVerificationTypeValues(), 11, "VerificationType",
                                        static_cast<uint32_t>(value));
    }

    template<>
    VerificationType EnumUtil::FromString<VerificationType>(const char *value) {
        return static_cast<VerificationType>(StringUtil::StringToEnum(GetVerificationTypeValues(), 11,
    ...
    VerifyExistenceType EnumUtil::FromString<VerifyExistenceType>(const char *value) {
        return static_cast<VerifyExistenceType>(StringUtil::StringToEnum(
            GetVerifyExistenceTypeValues(), 3, "VerifyExistenceType", value));
    }
    ...
    WindowAggregationMode EnumUtil::FromString<WindowAggregationMode>(const char *value) {
        return static_cast<WindowAggregationMode>(StringUtil::StringToEnum(
            GetWindowAggregationModeValues(), 3, "WindowAggregationMode", value));
    }
    ...
    WindowBoundary EnumUtil::FromString<WindowBoundary>(const char *value) {
        return static_cast<WindowBoundary>(StringUtil::StringToEnum(GetWindowBoundaryValues(), 12, "WindowBoundary",
                                                                    value));
    }
    ...
    const char *EnumUtil::ToChars<WindowExcludeMode>(WindowExcludeMode value) {
        return StringUtil::EnumToString(GetWindowExcludeModeValues(), 4, "WindowExcludeMode",
                                        static_cast<uint32_t>(value));
    }

    template<>
    WindowExcludeMode EnumUtil::FromString<WindowExcludeMode>(const char *value) {
        return static_cast<WindowExcludeMode>(StringUtil::StringToEnum(GetWindowExcludeModeValues(), 4,
                                                                       "WindowExcludeMode", value));
    }
    ...
    WindowMergeSortStage EnumUtil::FromString<WindowMergeSortStage>(const char *value) {
        return static_cast<WindowMergeSortStage>(StringUtil::StringToEnum(
            GetWindowMergeSortStageValues(), 5, "WindowMergeSortStage", value));
    }
}
