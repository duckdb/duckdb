...
bool GlobMultiFileList::ExpandNextPath(idx_t max_files, optional_ptr<HiveFilterParams> hive_filter_params) {
	return ExpandPathInternal(current_path, expanded_files, max_files, hive_filter_params);
}
