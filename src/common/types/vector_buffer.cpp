...
buffer_ptr<VectorBuffer> VectorBuffer::CreateStandardVector(VectorType vector_type, const LogicalType &type, idx_t capacity) {
	return make_buffer<VectorBuffer>(vector_type, type, capacity * GetTypeIdSize(type.InternalType()));
}

buffer_ptr<VectorBuffer> VectorBuffer::CreateStandardVector(VectorType vector_type, PhysicalType type, idx_t capacity) {
	return make_buffer<VectorBuffer>(vector_type, capacity * GetTypeIdSize(type));
}
