...
template <class MJ, class L_ARG, class R_ARG> static size_t merge_join(L_ARG &l, R_ARG &r) {
	switch (l.type) {
	case TypeId::TINYINT:
...
static size_t perform_merge_join(L_ARG &l, R_ARG &r, ExpressionType comparison_type) {
...
size_t MergeJoinMark::Perform(MergeInfo &l, MergeInfo &r, ExpressionType comparison_type) {
