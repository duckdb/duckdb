...
PhysicalUpdate::PhysicalUpdate(ArenaAllocator &arena, vector<LogicalType> types, TableCatalogEntry &tableref,
                               ...
                               bool return_chunk)
    : PhysicalOperator(arena, PhysicalOperatorType::UPDATE, std::move(types), estimated_cardinality),
