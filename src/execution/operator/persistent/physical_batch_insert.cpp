...
PhysicalBatchInsert::PhysicalBatchInsert(ArenaAllocator &arena, vector<LogicalType> types_p, TableCatalogEntry &table,
...
PhysicalBatchInsert::PhysicalBatchInsert(ArenaAllocator &arena, LogicalOperator &op, SchemaCatalogEntry &schema,
