...
bool ParallelCSVReader::BufferRemainder(bool &reached_remainder_state) {
...
bool ParallelCSVReader::TryParseSimpleCSV(DataChunk &insert_chunk, string &error_message) {
