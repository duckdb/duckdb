...
public:
	PhysicalIndexJoinOperatorState(ExecutionContext &execution_context, PhysicalOperator &op, PhysicalOperator *left,
...
unique_ptr<PhysicalOperatorState> PhysicalIndexJoin::GetOperatorState(ExecutionContext &execution_context) {
	auto state =
	    make_unique<PhysicalIndexJoinOperatorState>(execution_context, *this, children[0].get(), children[1].get());
