...
static uint8_t GetCandidateSpecificity(const LogicalType &candidate_type) {
	...
	const duckdb::unordered_map<uint8_t, uint8_t> auto_type_candidates_specificity {
	    ...
	    {static_cast<uint8_t>(LogicalTypeId::BIGNUM), 4},     {static_cast<uint8_t>(LogicalTypeId::UHUGEINT), 5},
	    {static_cast<uint8_t>(LogicalTypeId::HUGEINT), 6},    {static_cast<uint8_t>(LogicalTypeId::BIGINT), 7},
	    {static_cast<uint8_t>(LogicalTypeId::INTEGER), 8},    {static_cast<uint8_t>(LogicalTypeId::SMALLINT), 9},
	    {static_cast<uint8_t>(LogicalTypeId::TINYINT), 10},   {static_cast<uint8_t>(LogicalTypeId::TIMESTAMP_TZ), 11},
	    {static_cast<uint8_t>(LogicalTypeId::TIMESTAMP), 12}, {static_cast<uint8_t>(LogicalTypeId::DATE), 13},
	    {static_cast<uint8_t>(LogicalTypeId::TIME), 14},      {static_cast<uint8_t>(LogicalTypeId::BOOLEAN), 15},
	    {static_cast<uint8_t>(LogicalTypeId::SQLNULL), 16}};
