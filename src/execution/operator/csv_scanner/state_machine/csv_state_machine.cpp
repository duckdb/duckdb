...
CSVStateMachine::CSVStateMachine(const CSVReaderOptions &options_p, const CSVStateMachineOptions &state_machine_options_p,
                                 shared_ptr<CSVStateMachineCache> csv_state_machine_cache_p)
    : state_machine_cache(std::move(csv_state_machine_cache_p)),
      transition_array(state_machine_cache->Get(state_machine_options_p)),
