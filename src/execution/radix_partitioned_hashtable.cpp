...
public:
	explicit RadixHTLocalSourceState(const RadixPartitionedHashTable &ht) {
...
unique_ptr<LocalSourceState> RadixPartitionedHashTable::GetLocalSourceState() const {
	return make_unique<RadixHTLocalSourceState>(*this);
}
