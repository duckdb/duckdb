...
//===--------------------------------------------------------------------===//
bool ART::FullScan(ARTRowIdCollection &row_ids) {
	if (!tree.HasMetadata()) {
		return true;
	}
	Iterator it(*this);
...
bool ART::SearchEqual(ARTKey &key, ARTRowIdCollection &row_ids) {
...
bool ART::SearchGreater(ARTKey &key, bool equal, ARTRowIdCollection &row_ids) {
	if (!tree.HasMetadata()) {
		return true;
	}
...
bool ART::SearchLess(ARTKey &upper_bound, bool equal, ARTRowIdCollection &row_ids) {
	if (!tree.HasMetadata()) {
		return true;
	}
...
bool ART::Scan(IndexScanState &state, ARTRowIdCollection &row_ids) {
