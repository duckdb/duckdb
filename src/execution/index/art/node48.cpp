...
void Node48::DeleteChild(ART &art, ARTNode &node, const uint8_t byte) {
	...
	ARTNode::Free(art, n48->children[n48->child_index[byte]]);
	n48->child_index[byte] = ARTNode::EMPTY_MARKER;
	n48->count--;
...
ARTNode *Node48::GetNextChild(uint8_t &byte) {
