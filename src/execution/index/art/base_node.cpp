...
void BaseNode<CAPACITY, NODE_TYPE>::InsertChildInternal(BaseNode &n, const uint8_t byte, const NodePointer child) {
...
template <uint8_t CAPACITY, NType NODE_TYPE>
NodeHandle BaseNode<CAPACITY, NODE_TYPE>::DeleteChildInternal(ART &art, NodePointer &node, const uint8_t byte) {
