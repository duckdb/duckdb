...
static StaticFunctionDefinition internal_functions[] = {
	...
	DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(ArgmaxnullFun),
	DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(ArgminFun),
	DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(ArgminnullFun),
	...
	DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(MaxNullByFun),
	...
	DUCKDB_AGGREGATE_FUNCTION_SET_ALIAS(MinNullByFun),
