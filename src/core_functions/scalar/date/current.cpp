...
ScalarFunction CurrentTimeFun::GetFunction() {
	...
	current_time.result_type = FunctionResultType::CONSISTENT_WITHIN_QUERY;
	return current_time;
}

ScalarFunction CurrentDateFun::GetFunction() {
	ScalarFunction current_date({}, LogicalType::DATE, CurrentDateFunction);
	current_date.result_type = FunctionResultType::CONSISTENT_WITHIN_QUERY;
	return current_date;
}
...
ScalarFunction GetCurrentTimestampFun::GetFunction() {
	...
	current_timestamp.result_type = FunctionResultType::CONSISTENT_WITHIN_QUERY;
