...
FilterPropagateResult IsNullFilter::CheckStatistics(const BaseStatistics &stats) {
...
FilterPropagateResult IsNotNullFilter::CheckStatistics(const BaseStatistics &stats) {
	if (!stats.CanHaveNoNull()) {
