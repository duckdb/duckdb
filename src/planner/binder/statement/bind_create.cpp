...
void Binder::BindCreateViewInfo(CreateViewInfo &base) {
	...
	auto should_create_dependencies = BooleanValue::Get(db_config.GetSetting<EnableViewDependenciesSetting>(context));
...
SchemaCatalogEntry &Binder::BindCreateFunctionInfo(CreateInfo &info) {
	...
	for (auto &function : base.macros) {
		...
		auto should_create_dependencies =
		    BooleanValue::Get(db_config.GetSetting<EnableMacroDependenciesSetting>(context));
