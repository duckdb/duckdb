...
TableFunction::TableFunction(string name, const vector<LogicalType> &arguments, table_function_t function_,
    ...
    : SimpleNamedParameterFunction(std::move(name), arguments), bind(bind), bind_replace(nullptr),
      ...
      dependency(nullptr), cardinality(nullptr), rows_scanned(nullptr), row_groups_seq_scanned(nullptr),
      row_groups_total(nullptr), pushdown_complex_filter(nullptr), pushdown_expression(nullptr), to_string(nullptr),
