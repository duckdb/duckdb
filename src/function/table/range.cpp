...
void RangeTableFunction::RegisterFunction(BuiltinFunctions &set) {
	...
	range_function.parallelize_sequential_source = ParallelizeSequentialSource::DISABLED;
	...
	range_in_out.parallelize_sequential_source = ParallelizeSequentialSource::DISABLED;
	...
	generate_series_in_out.parallelize_sequential_source = ParallelizeSequentialSource::DISABLED;
