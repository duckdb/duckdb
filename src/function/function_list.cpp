...
static const StaticFunctionDefinition function[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET(InternalCompressDecimalBigintFun),
	DUCKDB_SCALAR_FUNCTION_SET(InternalCompressDecimalIntegerFun),
	DUCKDB_SCALAR_FUNCTION_SET(InternalCompressDecimalSmallintFun),
	DUCKDB_SCALAR_FUNCTION_SET(InternalCompressDecimalTinyintFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(InternalDecompressDecimalFun),
