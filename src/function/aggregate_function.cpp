...
bool AggregateFunctionCallbacks::operator==(const AggregateFunctionCallbacks &rhs) const {
	return state_size == rhs.state_size && initialize == rhs.initialize && update == rhs.update &&
	       ...
	       statistics_identity == rhs.statistics_identity && serialize == rhs.serialize &&
	       deserialize == rhs.deserialize && deserialize_identity == rhs.deserialize_identity &&
	       direct_rewrite == rhs.direct_rewrite && rewrite == rhs.rewrite && rewrite_policy == rhs.rewrite_policy &&
