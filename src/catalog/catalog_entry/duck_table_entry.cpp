...
vector<ColumnSegmentInfo> DuckTableEntry::GetColumnSegmentInfo(const QueryContext &context, bool only_loaded_segments) {
	return storage->GetColumnSegmentInfo(context, only_loaded_segments);
}
