...
static const DefaultMacro internal_macros[] = {
	...
	{"pg_catalog", "current_database", {nullptr}, {{nullptr, nullptr}}, "system.current_database()"},  	    // name of current database (called "catalog" in the SQL standard)
	{"pg_catalog", "current_query", {nullptr}, {{nullptr, nullptr}}, "system.current_query()"},  	        // the currently executing query (NULL if not inside a plpgsql function)
	{"pg_catalog", "current_schema", {nullptr}, {{nullptr, nullptr}}, "system.current_schema()"},  	        // name of current schema
	{"pg_catalog", "current_schemas", {"include_implicit"}, {{nullptr, nullptr}}, "system.current_schemas(include_implicit)"},  	// names of schemas in search path
