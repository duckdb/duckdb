...
static DefaultView internal_views[] = {
    ...
    {"pg_catalog", "pg_index", "SELECT index_oid indexrelid, table_oid indrelid, 0 indnatts, 0 indnkeyatts, is_unique indisunique, NULL::BOOLEAN indisprimary, false indisexclusion, true indimmediate, false indisclustered, true indisvalid, false indcheckxmin, true indisready, true indislive, false indisreplident, NULL indkey, NULL indcollation, NULL indclass, NULL indoption, expressions indexprs, NULL indpred FROM duckdb_indexes()"},
