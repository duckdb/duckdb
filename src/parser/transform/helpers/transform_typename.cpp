...
SQLType Transformer::TransformTypeName(postgres::PGTypeName *type_name) {
	auto name = (reinterpret_cast<postgres::PGValue *>(type_name->names->tail->data.ptr_value)->val.str);
