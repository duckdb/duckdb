...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformRenameAlterSequenceOptionsInternal(PEGTransformer &transformer,
                                                                   ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto rename_alter = transformer.Transform<unique_ptr<AlterTableInfo>>(list_pr.GetChild(0));
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformAnalyzeStatementInternal(PEGTransformer &transformer,
                                                                                          ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto analyze_keyword = transformer.Transform<Identifier>(list_pr.GetChild(0));
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformAnalyzeKeywordInternal(PEGTransformer &transformer,
                                                                                        ParseResult &parse_result) {
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformCopyGenericOptionListInternal(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	vector<GenericCopyOption> copy_generic_option;
	auto copy_generic_option_items = ExtractParseResultsFromList(ExtractResultFromParens(list_pr.GetChild(0)));
	for (auto &copy_generic_option_item : copy_generic_option_items) {
		auto copy_generic_option_value = transformer.Transform<GenericCopyOption>(copy_generic_option_item.get());
		copy_generic_option.push_back(copy_generic_option_value);
	}
	auto result = TransformCopyGenericOptionList(transformer, copy_generic_option);
	return make_uniq<TypedTransformResult<vector<GenericCopyOption>>>(result);
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformCopyGenericOptionInternal(PEGTransformer &transformer,
                                                                                           ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto result = transformer.Transform<GenericCopyOption>(choice_pr.GetResult());
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformOrderByCopyOptionInternal(PEGTransformer &transformer,
                                                                                           ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformPartitionedByCopyOptionInternal(PEGTransformer &transformer,
                                                                ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	optional<GenericCopyOptionValue> generic_copy_option_value {};
	auto &generic_copy_option_value_opt = list_pr.GetChild(2).Cast<OptionalParseResult>();
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformShowDeprecatedSelectInternal(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto show_rule = transformer.Transform<ShowType>(list_pr.GetChild(0));
	auto select_statement_internal = transformer.Transform<unique_ptr<SelectStatement>>(list_pr.GetChild(1));
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformDescribeSelectInternal(PEGTransformer &transformer,
                                                                                        ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto describe_or_summarize = transformer.Transform<ShowType>(list_pr.GetChild(0));
	auto select_statement_internal = transformer.Transform<unique_ptr<SelectStatement>>(list_pr.GetChild(1));
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformShowByNameInternal(PEGTransformer &transformer,
                                                                                    ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto show_rule = transformer.Transform<ShowType>(list_pr.GetChild(0));
	...
	if (show_target_opt.HasResult()) {
		auto show_target_value = transformer.Transform<DescribeTarget>(show_target_opt.GetResult());
		show_target = std::move(show_target_value);
	}
	auto result = TransformShowByName(transformer, show_rule, std::move(show_target));
	return make_uniq<TypedTransformResult<unique_ptr<QueryNode>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformDescribeByNameInternal(PEGTransformer &transformer,
                                                                                        ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto describe_or_summarize = transformer.Transform<ShowType>(list_pr.GetChild(0));
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformDescribeOrSummarizeInternal(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformShowTargetInternal(PEGTransformer &transformer,
                                                                                    ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto &choice_result = choice_pr.GetResult();
	DescribeTarget result {};
	if (!(choice_result.name == "ShowSpecialForm")) {
		result = transformer.Transform<DescribeTarget>(choice_result);
	}
	return make_uniq<TypedTransformResult<DescribeTarget>>(std::move(result));
}

unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformShowDeprecatedQualifiedTableNameInternal(PEGTransformer &transformer,
                                                                         ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto qualified_table_name = transformer.Transform<unique_ptr<BaseTableRef>>(list_pr.GetChild(0));
	auto result = TransformShowDeprecatedQualifiedTableName(transformer, std::move(qualified_table_name));
	return make_uniq<TypedTransformResult<DescribeTarget>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformShowSettingNameInternal(PEGTransformer &transformer,
                                                                                         ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformExplainStatementInternal(PEGTransformer &transformer,
	...
	if (analyze_keyword_opt.HasResult()) {
		auto analyze_keyword_value = transformer.Transform<Identifier>(analyze_keyword_opt.GetResult());
		analyze_keyword = analyze_keyword_value;
	}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformExplainOptionNameInternal(PEGTransformer &transformer,
                                                                                           ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto result = TransformExplainOptionName(transformer, choice_pr.GetResult());
	return make_uniq<TypedTransformResult<Identifier>>(result);
}
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformFunctionNameAsQualifiedNameInternal(PEGTransformer &transformer,
                                                                    ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformIdentifierWindowFrameInternal(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto identifier = list_pr.GetChild(0).Cast<IdentifierParseResult>().identifier;
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformMeasureSemanticsExpressionInternal(PEGTransformer &transformer,
                                                                   ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto measure_semantics = transformer.Transform<bool>(list_pr.GetChild(0));
	auto function_expression = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(1));
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformTableMatchRecognizeClauseInternal(PEGTransformer &transformer,
                                                                  ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto match_recognize_body =
	...
	auto result = TransformTableMatchRecognizeClause(transformer, std::move(match_recognize_body), table_alias);
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformMeasuresClauseInternal(PEGTransformer &transformer,
	...
	auto measures_element_items = ExtractParseResultsFromList(list_pr.GetChild(1));
	for (auto &measures_element_item : measures_element_items) {
		auto measures_element_value = transformer.Transform<unique_ptr<ParsedExpression>>(measures_element_item.get());
		measures_element.push_back(std::move(measures_element_value));
	}
	auto result = TransformMeasuresClause(transformer, std::move(measures_element));
	return make_uniq<TypedTransformResult<vector<unique_ptr<ParsedExpression>>>>(std::move(result));
}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformAllRowsPerMatchInternal(PEGTransformer &transformer,
	...
	if (all_rows_empty_matches_opt.HasResult()) {
		auto all_rows_empty_matches_value =
		    transformer.Transform<MatchRecognizeRows>(all_rows_empty_matches_opt.GetResult());
		all_rows_empty_matches = all_rows_empty_matches_value;
	}
...
unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformAllRowsEmptyMatchesInternal(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto result = transformer.Transform<MatchRecognizeRows>(choice_pr.GetResult());
	return make_uniq<TypedTransformResult<MatchRecognizeRows>>(result);
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformShowEmptyMatchesInternal(PEGTransformer &transformer,
                                                                                          ParseResult &parse_result) {
	auto result = TransformShowEmptyMatches(transformer);
	return make_uniq<TypedTransformResult<MatchRecognizeRows>>(result);
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformOmitEmptyMatchesInternal(PEGTransformer &transformer,
                                                                                          ParseResult &parse_result) {
	auto result = TransformOmitEmptyMatches(transformer);
	return make_uniq<TypedTransformResult<MatchRecognizeRows>>(result);
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformWithUnmatchedRowsInternal(PEGTransformer &transformer,
                                                                                           ParseResult &parse_result) {
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformAfterMatchSkipInternal(PEGTransformer &transformer,
                                                                                        ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto after_match_skip_target = transformer.Transform<MatchRecognizeAfterMatchClause>(list_pr.GetChild(3));
	auto result = std::move(after_match_skip_target);
	return make_uniq<TypedTransformResult<MatchRecognizeAfterMatchClause>>(std::move(result));
}

unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformAfterMatchSkipTargetInternal(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto result = transformer.Transform<MatchRecognizeAfterMatchClause>(choice_pr.GetResult());
	return make_uniq<TypedTransformResult<MatchRecognizeAfterMatchClause>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformSkipToNextRowInternal(PEGTransformer &transformer,
                                                                                       ParseResult &parse_result) {
	auto result = TransformSkipToNextRow(transformer);
	return make_uniq<TypedTransformResult<MatchRecognizeAfterMatchClause>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformSkipPastLastRowInternal(PEGTransformer &transformer,
                                                                                         ParseResult &parse_result) {
	auto result = TransformSkipPastLastRow(transformer);
	return make_uniq<TypedTransformResult<MatchRecognizeAfterMatchClause>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformSkipToFirstVarInternal(PEGTransformer &transformer,
                                                                                        ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto col_label_or_string = transformer.Transform<Identifier>(list_pr.GetChild(2));
	auto result = TransformSkipToFirstVar(transformer, col_label_or_string);
	return make_uniq<TypedTransformResult<MatchRecognizeAfterMatchClause>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformSkipToLastVarInternal(PEGTransformer &transformer,
                                                                                       ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto col_label_or_string = transformer.Transform<Identifier>(list_pr.GetChild(2));
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformSkipToVarInternal(PEGTransformer &transformer,
                                                                                   ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto col_label_or_string = transformer.Transform<Identifier>(list_pr.GetChild(1));
	auto result = TransformSkipToVar(transformer, col_label_or_string);
	return make_uniq<TypedTransformResult<MatchRecognizeAfterMatchClause>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformPatternClauseInternal(PEGTransformer &transformer,
                                                                                       ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto row_pattern =
	    transformer.Transform<unique_ptr<ParsedExpression>>(ExtractResultFromParens(list_pr.GetChild(1)));
	auto result = std::move(row_pattern);
	return make_uniq<TypedTransformResult<unique_ptr<ParsedExpression>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRowPatternInternal(PEGTransformer &transformer,
                                                                                    ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto row_pattern_term = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(0));
	optional<vector<unique_ptr<ParsedExpression>>> row_pattern_alternative {};
	auto &row_pattern_alternative_opt = list_pr.GetChild(1).Cast<OptionalParseResult>();
	if (row_pattern_alternative_opt.HasResult()) {
		vector<unique_ptr<ParsedExpression>> row_pattern_alternative_value;
		auto &row_pattern_alternative_value_repeat_1 =
		    row_pattern_alternative_opt.GetResult().Cast<RepeatParseResult>();
		for (auto &row_pattern_alternative_value_item_1 : row_pattern_alternative_value_repeat_1.GetChildren()) {
			auto row_pattern_alternative_value_value_1 =
			    transformer.Transform<unique_ptr<ParsedExpression>>(row_pattern_alternative_value_item_1.get());
			row_pattern_alternative_value.push_back(std::move(row_pattern_alternative_value_value_1));
		}
		row_pattern_alternative = std::move(row_pattern_alternative_value);
	}
	auto result = TransformRowPattern(transformer, std::move(row_pattern_term), std::move(row_pattern_alternative));
	return make_uniq<TypedTransformResult<unique_ptr<ParsedExpression>>>(std::move(result));
}

unique_ptr<TransformResultValue>
PEGTransformerFactory::TransformRowPatternAlternativeInternal(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto row_pattern_term = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(1));
	auto result = std::move(row_pattern_term);
	return make_uniq<TypedTransformResult<unique_ptr<ParsedExpression>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRowPatternTermInternal(PEGTransformer &transformer,
                                                                                        ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	vector<unique_ptr<ParsedExpression>> row_pattern_factor;
	auto &row_pattern_factor_repeat = list_pr.GetChild(0).Cast<RepeatParseResult>();
	for (auto &row_pattern_factor_item : row_pattern_factor_repeat.GetChildren()) {
		auto row_pattern_factor_value =
		    transformer.Transform<unique_ptr<ParsedExpression>>(row_pattern_factor_item.get());
		row_pattern_factor.push_back(std::move(row_pattern_factor_value));
	}
	auto result = TransformRowPatternTerm(transformer, std::move(row_pattern_factor));
	return make_uniq<TypedTransformResult<unique_ptr<ParsedExpression>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRowPatternFactorInternal(PEGTransformer &transformer,
                                                                                          ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto row_pattern_primary = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(0));
	optional<MatchRecognizeQuantifier> row_pattern_quantifier {};
	auto &row_pattern_quantifier_opt = list_pr.GetChild(1).Cast<OptionalParseResult>();
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRowPatternPrimaryInternal(PEGTransformer &transformer,
                                                                                           ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto result = transformer.Transform<unique_ptr<ParsedExpression>>(choice_pr.GetResult());
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRowPatternEmptyInternal(PEGTransformer &transformer,
                                                                                         ParseResult &parse_result) {
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRowPatternLabelInternal(PEGTransformer &transformer,
	...
	auto result = TransformRowPatternLabel(transformer, col_label_or_string);
	return make_uniq<TypedTransformResult<unique_ptr<ParsedExpression>>>(std::move(result));
}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformDefineClauseInternal(PEGTransformer &transformer,
	...
	auto define_element_items = ExtractParseResultsFromList(list_pr.GetChild(1));
	for (auto &define_element_item : define_element_items) {
		auto define_element_value = transformer.Transform<unique_ptr<ParsedExpression>>(define_element_item.get());
		define_element.push_back(std::move(define_element_value));
	}
	auto result = TransformDefineClause(transformer, std::move(define_element));
	return make_uniq<TypedTransformResult<vector<unique_ptr<ParsedExpression>>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformDefineElementInternal(PEGTransformer &transformer,
                                                                                       ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto col_label_or_string = transformer.Transform<Identifier>(list_pr.GetChild(0));
	auto expression = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(2));
	auto result = TransformDefineElement(transformer, col_label_or_string, std::move(expression));
	return make_uniq<TypedTransformResult<unique_ptr<ParsedExpression>>>(std::move(result));
}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformOffsetFetchClauseInternal(PEGTransformer &transformer,
                                                                                           ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto offset_clause = transformer.Transform<LimitPercentResult>(list_pr.GetChild(0));
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformQualifiedTableNameInternal(PEGTransformer &transformer,
                                                                                            ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto result = transformer.Transform<unique_ptr<BaseTableRef>>(choice_pr.GetResult());
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformFetchValueInternal(PEGTransformer &transformer,
                                                                                    ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto expression = transformer.Transform<unique_ptr<ParsedExpression>>(list_pr.GetChild(0));
...
void PEGTransformerFactory::RegisterGenerated() {
	static const TransformFinalizeRule builtin_transform_rules[] = {
	    ...
	    {"RenameAlterSequenceOptions", &PEGTransformerFactory::TransformRenameAlterSequenceOptionsInternal},
	    ...
	    {"AnalyzeKeyword", &PEGTransformerFactory::TransformAnalyzeKeywordInternal},
	    ...
	    {"CopyGenericOptionList", &PEGTransformerFactory::TransformCopyGenericOptionListInternal},
	    {"CopyGenericOption", &PEGTransformerFactory::TransformCopyGenericOptionInternal},
	    {"OrderByCopyOption", &PEGTransformerFactory::TransformOrderByCopyOptionInternal},
	    {"PartitionedByCopyOption", &PEGTransformerFactory::TransformPartitionedByCopyOptionInternal},
	    ...
	    {"ShowDeprecatedSelect", &PEGTransformerFactory::TransformShowDeprecatedSelectInternal},
	    {"DescribeSelect", &PEGTransformerFactory::TransformDescribeSelectInternal},
	    ...
	    {"ShowByName", &PEGTransformerFactory::TransformShowByNameInternal},
	    {"DescribeByName", &PEGTransformerFactory::TransformDescribeByNameInternal},
	    {"DescribeOrSummarize", &PEGTransformerFactory::TransformDescribeOrSummarizeInternal},
	    {"ShowTarget", &PEGTransformerFactory::TransformShowTargetInternal},
	    {"ShowDeprecatedQualifiedTableName", &PEGTransformerFactory::TransformShowDeprecatedQualifiedTableNameInternal},
	    {"ShowSettingName", &PEGTransformerFactory::TransformShowSettingNameInternal},
	    ...
	    {"FunctionNameAsQualifiedName", &PEGTransformerFactory::TransformFunctionNameAsQualifiedNameInternal},
	    ...
	    {"IdentifierWindowFrame", &PEGTransformerFactory::TransformIdentifierWindowFrameInternal},
	    ...
	    {"MeasureSemanticsExpression", &PEGTransformerFactory::TransformMeasureSemanticsExpressionInternal},
	    ...
	    {"AllRowsEmptyMatches", &PEGTransformerFactory::TransformAllRowsEmptyMatchesInternal},
	    {"ShowEmptyMatches", &PEGTransformerFactory::TransformShowEmptyMatchesInternal},
	    {"OmitEmptyMatches", &PEGTransformerFactory::TransformOmitEmptyMatchesInternal},
	    {"WithUnmatchedRows", &PEGTransformerFactory::TransformWithUnmatchedRowsInternal},
	    {"AfterMatchSkip", &PEGTransformerFactory::TransformAfterMatchSkipInternal},
	    {"AfterMatchSkipTarget", &PEGTransformerFactory::TransformAfterMatchSkipTargetInternal},
	    {"SkipToNextRow", &PEGTransformerFactory::TransformSkipToNextRowInternal},
	    {"SkipPastLastRow", &PEGTransformerFactory::TransformSkipPastLastRowInternal},
	    {"SkipToFirstVar", &PEGTransformerFactory::TransformSkipToFirstVarInternal},
	    {"SkipToLastVar", &PEGTransformerFactory::TransformSkipToLastVarInternal},
	    {"SkipToVar", &PEGTransformerFactory::TransformSkipToVarInternal},
	    {"PatternClause", &PEGTransformerFactory::TransformPatternClauseInternal},
	    {"RowPattern", &PEGTransformerFactory::TransformRowPatternInternal},
	    {"RowPatternAlternative", &PEGTransformerFactory::TransformRowPatternAlternativeInternal},
	    ...
	    {"RowPatternEmpty", &PEGTransformerFactory::TransformRowPatternEmptyInternal},
	    ...
	    {"QualifiedTableName", &PEGTransformerFactory::TransformQualifiedTableNameInternal},
