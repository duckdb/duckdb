...
unique_ptr<SQLStatement> PEGTransformerFactory::TransformCommentStatement(PEGTransformer &transformer,
	...
	if (comment_on_type == CatalogType::INVALID) {
		...
		info = make_uniq<SetColumnCommentInfo>(
		    Identifier(qualified_name.catalog.GetIdentifierName()),
		    Identifier(qualified_name.schema.GetIdentifierName()), Identifier(qualified_name.name.GetIdentifierName()),
		...
		info = make_uniq<SetCommentInfo>(comment_on_type, Identifier(qualified_name.catalog.GetIdentifierName()),
		                                 Identifier(qualified_name.schema.GetIdentifierName()),
		                                 Identifier(qualified_name.name.GetIdentifierName()), comment_value,
