...
unique_ptr<SQLStatement> PEGTransformerFactory::TransformTopLevelStatement(vector<MatcherToken> &tokens,
	...
	MatchState state(tokens, suggestions, parse_result_allocator, max_token_index, options.keyword_extension.get(),
	                 options.preserve_identifier_case, token_cursor, &packrat_cache);
