...
PEGTransformerFactory::TransformMergeMatch(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
...
pair<MergeActionCondition, unique_ptr<MergeIntoAction>>
PEGTransformerFactory::TransformMatchedClause(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
...
unique_ptr<MergeIntoAction> PEGTransformerFactory::TransformMatchedClauseAction(PEGTransformer &transformer,
                                                                                ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	return transformer.Transform<unique_ptr<MergeIntoAction>>(list_pr.Child<ChoiceParseResult>(0).GetResult());
}
...
unique_ptr<MergeIntoAction> PEGTransformerFactory::TransformUpdateMatchClause(PEGTransformer &transformer,
	...
	if (update_info.HasResult()) {
		result = transformer.Transform<unique_ptr<MergeIntoAction>>(update_info.GetResult());
	} else {
...
unique_ptr<UpdateSetInfo> PEGTransformerFactory::TransformUpdateMatchSetClause(PEGTransformer &transformer,
	...
	auto &choice_pr = inner_list.Child<ChoiceParseResult>(0).GetResult();
...
unique_ptr<MergeIntoAction> PEGTransformerFactory::TransformInsertMatchClause(PEGTransformer &transformer,
	...
	if (insert_info.HasResult()) {
		result = transformer.Transform<unique_ptr<MergeIntoAction>>(insert_info.GetResult());
	} else {
		result = make_uniq<MergeIntoAction>();
	}
...
unique_ptr<MergeIntoAction> PEGTransformerFactory::TransformErrorMatchClause(PEGTransformer &transformer,
	...
	if (expression_opt.HasResult()) {
		result->expressions.push_back(transformer.Transform<unique_ptr<ParsedExpression>>(expression_opt.GetResult()));
	}
	return result;
}
...
pair<MergeActionCondition, unique_ptr<MergeIntoAction>>
PEGTransformerFactory::TransformNotMatchedClause(PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
...
MergeActionCondition PEGTransformerFactory::TransformBySourceOrTarget(PEGTransformer &transformer,
                                                                      ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	return transformer.TransformEnum<MergeActionCondition>(list_pr.Child<ChoiceParseResult>(0).GetResult());
}
} // namespace duckdb
