...
unique_ptr<Constraint> CheckConstraint::Deserialize(FieldReader &source, ClientContext &context) {
	auto expression = source.ReadRequiredSerializable<ParsedExpression>(context);
