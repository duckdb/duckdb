...
class PhysicalTableScan : public PhysicalOperator {
  public:
	PhysicalTableScan(TableCatalogEntry &tableref, DataTable &table, std::vector<column_t> column_ids)
	    : PhysicalOperator(PhysicalOperatorType::SEQ_SCAN), tableref(tableref), table(table),
