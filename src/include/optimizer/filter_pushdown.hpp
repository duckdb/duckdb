...
private:
	...
	unique_ptr<LogicalOperator> PushdownLeftJoin(unique_ptr<LogicalOperator> op, unordered_set<uint64_t> &left_bindings,
	                                             unordered_set<uint64_t> &right_bindings);
	// Pushdown a mark join
	unique_ptr<LogicalOperator> PushdownMarkJoin(unique_ptr<LogicalOperator> op, unordered_set<uint64_t> &left_bindings,
	                                             unordered_set<uint64_t> &right_bindings);
