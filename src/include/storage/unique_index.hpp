...
public:
	UniqueIndex(DataTable &table, vector<TypeId> types, vector<index_t> keys, bool allow_nulls);
...
private:
	...
	UniqueIndexNode *AddEntry(Transaction &transaction, Tuple tuple, index_t row_identifier,
