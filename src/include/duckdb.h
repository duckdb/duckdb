...
#ifndef DUCKB_NO_CAPI_FUNCTIONS
...
// Note: obviously we would want some codegen like way to create this
typedef struct {
	// Example subset of CAPI to support a basic scalar function example
...
// We could have v2 APIs here as well where we can allow full changes to the struct
