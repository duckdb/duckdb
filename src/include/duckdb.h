...
*
* @param info A profiling information object
* @return The name of the operator of the current node. Returns a nullptr if the node is not an Operator Node. The result must be freed with `duckdb_free`.
*/
...
* @param info A profiling information object
* @return The query of the current node. Returns a nullptr if the node is not a Query Node. The result must be freed with `duckdb_free`.
*/
