...
public:
	LogicalInsert(TableCatalogEntry *table, vector<unique_ptr<Expression>> bound_defaults) : LogicalOperator(LogicalOperatorType::INSERT), table(table), bound_defaults(move(bound_defaults)) {
	}
