...
public:
	BoundReferenceExpression(string alias, TypeId type, uint32_t index, SQLType sql_type = SQLType());
	BoundReferenceExpression(TypeId type, uint32_t index, SQLType sql_type = SQLType());
