...
//===--------------------------------------------------------------------===//
typedef struct {
#if  DUCKDB_EXTENSION_API_VERSION_MINOR > 2 || (DUCKDB_EXTENSION_API_VERSION_MINOR == 2 &&  DUCKDB_EXTENSION_API_VERSION_PATCH >= 0) // v1.2.0
...
#define duckdb_table_function_supports_projection_pushdown duckdb_ext_api.duckdb_table_function_supports_projection_pushdown
...
#define duckdb_copy_function_global_init_get_client_context duckdb_ext_api.duckdb_copy_function_global_init_get_client_context
...
#define duckdb_copy_function_global_init_set_global_state duckdb_ext_api.duckdb_copy_function_global_init_set_global_state
...
#define duckdb_table_function_bind_get_result_column_count duckdb_ext_api.duckdb_table_function_bind_get_result_column_count
#define duckdb_table_function_bind_get_result_column_name duckdb_ext_api.duckdb_table_function_bind_get_result_column_name
...
#define DUCKDB_EXTENSION_API_INIT(info, access, minimum_api_version) duckdb_ext_api_v1 * res = (duckdb_ext_api_v1 *)access->get_api(info, minimum_api_version); if (!res) {return false;}; duckdb_ext_api = *res;
#endif // DUCKDB_BUILD_STATIC_EXTENSION
