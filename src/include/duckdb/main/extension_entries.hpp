...
static constexpr ExtensionEntry EXTENSION_SECRET_TYPES[] = {
    {"azure", "azure"}, {"ducklake", "ducklake"},    {"mysql", "mysql_scanner"}, {"postgres", "postgres_scanner"},
    {"quack", "quack"}, {"rds", "postgres_scanner"}, {"uc", "unity_catalog"},    {"unity_catalog", "unity_catalog"},
