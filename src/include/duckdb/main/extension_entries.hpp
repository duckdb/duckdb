...
struct ExtensionFunctionOverloadEntry {
	...
	char extension[48];
	CatalogType type;
	char signature[192]; // must match SIGNATURE_BUFFER_SIZE in scripts/generate_extensions_function.py.
};
...
static constexpr ExtensionFunctionOverloadEntry EXTENSION_FUNCTION_OVERLOADS[] = {
    ...
    {"age", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[timestamp::TIMESTAMPTZ]>INTERVAL"},
    {"age", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[timestamp1::TIMESTAMPTZ,timestamp2::TIMESTAMPTZ]>INTERVAL"},
    ...
    {"century", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"date_diff", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[part::VARCHAR,startdate::TIMESTAMPTZ,enddate::TIMESTAMPTZ]>BIGINT"},
    {"date_diff", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[part::VARCHAR,startdate::TIMESTAMPTZ_NS,enddate::TIMESTAMPTZ_NS]>BIGINT"},
    ...
    {"date_part", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[part_list::'VARCHAR[]',ts::TIMESTAMPTZ]>STRUCT"},
    {"date_part", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[part::VARCHAR,ts::TIMESTAMPTZ]>DOUBLE"},
    ...
    {"date_trunc", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[part::VARCHAR,timestamp::TIMESTAMPTZ]>TIMESTAMPTZ"},
    ...
    {"datepart", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[part_list::'VARCHAR[]',ts::TIMESTAMPTZ]>STRUCT"},
    {"datepart", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[part::VARCHAR,ts::TIMESTAMPTZ]>DOUBLE"},
    ...
    {"datetrunc", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[part::VARCHAR,timestamp::TIMESTAMPTZ]>TIMESTAMPTZ"},
    ...
    {"day", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"dayname", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>VARCHAR"},
    ...
    {"dayofmonth", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"dayofweek", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"dayofyear", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"decade", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"epoch", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>DOUBLE"},
    ...
    {"era", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"generate_series", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[start::TIMESTAMPTZ,stop::TIMESTAMPTZ,step::INTERVAL]>TIMESTAMPTZ[]"},
    ...
    {"hour", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"isodow", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"isoyear", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"julian", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>DOUBLE"},
    ...
    {"last_day", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>DATE"},
    ...
    {"microsecond", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"millennium", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"millisecond", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"minute", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"month", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"monthname", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>VARCHAR"},
    ...
    {"quarter", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"second", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"time_bucket", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[bucket_width::INTERVAL,timestamp::TIMESTAMPTZ]>TIMESTAMPTZ"},
    {"time_bucket", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[bucket_width::INTERVAL,timestamp::TIMESTAMPTZ,offset::INTERVAL]>TIMESTAMPTZ"},
    {"time_bucket", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[bucket_width::INTERVAL,timestamp::TIMESTAMPTZ,origin::TIMESTAMPTZ]>TIMESTAMPTZ"},
    {"time_bucket", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[bucket_width::INTERVAL,timestamp::TIMESTAMPTZ,timezone::VARCHAR]>TIMESTAMPTZ"},
    ...
    {"timezone", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    {"timezone", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[timezone::VARCHAR,timestamp::TIMESTAMP]>TIMESTAMPTZ"},
    {"timezone", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[timezone::VARCHAR,timestamp::TIMESTAMPTZ]>TIMESTAMP"},
    {"timezone", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[timezone::VARCHAR,timestamp::TIMESTAMPTZ_NS]>TIMESTAMP_NS"},
    {"timezone", "icu", CatalogType::SCALAR_FUNCTION_ENTRY,
     "[timezone::VARCHAR,timestamp::TIMESTAMP_NS]>TIMESTAMPTZ_NS"},
    {"timezone", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[timezone::VARCHAR,timestamp::TIMETZ]>TIMETZ"},
    ...
    {"timezone_hour", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"timezone_minute", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"week", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"weekday", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"weekofyear", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"year", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
    ...
    {"yearweek", "icu", CatalogType::SCALAR_FUNCTION_ENTRY, "[ts::TIMESTAMPTZ]>BIGINT"},
