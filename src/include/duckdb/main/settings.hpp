...
struct CapitalizeIdentifierSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "capitalize_identifier";
	static constexpr const char *Description =
	    "When preserve_identifier_case is false, uppercase non-quoted identifiers instead of lowercasing them (no "
	    "effect when preserve_identifier_case is true)";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SettingScopeTarget Scope = SettingScopeTarget::LOCAL_DEFAULT;
