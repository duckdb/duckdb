...
struct EnableColumnImprintSetting {
    ...
    static constexpr const char *Description = "Enable column imprint for fine-grained pruning using 64-bit bitmaps (default: false).";
    static constexpr const char *InputType = "BOOLEAN";
    static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
    static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
    static Value GetSetting(const ClientContext &context);
...
struct HTTPLoggingOutputSetting {
    ...
    static constexpr const char *Description = "(deprecated) The file to which HTTP logging output should be saved, or empty to print to the terminal";
    static constexpr const char *InputType = "VARCHAR";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct IeeeFloatingPointOpsSetting {
    ...
    static constexpr const char *Description = "Use IEE754-compliant floating point operations (returning NAN instead of errors/NULL).";
    static constexpr const char *InputType = "BOOLEAN";
    static constexpr const char *DefaultValue = "true";
    static constexpr SetScope DefaultScope = SetScope::SESSION;
};
