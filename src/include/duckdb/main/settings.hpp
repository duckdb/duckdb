...
struct ReadAheadDepthSetting {
    ...
    static constexpr const char *Description = "Number of scan jobs the multi-file reader prefetches ahead of decoding. -1 = automatic (based on thread count), 0 = disabled.";
    static constexpr const char *InputType = "BIGINT";
    static constexpr const char *DefaultValue = "-1";
    static constexpr SettingScopeTarget Scope = SettingScopeTarget::GLOBAL_DEFAULT;
    static constexpr idx_t SettingIndex = NEXT_SETTING_INDEX();
