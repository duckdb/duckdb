...
struct ArrowFilterPushdownWithViewTypesSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "arrow_filter_pushdown_with_view_types";
	static constexpr const char *Description =
	    "Whether to allow filter pushdown into Arrow scans on tables containing string_view or binary_view columns. "
	    "Some Arrow libraries (e.g. pyarrow) do not support filtering on view types. Set to true if the Arrow library "
	    "in use supports it (e.g. Vortex).";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SettingScopeTarget Scope = SettingScopeTarget::GLOBAL_DEFAULT;
