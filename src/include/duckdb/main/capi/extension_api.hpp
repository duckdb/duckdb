...
inline duckdb_ext_api_v1 CreateAPIv1() {
	...
	result.duckdb_assign_constant_to_vector = duckdb_assign_constant_to_vector;
	result.duckdb_reference_vector_from_vector = duckdb_reference_vector_from_vector;
