...
inline duckdb_ext_api_v1 CreateAPIv1() {
	...
	result.duckdb_copy_function_to_add_option = duckdb_copy_function_to_add_option;
	...
	result.duckdb_copy_function_to_bind_get_option = duckdb_copy_function_to_bind_get_option;
	...
	result.duckdb_copy_function_from_add_option = duckdb_copy_function_from_add_option;
	...
	result.duckdb_copy_function_from_bind_get_option = duckdb_copy_function_from_bind_get_option;
