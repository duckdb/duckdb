...
inline duckdb_ext_api_v1 CreateAPIv1() {
	...
	result.duckdb_copy_function_to_set_bind = duckdb_copy_function_to_set_bind;
	result.duckdb_copy_function_to_bind_set_error = duckdb_copy_function_to_bind_set_error;
	result.duckdb_copy_function_to_bind_get_extra_info = duckdb_copy_function_to_bind_get_extra_info;
	result.duckdb_copy_function_to_bind_get_client_context = duckdb_copy_function_to_bind_get_client_context;
	result.duckdb_copy_function_to_bind_get_column_count = duckdb_copy_function_to_bind_get_column_count;
	result.duckdb_copy_function_to_bind_get_column_type = duckdb_copy_function_to_bind_get_column_type;
	result.duckdb_copy_function_to_bind_get_options = duckdb_copy_function_to_bind_get_options;
	result.duckdb_copy_function_to_bind_set_bind_data = duckdb_copy_function_to_bind_set_bind_data;
	result.duckdb_copy_function_to_set_global_init = duckdb_copy_function_to_set_global_init;
	result.duckdb_copy_function_to_global_init_set_error = duckdb_copy_function_to_global_init_set_error;
	result.duckdb_copy_function_to_global_init_get_extra_info = duckdb_copy_function_to_global_init_get_extra_info;
	result.duckdb_copy_function_to_global_init_get_client_context =
	    duckdb_copy_function_to_global_init_get_client_context;
	result.duckdb_copy_function_to_global_init_get_bind_data = duckdb_copy_function_to_global_init_get_bind_data;
	result.duckdb_copy_function_to_global_init_set_global_state = duckdb_copy_function_to_global_init_set_global_state;
	result.duckdb_copy_function_to_global_init_get_file_path = duckdb_copy_function_to_global_init_get_file_path;
	result.duckdb_copy_function_to_set_sink = duckdb_copy_function_to_set_sink;
	result.duckdb_copy_function_to_sink_set_error = duckdb_copy_function_to_sink_set_error;
	result.duckdb_copy_function_to_sink_get_extra_info = duckdb_copy_function_to_sink_get_extra_info;
	result.duckdb_copy_function_to_sink_get_client_context = duckdb_copy_function_to_sink_get_client_context;
	result.duckdb_copy_function_to_sink_get_bind_data = duckdb_copy_function_to_sink_get_bind_data;
	result.duckdb_copy_function_to_sink_get_global_state = duckdb_copy_function_to_sink_get_global_state;
	result.duckdb_copy_function_to_set_finalize = duckdb_copy_function_to_set_finalize;
	result.duckdb_copy_function_to_finalize_set_error = duckdb_copy_function_to_finalize_set_error;
	result.duckdb_copy_function_to_finalize_get_extra_info = duckdb_copy_function_to_finalize_get_extra_info;
	result.duckdb_copy_function_to_finalize_get_client_context = duckdb_copy_function_to_finalize_get_client_context;
	result.duckdb_copy_function_to_finalize_get_bind_data = duckdb_copy_function_to_finalize_get_bind_data;
	result.duckdb_copy_function_to_finalize_get_global_state = duckdb_copy_function_to_finalize_get_global_state;
	result.duckdb_copy_function_from_set_bind = duckdb_copy_function_from_set_bind;
	result.duckdb_copy_function_from_bind_set_error = duckdb_copy_function_from_bind_set_error;
	result.duckdb_copy_function_from_bind_get_extra_info = duckdb_copy_function_from_bind_get_extra_info;
	result.duckdb_copy_function_from_bind_get_client_context = duckdb_copy_function_from_bind_get_client_context;
	result.duckdb_copy_function_from_bind_get_options = duckdb_copy_function_from_bind_get_options;
	result.duckdb_copy_function_from_bind_set_bind_data = duckdb_copy_function_from_bind_set_bind_data;
	result.duckdb_copy_function_from_set_function = duckdb_copy_function_from_set_function;
