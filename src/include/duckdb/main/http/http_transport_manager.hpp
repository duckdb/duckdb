...
//                         DuckDB
//
// duckdb/main/http/http_transport_manager.hpp
//
//===----------------------------------------------------------------------===//
...
//! Managed reuse always requires an exact origin and HTTPTransportConfig match.
//! Provider reuse domains and CanReuse may restrict this further, never bypass it.
