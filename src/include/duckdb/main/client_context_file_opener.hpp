...
public:
	...
	bool TryGetCurrentSetting(const string &key, SettingLookupResult &result, FileOpenerInfo &info) override;
	bool TryGetCurrentSetting(const string &key, SettingLookupResult &result) override;
