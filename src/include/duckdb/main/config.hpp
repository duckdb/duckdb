...
#include "duckdb/function/drop_database_extension.hpp"
...
public:
	...
	//! Extensions made to binder to implement the drop_database functionality
	vector<DropDatabaseExtension> drop_database_extensions;
