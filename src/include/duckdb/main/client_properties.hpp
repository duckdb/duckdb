...
struct ClientProperties {
	ClientProperties(string time_zone_p, const ArrowOffsetSize arrow_offset_size_p, const bool arrow_use_list_view_p,
	                 ...
	                 const bool arrow_output_fixed_shape_tensor_p = false)
	    : time_zone(std::move(time_zone_p)), arrow_offset_size(arrow_offset_size_p),
	      ...
	      arrow_output_fixed_shape_tensor(arrow_output_fixed_shape_tensor_p),
	      arrow_output_version(arrow_output_version), client_context(client_context) {
	}
	ClientProperties() {};
	...
	bool arrow_output_fixed_shape_tensor = false;
