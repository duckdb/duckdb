...
inline duckdb_ext_api_v2 CreateAPIv2(void) {
	...
	result.duckdb_v2_execute_args_create = duckdb_v2_execute_args_create;
	result.duckdb_v2_execute_args_destroy = duckdb_v2_execute_args_destroy;
	result.duckdb_v2_execute_args_set_eagerness = duckdb_v2_execute_args_set_eagerness;
	result.duckdb_v2_execute_args_set_statement_params = duckdb_v2_execute_args_set_statement_params;
	...
	result.duckdb_v2_result_can_stream = duckdb_v2_result_can_stream;
	result.duckdb_v2_result_complete = duckdb_v2_result_complete;
	result.duckdb_v2_result_destroy = duckdb_v2_result_destroy;
	result.duckdb_v2_result_fetch = duckdb_v2_result_fetch;
	result.duckdb_v2_result_get_collection = duckdb_v2_result_get_collection;
	...
	result.duckdb_v2_result_materialize = duckdb_v2_result_materialize;
	result.duckdb_v2_result_poll = duckdb_v2_result_poll;
	result.duckdb_v2_result_render_box = duckdb_v2_result_render_box;
	result.duckdb_v2_result_step = duckdb_v2_result_step;
	result.duckdb_v2_result_stream_create = duckdb_v2_result_stream_create;
	result.duckdb_v2_result_stream_destroy = duckdb_v2_result_stream_destroy;
	result.duckdb_v2_result_stream_fetch = duckdb_v2_result_stream_fetch;
	result.duckdb_v2_result_stream_get_result_type = duckdb_v2_result_stream_get_result_type;
	result.duckdb_v2_result_stream_get_schema = duckdb_v2_result_stream_get_schema;
	result.duckdb_v2_result_stream_get_statement_type = duckdb_v2_result_stream_get_statement_type;
	result.duckdb_v2_result_stream_poll = duckdb_v2_result_stream_poll;
	result.duckdb_v2_result_stream_step = duckdb_v2_result_stream_step;
	result.duckdb_v2_result_stream_try_fetch = duckdb_v2_result_stream_try_fetch;
	result.duckdb_v2_result_stream_wait = duckdb_v2_result_stream_wait;
	result.duckdb_v2_result_take_collection = duckdb_v2_result_take_collection;
