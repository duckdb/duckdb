...
public:
	...
	//! Returns a reference to the query context.
	QueryContext &GetQueryContext();

protected:
	//! The query context in which we use the partial block manager.
	...
	//! Thus, we're using the QueryContext instead of the ClientContext.
