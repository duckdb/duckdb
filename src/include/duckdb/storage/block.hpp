...
public:
	Block(Allocator &allocator, const block_id_t id, const idx_t block_size, BlockManager &block_manager);
	Block(Allocator &allocator, block_id_t id, uint32_t internal_size, BlockManager &block_manager);
