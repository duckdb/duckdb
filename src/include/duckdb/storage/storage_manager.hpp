...
public:
	...
	virtual void CreateCheckpoint(ClientContext &context, bool delete_wal = false, bool force_checkpoint = false) = 0;
...
public:
	...
	void CreateCheckpoint(ClientContext &context, bool delete_wal, bool force_checkpoint) override;
