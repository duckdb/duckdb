...
class BaseSegment {
public:
	BaseSegment(DatabaseInstance &db, PhysicalType type, idx_t row_start);
	virtual ~BaseSegment();
...
public:
	...
	virtual void ScanPartial(ColumnScanState &state, idx_t start, idx_t scan_count, Vector &result,
