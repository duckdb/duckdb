...
public:
	...
	static constexpr uint8_t DICTIONARY_BIT_WIDTH = 3;
	static constexpr uint8_t DICTIONARY_SIZE = (1 << DICTIONARY_BIT_WIDTH); // 8
	...
	static constexpr uint8_t HEADER_SIZE = METADATA_POINTER_SIZE + RIGHT_BIT_WIDTH_SIZE; // Pointer to metadata + Right BW
};
