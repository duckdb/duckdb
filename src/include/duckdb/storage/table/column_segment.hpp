...
public:
	...
	virtual void Select(Transaction &transaction, ColumnScanState &state, vector<TableFilter> &tableFilter,
	                    SelectionVector &sel, SelectionVector &valid_sel, idx_t &approved_tuple_count, idx_t count) = 0;
