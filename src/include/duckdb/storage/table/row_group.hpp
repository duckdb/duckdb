...
public:
	...
	RowGroupWriteData WriteToDisk(PartialBlockManager &manager, const vector<CompressionType> &compression_types, vector<unique_ptr<BaseStatistics>> &global_stats);
