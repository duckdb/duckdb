...
public:
	...
	//! Returns current timestamp with millisecond resolution
	DUCKDB_API static timestamp_t GetCurrentTimestamp();
	//! Returns current timestamp with nanosecond resolution resolution
	DUCKDB_API static timestamp_ns_t GetCurrentTimestampNs();
