...
struct ConstantVector {
	...
	//! Turns "vector" into a constant vector by referencing a value within the other vector
	DUCKDB_API static void Reference(Vector &vector, Vector &other, idx_t position, idx_t count);
