...
public:
	...
	DUCKDB_API static void NegateInPlace(hugeint_t &input) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static hugeint_t Negate(hugeint_t input) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static hugeint_t Multiply(hugeint_t lhs, hugeint_t rhs) {
		hugeint_t result;
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static hugeint_t Divide(hugeint_t lhs, hugeint_t rhs) {
		// No division by zero
		if (rhs == 0) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static hugeint_t Modulo(hugeint_t lhs, hugeint_t rhs) {
		// No division by zero
		if (rhs == 0) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static hugeint_t Add(hugeint_t lhs, hugeint_t rhs) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static hugeint_t Subtract(hugeint_t lhs, hugeint_t rhs) {
