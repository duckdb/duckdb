...
public:
	...
	DUCKDB_API static void NegateInPlace(uhugeint_t &input) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static uhugeint_t Negate(uhugeint_t input) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static uhugeint_t Multiply(uhugeint_t lhs, uhugeint_t rhs) {
		uhugeint_t result;
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static uhugeint_t Divide(uhugeint_t lhs, uhugeint_t rhs) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static uhugeint_t Modulo(uhugeint_t lhs, uhugeint_t rhs) {
		if (rhs == 0) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static uhugeint_t Add(uhugeint_t lhs, uhugeint_t rhs) {
	...
	template <bool CHECK_OVERFLOW = true>
	DUCKDB_API static uhugeint_t Subtract(uhugeint_t lhs, uhugeint_t rhs) {
