...
public:
	...
	DUCKDB_API void Hash(const vector<idx_t> &column_ids, Vector &result);
	DUCKDB_API void Hash(const vector<idx_t> &column_ids, const SelectionVector &sel, idx_t count, Vector &result);
