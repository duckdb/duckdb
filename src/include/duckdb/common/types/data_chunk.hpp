...
public:
	...
	//! Set the DataChunk to reference a set of columns of another data chunk
	DUCKDB_API void ReferencePartial(DataChunk &chunk, const vector<column_t> &column_ids);
