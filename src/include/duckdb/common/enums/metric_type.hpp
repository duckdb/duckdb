...
enum class MetricType : uint8_t {
	...
	OPERATOR_ROW_GROUPS_SCANNED = 104,
	OPERATOR_TIMING = 9,
	...
	OPTIMIZER_DISJUNCTIVE_JOIN_REWRITER = 64,
	// PhaseTiming metrics
	ALL_OPTIMIZERS = 18,
...
public:
	...
	static constexpr uint8_t END_OPTIMIZER = static_cast<uint8_t>(MetricType::OPTIMIZER_DISJUNCTIVE_JOIN_REWRITER);
