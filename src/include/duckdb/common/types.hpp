...
public:
	static constexpr LogicalTypeId SQLNULL = LogicalTypeId::SQLNULL;
	static constexpr LogicalTypeId UNKNOWN = LogicalTypeId::UNKNOWN;
	static constexpr LogicalTypeId BOOLEAN = LogicalTypeId::BOOLEAN;
	static constexpr LogicalTypeId TINYINT = LogicalTypeId::TINYINT;
	static constexpr LogicalTypeId UTINYINT = LogicalTypeId::UTINYINT;
	static constexpr LogicalTypeId SMALLINT = LogicalTypeId::SMALLINT;
	static constexpr LogicalTypeId USMALLINT = LogicalTypeId::USMALLINT;
	static constexpr LogicalTypeId INTEGER = LogicalTypeId::INTEGER;
	static constexpr LogicalTypeId UINTEGER = LogicalTypeId::UINTEGER;
	static constexpr LogicalTypeId BIGINT = LogicalTypeId::BIGINT;
	static constexpr LogicalTypeId UBIGINT = LogicalTypeId::UBIGINT;
	static constexpr LogicalTypeId FLOAT = LogicalTypeId::FLOAT;
	static constexpr LogicalTypeId DOUBLE = LogicalTypeId::DOUBLE;
	static constexpr LogicalTypeId DATE = LogicalTypeId::DATE;
	static constexpr LogicalTypeId TIMESTAMP = LogicalTypeId::TIMESTAMP;
	static constexpr LogicalTypeId TIMESTAMP_S = LogicalTypeId::TIMESTAMP_SEC;
	static constexpr LogicalTypeId TIMESTAMP_MS = LogicalTypeId::TIMESTAMP_MS;
	static constexpr LogicalTypeId TIMESTAMP_NS = LogicalTypeId::TIMESTAMP_NS;
	static constexpr LogicalTypeId TIME = LogicalTypeId::TIME;
	static constexpr LogicalTypeId TIME_NS = LogicalTypeId::TIME_NS;
	static constexpr LogicalTypeId TIMESTAMP_TZ = LogicalTypeId::TIMESTAMP_TZ;
	static constexpr LogicalTypeId TIME_TZ = LogicalTypeId::TIME_TZ;
	static constexpr LogicalTypeId VARCHAR = LogicalTypeId::VARCHAR;
	static constexpr LogicalTypeId ANY = LogicalTypeId::ANY;
	static constexpr LogicalTypeId BLOB = LogicalTypeId::BLOB;
	static constexpr LogicalTypeId BIT = LogicalTypeId::BIT;
	static constexpr LogicalTypeId VARINT = LogicalTypeId::VARINT;

	static constexpr LogicalTypeId INTERVAL = LogicalTypeId::INTERVAL;
	static constexpr LogicalTypeId HUGEINT = LogicalTypeId::HUGEINT;
	static constexpr LogicalTypeId UHUGEINT = LogicalTypeId::UHUGEINT;
	static constexpr LogicalTypeId UUID = LogicalTypeId::UUID;
	static constexpr LogicalTypeId HASH = LogicalTypeId::UBIGINT;
	static constexpr LogicalTypeId POINTER = LogicalTypeId::POINTER;
	static constexpr LogicalTypeId TABLE = LogicalTypeId::TABLE;
	static constexpr LogicalTypeId LAMBDA = LogicalTypeId::LAMBDA;
	static constexpr LogicalTypeId INVALID = LogicalTypeId::INVALID;
	static constexpr LogicalTypeId ROW_TYPE = LogicalTypeId::BIGINT;
