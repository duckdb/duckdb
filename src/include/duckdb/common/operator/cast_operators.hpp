...
struct CastFromBlob {
	...
	template <class SRC> static inline void ToHexaString(SRC input, SRC &output) {
...
template <> void CastFromBlob::ToHexaString(duckdb::string_t input, duckdb::string_t &output);
