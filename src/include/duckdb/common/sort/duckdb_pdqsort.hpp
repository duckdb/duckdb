...
struct PDQConstants {
	PDQConstants(idx_t entry_size, idx_t comp_offset, idx_t comp_size, data_ptr_t end)
	    : entry_size(entry_size), comp_offset(comp_offset), comp_size(comp_size),
	      tmp_buf_ptr(make_array<data_t>(entry_size)), tmp_buf(tmp_buf_ptr.get()),
	      iter_swap_buf_ptr(make_array<data_t>(entry_size)), iter_swap_buf(iter_swap_buf_ptr.get()),
	      swap_offsets_buf_ptr(make_array<data_t>(entry_size)),
	...
	array_ptr<data_t> tmp_buf_ptr;
	const data_ptr_t tmp_buf;

	array_ptr<data_t> iter_swap_buf_ptr;
	const data_ptr_t iter_swap_buf;

	array_ptr<data_t> swap_offsets_buf_ptr;
