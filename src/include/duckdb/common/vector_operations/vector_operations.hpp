...
struct VectorOperations {
	...
	// Copy the data of <source> to the target vector partially (copies 'copy_count' tuples)
	static void CopyPartial(const Vector &source, Vector &target, idx_t source_count, idx_t source_offset,
	                        idx_t copy_count, idx_t target_offset);
	static void CopyPartial(const Vector &source, Vector &target, const SelectionVector &sel, idx_t source_count,
	                        idx_t source_offset, idx_t copy_count, idx_t target_offset);
