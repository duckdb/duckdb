...
public:
	...
	static inline idx_t SelectDictionaryConstant(Vector &dictionary, Vector &constant,
		...
		auto &dictionary_validity = FlatVector::ValidityMutable(dictionary_child);
	...
	static idx_t SelectFlatColumnConstant(Vector &flat_col, Vector &constant, const SelectionVector &sel, idx_t count,
		...
		auto &validity = FlatVector::ValidityMutable(flat_col);
	...
	SelectGenericLoopSelSwitch(const LEFT_TYPE *__restrict ldata, const RIGHT_TYPE *__restrict rdata,
	                           ...
	                           const SelectionVector &result_sel, idx_t count, ValidityMask &lvalidity,
