...
public:
	...
	//! Whether this transaction is shared with other connections through a transaction snapshot.
	bool IsShared() const {
...
private:
	...
	//! Set once the transaction is shared with other connections. Guarded by the transaction manager lock.
