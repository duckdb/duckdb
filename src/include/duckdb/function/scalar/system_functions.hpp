...
struct ExportTransactionSnapshot {
	...
	static constexpr const char *Parameters = "";
	static constexpr const char *Description = "Export the current transaction so other connections can attach to it via SET TRANSACTION SNAPSHOT. Returns an opaque snapshot id.";
