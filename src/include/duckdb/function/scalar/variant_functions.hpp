...
struct VariantArrayLengthFun {
	...
	static constexpr const char *Example = "variant_array_length(['duck', 'goose']::VARIANT)\001variant_array_length({'a': { 'a': 1, 'b': 2}}::VARIANT, 'a')\001variant_array_length({'a': 1, 'b': ['duck', 'goose']}::VARIANT, ['a', 'b'])";
