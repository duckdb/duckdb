...
public:
	//! Returns the logical type for state type ST, using return_type as the value type for sort-key states
	//! (whose decoded type equals the aggregate's runtime return type).
