...
class LegacyOptionalFilter : public TableFilter {
public:
	static constexpr auto TYPE = TableFilterType::LEGACY_OPTIONAL_FILTER;

public:
	explicit LegacyOptionalFilter(unique_ptr<TableFilter> filter = nullptr);
