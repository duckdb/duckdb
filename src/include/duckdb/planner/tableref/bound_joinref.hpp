...
public:
	...
	bool lateral;
	//! Whether the join condition is bound as part of the lateral right-hand side
	bool condition_lateral = false;
	//! Whether a RIGHT join was normalized by swapping its inputs before binding
	bool inputs_flipped = false;
