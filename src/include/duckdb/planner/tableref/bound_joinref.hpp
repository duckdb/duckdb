...
public:
	...
	//! If valid, a LogicalRowPresence operator is placed below the left/right side when planning:
	//! its column (index, 0) is true for real rows and NULL for rows fabricated by the join
	TableIndex left_presence_index;
	TableIndex right_presence_index;
};
} // namespace duckdb
