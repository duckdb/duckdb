...
private:
	...
	unique_ptr<LogicalOperator> BindCopyDatabaseSchema(Catalog &source_catalog,
	                                                   const std::string &target_database_name);
	unique_ptr<LogicalOperator> BindCopyDatabaseData(Catalog &source_catalog, const std::string &target_database_name);
