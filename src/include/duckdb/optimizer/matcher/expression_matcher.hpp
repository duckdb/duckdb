...
public:
	...
	virtual bool Match(Expression &expr, vector<reference_wrapper<Expression>> &bindings);
...
public:
	...
	bool Match(Expression &expr_, vector<reference_wrapper<Expression>> &bindings) override;
};
