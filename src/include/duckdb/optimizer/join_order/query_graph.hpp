...
public:
	...
	const vector<reference<NeighborInfo>> GetConnections(optional_ptr<JoinRelationSet> node,
	...
	void CreateEdge(optional_ptr<JoinRelationSet> left, optional_ptr<JoinRelationSet> right,
