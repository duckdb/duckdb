...
public:
	...
	void Sink(ExecutionContext &context, GlobalSinkState &state, LocalSinkState &lstate, DataChunk &group_chunk, DataChunk &aggregate_input_chunk) const;
	...
	void GetData(ExecutionContext &context, DataChunk &scan_chunk, DataChunk &chunk, GlobalSinkState &sink_state, GlobalSourceState &gstate_p) const;
