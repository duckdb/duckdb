...
public:
	...
	struct ScanStructure {
		array_ptr<UnifiedVectorFormat> key_data;
		Vector pointers;
		idx_t count;
		SelectionVector sel_vector;
		// whether or not the given tuple has found a match
		array_ptr<bool> found_match;
		JoinHashTable &ht;
		bool finished;
...
private:
	...
	idx_t PrepareKeys(DataChunk &keys, array_ptr<UnifiedVectorFormat> &key_data, const SelectionVector *&current_sel,
