...
public:
	...
	//	Threading states
	virtual unique_ptr<WindowAggregatorState> GetGlobalState(BufferManager &buffer_manager, idx_t group_count,
...
public:
	...
	unique_ptr<WindowAggregatorState> GetGlobalState(BufferManager &buffer_manager, idx_t group_count,
