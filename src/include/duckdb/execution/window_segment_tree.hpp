...
public:
	...
	virtual void Sink(WindowAggregatorState &gsink, DataChunk &arg_chunk, idx_t input_idx, SelectionVector *filter_sel,
	                  idx_t filtered);
...
public:
	...
	void Sink(WindowAggregatorState &gsink, DataChunk &arg_chunk, idx_t input_idx, SelectionVector *filter_sel,
