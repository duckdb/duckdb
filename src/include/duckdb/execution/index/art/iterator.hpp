...
//! Collects query-scan Row IDs contiguously and normalizes them outside the ART locks when possible.
class ARTRowIdCollection {
public:
	explicit ARTRowIdCollection(idx_t capacity);
