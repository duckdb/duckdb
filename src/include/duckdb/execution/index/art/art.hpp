...
public:
	...
	bool Scan(IndexScanState &state, ARTRowIdCollection &row_ids);
...
private:
	...
	bool FullScan(ARTRowIdCollection &row_ids);
	bool SearchEqual(ARTKey &key, ARTRowIdCollection &row_ids);
	bool SearchGreater(ARTKey &key, bool equal, ARTRowIdCollection &row_ids);
	bool SearchLess(ARTKey &upper_bound, bool equal, ARTRowIdCollection &row_ids);
	bool SearchCloseRange(ARTKey &lower_bound, ARTKey &upper_bound, bool left_equal, bool right_equal,
