...
public:
	...
	virtual COrderSpec* PosRequired(CExpressionHandle &exprhdl, COrderSpec* posRequired, ULONG child_index, vector<CDrvdProp*> pdrgpdpCtxt, ULONG ulOptReq) const
	{
		return new COrderSpec();
	}

	virtual bool FProvidesReqdCols(CExpressionHandle &exprhdl, vector<ColumnBinding> pcrsRequired, ULONG ulOptReq) const
	{
		return true;
	}
...
public:
	...
	virtual vector<ColumnBinding> PcrsRequired(CExpressionHandle &exprhdl, vector<ColumnBinding> pcrsRequired, ULONG child_index, vector<CDrvdProp*> pdrgpdpCtxt, ULONG ulOptReq)
	{
	...
	vector<ColumnBinding> PcrsChildReqd(CExpressionHandle &exprhdl, vector<ColumnBinding> pcrsRequired, ULONG child_index);
