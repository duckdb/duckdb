...
private:
	...
	//! Finish the unit under construction, stamped with the batch it came from. Null when there is none
	...
	bool HandOver(ResultSinkGlobalState &gstate, unique_ptr<ResultUnit> unit, const InterruptState &interrupt) const;
