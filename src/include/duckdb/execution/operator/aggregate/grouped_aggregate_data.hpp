...
public:
	...
	vector<vector<ProjectionIndex>> grouping_functions;
	//! The group types
...
public:
	...
	const vector<vector<ProjectionIndex>> &GetGroupingFunctions() const;
...
private:
	...
	void SetGroupingFunctions(vector<unsafe_vector<ProjectionIndex>> &functions);
};
