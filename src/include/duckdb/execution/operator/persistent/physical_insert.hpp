...
public:
	//! INSERT INTO
	PhysicalInsert(ArenaAllocator &arena, vector<LogicalType> types, TableCatalogEntry &table,
	...
	//! CREATE TABLE AS
	PhysicalInsert(ArenaAllocator &arena, LogicalOperator &op, SchemaCatalogEntry &schema,
