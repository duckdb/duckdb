...
public:
	PhysicalRecursiveKeyCTE(string ctename, idx_t table_index, vector<LogicalType> types,
	                     bool union_all, vector<idx_t > key_columns, unique_ptr<PhysicalOperator> top,
