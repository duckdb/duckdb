...
public:
	...
	static shared_ptr<CompiledGrammar> Create(const identifier_map_t<reference<GrammarExtension>> &grammar_extensions);
...
public:
	...
	static shared_ptr<CompiledGrammar> Create(const ClientContext &context, const identifier_set_t &active_extensions);
