...
private:
	...
	static unique_ptr<SQLStatement> TransformCreatePublicationStatement(PEGTransformer &transformer,
                                                                        ParseResult &parse_result);
	// create_subscription.gram — optional CONNECTION clause with nested PUBLICATION list requires a hand-written transformer.
	...
	static case_insensitive_map_t<unique_ptr<ParsedExpression>> TransformRelOptionOrOids(PEGTransformer &transformer,
	                                                                                     ParseResult &parse_result);
	static case_insensitive_map_t<unique_ptr<ParsedExpression>> TransformRelOptionList(PEGTransformer &transformer,
	                                                                                   ParseResult &parse_result);
	static case_insensitive_map_t<unique_ptr<ParsedExpression>> TransformOids(PEGTransformer &transformer,
	                                                                          ParseResult &parse_result);
	static string TransformRelOptionName(PEGTransformer &transformer, ParseResult &parse_result);
	...
	static pair<string, unique_ptr<ParsedExpression>> TransformRelOption(PEGTransformer &transformer,
	                                                                     ParseResult &parse_result);
	static string TransformIndexName(PEGTransformer &transformer, ParseResult &parse_result);
	...
	static ShowType TransformSummarize(PEGTransformer &transformer, ParseResult &parse_result);
	...
	static unique_ptr<TransformResultValue> TransformAlterIndexStmtInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<AlterInfo> TransformAlterIndexStmt(PEGTransformer &transformer, const bool &if_exists, unique_ptr<BaseTableRef> base_table_name, unique_ptr<AlterTableInfo> rename_alter);
	static unique_ptr<TransformResultValue> TransformAlterFunctionStmtInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<AlterInfo> TransformAlterFunctionStmt(PEGTransformer &transformer, const bool &if_exists, const QualifiedName &qualified_name, unique_ptr<AlterTableInfo> rename_alter);
	...
	static unique_ptr<TransformResultValue> TransformDropConstraintInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<AlterTableInfo> TransformDropConstraint(PEGTransformer &transformer, const bool &if_exists, const string &identifier, const bool &drop_behavior);
	static unique_ptr<TransformResultValue> TransformRenameConstraintInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<AlterTableInfo> TransformRenameConstraint(PEGTransformer &transformer, const string &identifier, const string &identifier_1);
	...
	static unique_ptr<TransformResultValue> TransformCreateDatabaseStatementInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformCreateDatabaseStatement(PEGTransformer &transformer, const bool &if_not_exists, const string &catalog_name);
	static unique_ptr<TransformResultValue> TransformDropDatabaseStatementInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformDropDatabaseStatement(PEGTransformer &transformer, const bool &if_exists, const string &catalog_name, const bool &drop_database_force);
	static unique_ptr<TransformResultValue> TransformDropDatabaseForceInternal(PEGTransformer &transformer, ParseResult &parse_result);
	...
	static unique_ptr<CreateStatement> TransformCreateTriggerStmt(PEGTransformer &transformer, const bool &if_not_exists, const string &trigger_name, const TriggerTiming &trigger_timing, const TriggerEventInfo &trigger_event, unique_ptr<BaseTableRef> base_table_name, const TriggerForEach &for_each_clause, unique_ptr<SQLStatement> trigger_body);
	...
	static unique_ptr<SQLStatement> TransformBeginTransaction(PEGTransformer &transformer, const TransactionIsolationLevel &isolation_level_clause, const TransactionModifierType &read_or_write);
	...
	static unique_ptr<TransformResultValue> TransformIsolationLevelClauseInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static TransactionIsolationLevel TransformIsolationLevelClause(PEGTransformer &transformer, const TransactionIsolationLevel &isolation_level);
	...
	static string TransformVacuumOption(PEGTransformer &transformer, ParseResult &choice_result);
