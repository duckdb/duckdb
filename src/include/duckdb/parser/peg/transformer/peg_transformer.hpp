...
public:
	...
	static unique_ptr<TransformResultValue> FinalizeDropExtensionRepositoryStmtTrampoline(PEGTransformer &transformer,
	                                                                                      TransformStack &stack,
	                                                                                      TransformStackFrame &frame);
	static void InitializeTableMatchRecognizeClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                          TransformStackFrame &frame);
	static unique_ptr<TransformResultValue> FinalizeTableMatchRecognizeClauseTrampoline(PEGTransformer &transformer,
	                                                                                    TransformStack &stack,
	                                                                                    TransformStackFrame &frame);
	static void InitializeMatchRecognizeBodyTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                   TransformStackFrame &frame);
	...
	static void InitializeMeasuresClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeMeasuresClauseTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeMeasuresElementTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	...
	static void InitializeRowsPerMatchTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                             TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRowsPerMatchTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeOneRowPerMatchTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeOneRowPerMatchTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeAllRowsPerMatchTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeAllRowsPerMatchTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeAfterMatchSkipTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeAfterMatchSkipTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeAfterMatchSkipTargetTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                     TransformStackFrame &frame);
	static unique_ptr<TransformResultValue> FinalizeAfterMatchSkipTargetTrampoline(PEGTransformer &transformer,
	                                                                               TransformStack &stack,
	                                                                               TransformStackFrame &frame);
	static void InitializeSkipToNextRowTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                              TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeSkipToNextRowTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeSkipPastLastRowTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeSkipPastLastRowTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeSkipToFirstVarTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeSkipToFirstVarTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeSkipToLastVarTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                              TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeSkipToLastVarTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializePatternClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                              TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizePatternClauseTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeRowPatternTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                           TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRowPatternTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeRowPatternAlternativeTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                      TransformStackFrame &frame);
	static unique_ptr<TransformResultValue> FinalizeRowPatternAlternativeTrampoline(PEGTransformer &transformer,
	                                                                                TransformStack &stack,
	                                                                                TransformStackFrame &frame);
	static void InitializeRowPatternTermTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRowPatternTermTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeRowPatternFactorTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                 TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRowPatternFactorTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeRowPatternPrimaryTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                  TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	...
	static void InitializeRowPatternAnchorTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                 TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRowPatternAnchorTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializePatternStartTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                             TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizePatternStartTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializePatternEndTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                           TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizePatternEndTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	...
	static void InitializeRowPatternLabelTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRowPatternLabelTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeRowPatternQuantifierTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                     TransformStackFrame &frame);
	...
	static void InitializeQuantifierStarTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeQuantifierStarTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeQuantifierPlusTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	...
	static void InitializeQuantifierRangeTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeQuantifierRangeTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeQuantifierBoundsTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                 TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeQuantifierBoundsTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeQuantifierMinMaxTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                 TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeQuantifierMinMaxTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeQuantifierMinTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                              TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeQuantifierMinTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeQuantifierMaxTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                              TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeQuantifierMaxTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeQuantifierExactTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	...
	static void InitializeDefineClauseTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                             TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeDefineClauseTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeDefineElementTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                              TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeDefineElementTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
