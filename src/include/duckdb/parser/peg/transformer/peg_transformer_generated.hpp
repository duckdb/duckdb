...
// NOLINTBEGIN
	...
	static unique_ptr<SQLStatement> TransformDetachStatementInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformDetachStatement(const bool &if_exists, const string &catalog_name);
	static unique_ptr<SQLStatement> TransformExportStatementInternal(PEGTransformer &transformer, ParseResult &parse_result);
	...
	static unique_ptr<SQLStatement> TransformImportStatementInternal(PEGTransformer &transformer, ParseResult &parse_result);
