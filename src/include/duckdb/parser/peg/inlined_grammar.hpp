...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"GenericCopyOption <- OrderByGenericCopyOption / PartitionedByGenericCopyOption / NamedGenericCopyOption\n"
	"OrderByGenericCopyOption <- 'ORDER' 'BY' GenericCopyOptionValue?\n"
	"PartitionedByGenericCopyOption <- 'PARTITIONED' 'BY' GenericCopyOptionValue?\n"
	"NamedGenericCopyOption <- CopyOptionName GenericCopyOptionValue?\n"
