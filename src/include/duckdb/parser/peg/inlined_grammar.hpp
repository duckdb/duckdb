...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"GenericCopyOption <- SortByOption / RegularGenericCopyOption\n"
	"RegularGenericCopyOption <- CopyOptionName Expression?\n"
	"SortByOption <- 'SORT_BY' Parens(OrderByExpressions)\n"
