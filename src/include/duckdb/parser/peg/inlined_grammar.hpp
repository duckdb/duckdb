...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"LoadStatement <- 'LOAD' ExtensionNamespace? ColIdOrString ExtensionAlias?\n"
	"ExtensionAlias <- 'AS' Identifier\n"
	"ExtensionNamespace <- Identifier '/'\n"
	"InstallStatement <- 'FORCE'? 'INSTALL' ExtensionNamespace? IdentifierOrStringLiteral FromSource? VersionNumber?\n"
