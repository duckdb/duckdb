...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"InnerTableRef <- ValuesRef / TableFunction / TableSubquery / FeatureAtVersionRef / ServeFeatureRef / BaseTableRef / ParensTableRef\n"
	...
	"ServeFeatureRef <- 'SERVE' ServeFeatureKw List(ServeFeatureItem) 'FOR' IdentifierOrStringLiteral ServeFeatureEntity? ServeFeatureAsOf? TableAlias?\n"
	...
	"AlterFeatureOptions <- AlterFeatureSetSchedule / AlterFeatureSetTTL / AlterFeatureEnableSchedule / AlterFeatureDisableSchedule\n"
