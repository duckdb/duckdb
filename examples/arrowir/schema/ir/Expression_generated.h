...
inline const char *EnumNameDeref(Deref e) {
  if (flatbuffers::IsOutRange(e, Deref_NONE, Deref_FieldIndex)) return "";
...
inline const Ordering (&EnumValuesOrdering())[4] {
  static const Ordering values[] = {
    Ordering_ASCENDING_THEN_NULLS,
    Ordering_DESCENDING_THEN_NULLS,
    Ordering_NULLS_THEN_ASCENDING,
    Ordering_NULLS_THEN_DESCENDING
  };
  return values;
}
...
inline const char *EnumNameOrdering(Ordering e) {
  if (flatbuffers::IsOutRange(e, Ordering_ASCENDING_THEN_NULLS, Ordering_NULLS_THEN_DESCENDING)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const ConcreteBoundImpl (&EnumValuesConcreteBoundImpl())[3] {
  static const ConcreteBoundImpl values[] = {
    ConcreteBoundImpl_NONE,
    ConcreteBoundImpl_Expression,
...
inline const char *EnumNameConcreteBoundImpl(ConcreteBoundImpl e) {
  if (flatbuffers::IsOutRange(e, ConcreteBoundImpl_NONE, ConcreteBoundImpl_Unbounded)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameBound(Bound e) {
  if (flatbuffers::IsOutRange(e, Bound_NONE, Bound_CurrentRow)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum Frame : uint8_t {
  Frame_Rows = 0,
  Frame_Range = 1,
  Frame_MIN = Frame_Rows,
  Frame_MAX = Frame_Range
};
...
inline const char *EnumNameFrame(Frame e) {
  if (flatbuffers::IsOutRange(e, Frame_Rows, Frame_Range)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum ExpressionImpl : uint8_t {
  ...
  ExpressionImpl_Cast = 7,
  ExpressionImpl_MIN = ExpressionImpl_NONE,
  ExpressionImpl_MAX = ExpressionImpl_Cast
};

inline const ExpressionImpl (&EnumValuesExpressionImpl())[8] {
  static const ExpressionImpl values[] = {
    ExpressionImpl_NONE,
    ExpressionImpl_Literal,
    ExpressionImpl_FieldRef,
    ExpressionImpl_Call,
    ExpressionImpl_ConditionalCase,
    ExpressionImpl_SimpleCase,
...
inline const char *EnumNameExpressionImpl(ExpressionImpl e) {
  if (flatbuffers::IsOutRange(e, ExpressionImpl_NONE, ExpressionImpl_Cast)) return "";
  const size_t index = static_cast<size_t>(e);
...
template<> struct ExpressionImplTraits<org::apache::arrow::computeir::flatbuf::Cast> {
  static const ExpressionImpl enum_value = ExpressionImpl_Cast;
};
...
struct FieldRef FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::computeir::flatbuf::MapKey *ref_as_MapKey() const {
    return ref_type() == org::apache::arrow::computeir::flatbuf::Deref_MapKey ? static_cast<const org::apache::arrow::computeir::flatbuf::MapKey *>(ref()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::StructField *ref_as_StructField() const {
    return ref_type() == org::apache::arrow::computeir::flatbuf::Deref_StructField ? static_cast<const org::apache::arrow::computeir::flatbuf::StructField *>(ref()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::ArraySubscript *ref_as_ArraySubscript() const {
    return ref_type() == org::apache::arrow::computeir::flatbuf::Deref_ArraySubscript ? static_cast<const org::apache::arrow::computeir::flatbuf::ArraySubscript *>(ref()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::ArraySlice *ref_as_ArraySlice() const {
    return ref_type() == org::apache::arrow::computeir::flatbuf::Deref_ArraySlice ? static_cast<const org::apache::arrow::computeir::flatbuf::ArraySlice *>(ref()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::FieldIndex *ref_as_FieldIndex() const {
    return ref_type() == org::apache::arrow::computeir::flatbuf::Deref_FieldIndex ? static_cast<const org::apache::arrow::computeir::flatbuf::FieldIndex *>(ref()) : nullptr;
  }
...
inline flatbuffers::Offset<SortKey> CreateSortKey(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::Expression> expression = 0,
    org::apache::arrow::computeir::flatbuf::Ordering ordering = org::apache::arrow::computeir::flatbuf::Ordering_ASCENDING_THEN_NULLS) {
...
struct Preceding FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::computeir::flatbuf::Expression *impl_as_Expression() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ConcreteBoundImpl_Expression ? static_cast<const org::apache::arrow::computeir::flatbuf::Expression *>(impl()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::Unbounded *impl_as_Unbounded() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ConcreteBoundImpl_Unbounded ? static_cast<const org::apache::arrow::computeir::flatbuf::Unbounded *>(impl()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline flatbuffers::Offset<Preceding> CreatePreceding(
    flatbuffers::FlatBufferBuilder &_fbb,
    org::apache::arrow::computeir::flatbuf::ConcreteBoundImpl impl_type = org::apache::arrow::computeir::flatbuf::ConcreteBoundImpl_NONE,
...
struct WindowCall FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::computeir::flatbuf::Preceding *lower_bound_as_Preceding() const {
    return lower_bound_type() == org::apache::arrow::computeir::flatbuf::Bound_Preceding ? static_cast<const org::apache::arrow::computeir::flatbuf::Preceding *>(lower_bound()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::Following *lower_bound_as_Following() const {
    return lower_bound_type() == org::apache::arrow::computeir::flatbuf::Bound_Following ? static_cast<const org::apache::arrow::computeir::flatbuf::Following *>(lower_bound()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::CurrentRow *lower_bound_as_CurrentRow() const {
    return lower_bound_type() == org::apache::arrow::computeir::flatbuf::Bound_CurrentRow ? static_cast<const org::apache::arrow::computeir::flatbuf::CurrentRow *>(lower_bound()) : nullptr;
  }
  ...
  const org::apache::arrow::computeir::flatbuf::Preceding *upper_bound_as_Preceding() const {
    return upper_bound_type() == org::apache::arrow::computeir::flatbuf::Bound_Preceding ? static_cast<const org::apache::arrow::computeir::flatbuf::Preceding *>(upper_bound()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::Following *upper_bound_as_Following() const {
    return upper_bound_type() == org::apache::arrow::computeir::flatbuf::Bound_Following ? static_cast<const org::apache::arrow::computeir::flatbuf::Following *>(upper_bound()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::CurrentRow *upper_bound_as_CurrentRow() const {
    return upper_bound_type() == org::apache::arrow::computeir::flatbuf::Bound_CurrentRow ? static_cast<const org::apache::arrow::computeir::flatbuf::CurrentRow *>(upper_bound()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffsetRequired(verifier, VT_EXPRESSION) &&
...
struct Expression FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const org::apache::arrow::computeir::flatbuf::Literal *impl_as_Literal() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ExpressionImpl_Literal ? static_cast<const org::apache::arrow::computeir::flatbuf::Literal *>(impl()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::FieldRef *impl_as_FieldRef() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ExpressionImpl_FieldRef ? static_cast<const org::apache::arrow::computeir::flatbuf::FieldRef *>(impl()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::Call *impl_as_Call() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ExpressionImpl_Call ? static_cast<const org::apache::arrow::computeir::flatbuf::Call *>(impl()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::ConditionalCase *impl_as_ConditionalCase() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ExpressionImpl_ConditionalCase ? static_cast<const org::apache::arrow::computeir::flatbuf::ConditionalCase *>(impl()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::SimpleCase *impl_as_SimpleCase() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ExpressionImpl_SimpleCase ? static_cast<const org::apache::arrow::computeir::flatbuf::SimpleCase *>(impl()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::WindowCall *impl_as_WindowCall() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ExpressionImpl_WindowCall ? static_cast<const org::apache::arrow::computeir::flatbuf::WindowCall *>(impl()) : nullptr;
  }
  const org::apache::arrow::computeir::flatbuf::Cast *impl_as_Cast() const {
    return impl_type() == org::apache::arrow::computeir::flatbuf::ExpressionImpl_Cast ? static_cast<const org::apache::arrow::computeir::flatbuf::Cast *>(impl()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_IMPL_TYPE) &&
...
inline flatbuffers::Offset<Expression> CreateExpression(
    flatbuffers::FlatBufferBuilder &_fbb,
    org::apache::arrow::computeir::flatbuf::ExpressionImpl impl_type = org::apache::arrow::computeir::flatbuf::ExpressionImpl_NONE,
    flatbuffers::Offset<void> impl = 0) {
...
inline const flatbuffers::TypeTable *ExpressionImplTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    ...
    org::apache::arrow::computeir::flatbuf::CastTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "Literal",
