...
struct Plan FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
	...
	enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_SINKS = 4 };
	...
	bool Verify(flatbuffers::Verifier &verifier) const {
		return VerifyTableStart(verifier) && VerifyOffsetRequired(verifier, VT_SINKS) &&
		       verifier.VerifyVector(sinks()) && verifier.VerifyVectorOfTables(sinks()) && verifier.EndTable();
	}
};
...
struct PlanBuilder {
	...
	explicit PlanBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<Plan> CreatePlanDirect(
	...
	auto sinks__ =
	    sinks ? _fbb.CreateVector<flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::Relation>>(*sinks) : 0;
	return org::apache::arrow::computeir::flatbuf::CreatePlan(_fbb, sinks__);
}

inline const flatbuffers::TypeTable *PlanTypeTable() {
	static const flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_SEQUENCE, 1, 0}};
	static const flatbuffers::TypeFunction type_refs[] = {org::apache::arrow::computeir::flatbuf::RelationTypeTable};
	static const char *const names[] = {"sinks"};
...
inline bool VerifyPlanBuffer(flatbuffers::Verifier &verifier) {
	return verifier.VerifyBuffer<org::apache::arrow::computeir::flatbuf::Plan>(nullptr);
}

inline bool VerifySizePrefixedPlanBuffer(flatbuffers::Verifier &verifier) {
	return verifier.VerifySizePrefixedBuffer<org::apache::arrow::computeir::flatbuf::Plan>(nullptr);
}

inline void FinishPlanBuffer(flatbuffers::FlatBufferBuilder &fbb,
                             flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::Plan> root) {
	fbb.Finish(root);
}

inline void FinishSizePrefixedPlanBuffer(flatbuffers::FlatBufferBuilder &fbb,
                                         flatbuffers::Offset<org::apache::arrow::computeir::flatbuf::Plan> root) {
