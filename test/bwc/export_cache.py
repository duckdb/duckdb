...
parser.add_argument('--output-dir', dest='output_dir', help='Output directory for cache archives (default: current directory)', default='.')
...
if __name__ == '__main__':
    ...
    if args.version:
        ...
        versions = sorted([d for d in os.listdir(runtime_dir) if d.startswith('v') and os.path.isdir(os.path.join(runtime_dir, d))])
