WITH jennifer_0 AS (
    SELECT
        ...
        CASE WHEN ((EXISTS (
                        ...
                        WHERE
                            EXISTS (
                                SELECT
                                    ref_1.c_custkey AS c0, sample_1.r_comment AS c1, sample_0.o_shippriority AS c2, ref_0.l_comment AS c3, 15 AS c4, sample_0.o_orderkey AS c5
                                FROM
    ...
    RIGHT JOIN main.orders AS sample_0 TABLESAMPLE SYSTEM (3.9)
    ON ((0)
            OR (1))
        RIGHT JOIN main.region AS sample_1 TABLESAMPLE SYSTEM (0.3)
        LEFT JOIN main.region AS sample_2 TABLESAMPLE SYSTEM (8.3)
        RIGHT JOIN main.customer AS ref_1 ON (sample_2.r_comment = ref_1.c_name)
        ON ((1)
                    ...
                    OR ((((EXISTS (
                            ...
                            OR (EXISTS (
                                    ...
                                    WHERE
                                        EXISTS (
                                            SELECT
                                                sample_2.r_regionkey AS c0, sample_6.p_partkey AS c1, ref_1.c_name AS c2, sample_1.r_comment AS c3, sample_6.p_type AS c4, (
                                                    SELECT
                                                        ps_comment
                                                    FROM
                                                        main.partsupp
                        ...
                        OR ((((EXISTS (
                                            ...
                                            WHERE ((1)
                                                OR ((EXISTS (
                                                            SELECT
                                                                sample_2.r_regionkey AS c0, sample_1.r_regionkey AS c1, ref_1.c_acctbal AS c2, ref_1.c_phone AS c3, 98 AS c4, sample_1.r_regionkey AS c5, sample_2.r_name AS c6
                                                            FROM
                        ...
                        AND (EXISTS (
                                ...
                                OR (((EXISTS (
                                                SELECT
                                                    sample_10.o_orderdate AS c0, sample_9.l_comment AS c1, sample_10.o_comment AS c2, sample_10.o_orderpriority AS c3
                                                FROM
            ...
            OR (EXISTS (
                    ...
                    LIMIT 107))))))
ON (sample_0.o_totalprice = ref_1.c_acctbal)
WHERE (EXISTS (
        SELECT
            sample_1.r_name AS c0, sample_15.s_comment AS c1, sample_1.r_name AS c2, ref_12.p_type AS c3, sample_16.p_partkey AS c4, sample_1.r_regionkey AS c5, ref_0.l_discount AS c6, ref_0.l_orderkey AS c7, sample_14.o_orderstatus AS c8, ref_1.c_acctbal AS c9, sample_14.o_custkey AS c10, sample_16.p_partkey AS c11, sample_15.s_comment AS c12, sample_1.r_comment AS c13, sample_1.r_name AS c14, sample_0.o_custkey AS c15
        FROM
            main.orders AS sample_14 TABLESAMPLE SYSTEM (8.1)
            INNER JOIN main.supplier AS sample_15 TABLESAMPLE SYSTEM (8.3)
            ON (sample_14.o_clerk = sample_15.s_name)
            INNER JOIN main.part AS ref_12
        RIGHT JOIN main.part AS sample_16 TABLESAMPLE SYSTEM (2.8)
        INNER JOIN main.customer AS sample_17 TABLESAMPLE BERNOULLI (1.6)
        ON (1)
        ON ((EXISTS (
                    SELECT
            ...
            AND ((
                    ...
                    LIMIT 1 offset 3)
                IS NULL))
        ON (sample_2.r_regionkey IS NOT NULL)
    WHERE
    ...
    AND (((sample_2.r_name IS NOT NULL)
            AND (EXISTS (
                    ...
                    WHERE (((1)
                            AND (EXISTS (
                                    SELECT
                                        sample_0.o_orderpriority AS c0, ref_1.c_acctbal AS c1
                                    FROM
                                        main.nation AS ref_13
                                    WHERE ((((EXISTS (
                                                        SELECT
                                                            ref_1.c_address AS c0, ref_1.c_custkey AS c1, sample_1.r_name AS c2, sample_20.r_regionkey AS c3, ref_13.n_nationkey AS c4, (
                                                                SELECT
                                                                    p_brand
                                                                FROM
                                                                    main.part
                                                ...
                                                OR (EXISTS (
                                                        SELECT
                                                            sample_1.r_regionkey AS c0, ref_13.n_nationkey AS c1, sample_0.o_custkey AS c2, sample_0.o_orderdate AS c3, ref_13.n_name AS c4, ref_13.n_nationkey AS c5, ref_0.l_shipmode AS c6, ref_0.l_orderkey AS c7, ref_0.l_suppkey AS c8, ref_13.n_regionkey AS c9, ref_1.c_acctbal AS c10, ref_1.c_acctbal AS c11, ref_13.n_regionkey AS c12, sample_2.r_comment AS c13
                                                        FROM
                                        ...
                                        OR ((sample_2.r_comment IS NOT NULL)
                                            AND (((EXISTS (
                                                            SELECT
                                                                sample_1.r_comment AS c0, ref_1.c_custkey AS c1, sample_0.o_orderpriority AS c2, sample_1.r_comment AS c3
                                                            FROM
...
jennifer_1 AS (
    SELECT
        ...
        CASE WHEN (((subq_0.c0 IS NOT NULL)
                ...
                OR (EXISTS (
                        SELECT
                            29 AS c0, subq_0.c0 AS c1, ref_20.o_clerk AS c2, 14 AS c3, (
                                SELECT
                                    n_nationkey
                                FROM
                                    main.nation
    ...
    FROM (
        ...
        WHERE ((1)
            OR ((((EXISTS (
                                SELECT
                                    sample_24.p_partkey AS c0, sample_24.p_retailprice AS c1, sample_24.p_comment AS c2, ref_16.ps_availqty AS c3, sample_24.p_retailprice AS c4, sample_24.p_mfgr AS c5, ref_16.ps_partkey AS c6, sample_24.p_name AS c7, ref_16.ps_availqty AS c8
                                FROM
    ...
    WHERE (((1)
            OR ((sample_28.r_name IS NULL)
                OR ((1)
                    OR ((((((EXISTS (
                                                SELECT
                                                    sample_28.r_comment AS c0, sample_28.r_comment AS c1
                                                FROM
                                                ...
                                                OR ((0)
                                                    OR ((EXISTS (
                                                                SELECT
                                                                    sample_29.ps_partkey AS c0, sample_29.ps_partkey AS c1, sample_29.ps_partkey AS c2
                                                                FROM
                        ...
                        OR ((1)
                            AND (EXISTS (
                                    SELECT
                                        ref_21.s_name AS c0, sample_28.r_comment AS c1, ref_21.s_name AS c2, sample_28.r_comment AS c3, sample_28.r_comment AS c4, ref_21.s_comment AS c5, sample_28.r_comment AS c6, sample_28.r_regionkey AS c7, sample_28.r_name AS c8, sample_28.r_comment AS c9
                                    FROM
...
OR ((((((EXISTS (
                            ...
                            WHERE ((((0)
                                    ...
                                    OR ((0)
                                        OR (((((EXISTS (
                                                                SELECT
                                                                    ref_22.l_quantity AS c0, sample_28.r_regionkey AS c1, ref_23.n_comment AS c2, sample_28.r_name AS c3, ref_22.l_partkey AS c4, sample_28.r_comment AS c5, sample_28.r_name AS c6, ref_23.n_name AS c7, sample_28.r_name AS c8, ref_22.l_quantity AS c9, ref_22.l_tax AS c10, ref_22.l_quantity AS c11
                                                                FROM
                                                            ...
                                                            OR (EXISTS (
                                                                    SELECT
                                                                        sample_32.l_tax AS c0, sample_28.r_regionkey AS c1, sample_28.r_regionkey AS c2, sample_32.l_tax AS c3
                                                                    FROM
                                    ...
                                    AND (((0)
                                            ...
                                            OR (((EXISTS (
                                                            ...
                                                            WHERE
                                                                EXISTS (
                                                                    SELECT
                                                                        ref_22.l_tax AS c0, ref_22.l_linenumber AS c1, (
                                                                            SELECT
                                                                                n_name
                                                                            FROM
                                                                                main.nation
                                        ...
                                        OR (EXISTS (
                                                SELECT
                                                    ref_30.o_clerk AS c0, ref_22.l_receiptdate AS c1, ref_22.l_quantity AS c2
                                                FROM
                            ...
                            AND ((sample_35.c_mktsegment IS NOT NULL)
                                AND (((sample_28.r_name IS NOT NULL)
                                        AND ((0)
                                            AND (EXISTS (
                                                    SELECT
                                                        86 AS c0, sample_35.c_phone AS c1
                                                    FROM
                                ...
                                AND (((EXISTS (
                                        ...
                                        OR ((0)
                                            AND (EXISTS (
                                                    ...
                                                    WHERE (EXISTS (
                                                            SELECT
                                                                sample_35.c_name AS c0, sample_28.r_comment AS c1, sample_28.r_name AS c2, ref_34.c_custkey AS c3, ref_34.c_custkey AS c4, ref_34.c_acctbal AS c5, sample_28.r_comment AS c6, sample_35.c_address AS c7, 75 AS c8, sample_38.l_orderkey AS c9, sample_38.l_orderkey AS c10, (
                                                                    SELECT
                                                                        l_quantity
                                                                    FROM
                                                                        main.lineitem
                                                        ...
                                                        AND (((EXISTS (
                                                                        ...
                                                                        OR (EXISTS (
                                                                                SELECT
                                                                                    sample_35.c_comment AS c0, sample_28.r_regionkey AS c1, sample_28.r_name AS c2
                                                                                FROM
