...
void ArrowStreamTestFactory::GetSchema(ArrowArrayStream * arrow_array_stream, duckdb::ArrowSchemaWrapper &schema) {
	arrow_array_stream->get_schema(arrow_array_stream, &schema.arrow_schema);
}
