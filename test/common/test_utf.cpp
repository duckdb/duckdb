...
TEST_CASE("UTF8 NFC tests", "[utf8]") {
	...
	// related to bug 539
	REQUIRE_NO_FAIL(con.Query("\x49\x4E\x53\x45\x52\x54\x20\x49\x4E\x54\x4F\x20\x73\x74\x72\x69\x6E\x67\x73\x20\x56\x41\x4C\x55\x45\x53\x28\x27\x61\x27\x29"));
	REQUIRE_NO_FAIL(con.Query("\x49\x4E\x53\x45\x52\x54\x20\x49\x4E\x54\x4F\x20\x73\x74\x72\x69\x6E\x67\x73\x20\x56\x41\x4C\x55\x45\x53\x28\x27\x3F\x27\x29"));
