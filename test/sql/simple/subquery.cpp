...
TEST_CASE("Test subqueries", "[subqueries]") {
	...
	//                    "INTEGER, e INTEGER)");
	// result = con.Query("INSERT INTO t1(e,c,b,d,a)
	// VALUES(103,102,100,101,104)"); result = con.Query("INSERT INTO
	// t1(a,c,d,e,b) VALUES(107,106,108,109,105)");
	...
	// result = con.Query("SELECT a, (SELECT CASE WHEN test.a=11 THEN b ELSE
	// NULL "
