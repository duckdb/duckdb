...
TEST_CASE("Test LEFT OUTER JOIN", "[join]") {
	...
	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON "
	...
	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON 1=1 ORDER BY i, k;"));
	...
	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON 1=2 ORDER BY i;"));
	// REQUIRE(CHECK_COLUMN(result, 0, {1, 2, 3}));
	// REQUIRE(CHECK_COLUMN(result, 1, {2, 3, 4}));
	...
	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON i=1 ORDER BY i, k;"));
	...
	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON l=20 ORDER BY i, k;"));
	// REQUIRE(CHECK_COLUMN(result, 0, {1, 2, 3}));
	// REQUIRE(CHECK_COLUMN(result, 1, {2, 3, 4}));
	// REQUIRE(CHECK_COLUMN(result, 2, {2, 2, 2}));
	// REQUIRE(CHECK_COLUMN(result, 3, {20, 20, 20}));

	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON l>0 ORDER BY i, k;"));
	// REQUIRE(CHECK_COLUMN(result, 0, {1, 1, 2, 2, 3, 3}));
	// REQUIRE(CHECK_COLUMN(result, 1, {2, 2, 3, 3, 4, 4}));
	// REQUIRE(CHECK_COLUMN(result, 2, {1, 2, 1, 2, 1, 2}));
	// REQUIRE(CHECK_COLUMN(result, 3, {10, 20, 10, 20, 10, 20}));
	...
	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON i=1 OR l=20 ORDER BY i, k;"));
	// REQUIRE(CHECK_COLUMN(result, 0, {1, 1, 2, 3}));
	// REQUIRE(CHECK_COLUMN(result, 1, {2, 2, 3, 4}));
	// REQUIRE(CHECK_COLUMN(result, 2, {1, 2, 2, 2}));
	// REQUIRE(CHECK_COLUMN(result, 3, {10, 20, 20, 20}));

	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON i=4 OR l=17 ORDER BY i;"));
	// REQUIRE(CHECK_COLUMN(result, 0, {1, 2, 3}));
	// REQUIRE(CHECK_COLUMN(result, 1, {2, 3, 4}));
	// REQUIRE(CHECK_COLUMN(result, 2, {Value(), Value(), Value()}));
	// REQUIRE(CHECK_COLUMN(result, 3, {Value(), Value(), Value()}));

	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON i+l=21 ORDER BY i;"));
	// REQUIRE(CHECK_COLUMN(result, 0, {1, 2, 3}));
	// REQUIRE(CHECK_COLUMN(result, 1, {2, 3, 4}));
	// REQUIRE(CHECK_COLUMN(result, 2, {2, Value(), Value()}));
	// REQUIRE(CHECK_COLUMN(result, 3, {20, Value(), Value()}));

	REQUIRE_FAIL(result = con.Query("SELECT * FROM integers LEFT OUTER JOIN integers2 ON i+l>12 ORDER BY i;"));
