...
TEST_CASE("Test TPC-DS SF0 Query Compilation", "[tpcds]") {
	...
	vector<size_t> compiling_queries = {
	    1,  2,  3,  5,  6,  7,  9,  10, 12, 13, 16, 17,  20,  21,  22,
	    24, 25, 26, 27, 28, 29, 31, 32, 33, 35, 36, 37,  38,  40,  44,
	    46, 47, 49, 50, 52, 54, 56, 57, 58, 59, 60, 63,  64,  65,  66,
	    67, 68, 69, 72, 73, 75, 77, 79, 80, 81, 82, 83,  84,  85,  86,
	    87, 88, 89, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103};
