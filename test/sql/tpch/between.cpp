...
//FIXME: this needs to go somewhere else, but not sure where, the helpers are here
TEST_CASE("BETWEEN", "[sql]") {
	...
	result = con.Query("SELECT a FROM between_tests WHERE a NOT BETWEEN 43 AND 44");
