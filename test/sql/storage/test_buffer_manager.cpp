...
TEST_CASE("Test storing a big string that exceeds buffer manager size", "[storage][.]") {
	...
	config->options.default_block_size = DEFAULT_BLOCK_ALLOC_SIZE;
...
TEST_CASE("Test buffer reallocation", "[storage][.]") {
	...
	auto block_size = config->options.default_block_size - Storage::DEFAULT_BLOCK_HEADER_SIZE;
...
TEST_CASE("Test buffer manager buffer re-use", "[storage][.]") {
	...
	idx_t pin_count = 10;
	auto block_alloc_size = config->options.default_block_size;
