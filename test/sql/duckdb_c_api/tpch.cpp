...
TEST_CASE("Test TPC-H Q1", "[tpch]") {
	...
	//NULL, " 		     "p_type VARCHAR(25) NOT NULL, p_size INT NOT NULL, p_container "
	//"VARCHAR(10) NOT NULL, p_retailprice DECIMAL(15,2) NOT NULL, " 		     "p_comment
	//VARCHAR(23) NOT NULL) ;"); 		EXEC("CREATE TABLE supplier (s_suppkey INT NOT
	//NULL, s_name
	...
	// ps_supplycost DECIMAL(15,2) NOT " 		     "NULL, ps_comment VARCHAR(199)
	// NOT NULL) ;"); 		EXEC("CREATE TABLE region (r_regionkey INT NOT NULL,
	// r_name VARCHAR(25) " 		     "NOT NULL, r_comment VARCHAR(152) NOT NULL)
	// ;"); 		EXEC( 		    "CREATE TABLE nation (n_nationkey INT NOT NULL, n_name
	//VARCHAR(25) NOT " 		    "NULL, n_regionkey INT NOT NULL, n_comment
