...
//		EXEC("CREATE TABLE supplier (s_suppkey INT NOT NULL, s_name VARCHAR(25) "
//		     "NOT NULL, s_address VARCHAR(40) NOT NULL, s_nationkey INT NOT NULL, "
//		     "s_phone VARCHAR(15) NOT NULL, s_acctbal DECIMAL(15,2) NOT NULL, "
//		     "s_comment VARCHAR(101) NOT NULL);");
//		EXEC("CREATE TABLE partsupp (ps_partkey INT NOT NULL, ps_suppkey INT NOT "
//		     "NULL, ps_availqty INT NOT NULL, ps_supplycost DECIMAL(15,2) NOT "
//		     "NULL, ps_comment VARCHAR(199) NOT NULL) ;");
//		EXEC("CREATE TABLE region (r_regionkey INT NOT NULL, r_name VARCHAR(25) "
//		     "NOT NULL, r_comment VARCHAR(152) NOT NULL) ;");
//		EXEC(
//		    "CREATE TABLE nation (n_nationkey INT NOT NULL, n_name VARCHAR(25) NOT "
//		    "NULL, n_regionkey INT NOT NULL, n_comment VARCHAR(152) NOT NULL) ;");
//
...
//		     "'EUROPE' ) order by s_acctbal desc, n_name, s_name, p_partkey limit "
//		     "100");
