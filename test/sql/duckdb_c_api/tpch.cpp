...
TEST_CASE("Test TPC-H Q1", "[tpch]") {
	...
	//" 		     "NULL, p_mfgr VARCHAR(25) NOT NULL, p_brand VARCHAR(10) NOT
	// NULL, " 		     "p_type VARCHAR(25) NOT NULL, p_size INT NOT NULL,
	// p_container " "VARCHAR(10) NOT NULL, p_retailprice DECIMAL(15,2) NOT
	// NULL,
	//" 		     "p_comment VARCHAR(23) NOT NULL) ;"); 		EXEC("CREATE
	// TABLE supplier (s_suppkey INT NOT NULL, s_name
	// VARCHAR(25) " 		     "NOT NULL, s_address VARCHAR(40) NOT NULL,
	// s_nationkey INT NOT NULL, " 		     "s_phone VARCHAR(15) NOT NULL,
	// s_acctbal DECIMAL(15,2) NOT NULL, " 		     "s_comment VARCHAR(101) NOT
	// NULL);"); 		EXEC("CREATE TABLE partsupp (ps_partkey INT NOT NULL,
	// ps_suppkey INT NOT " 		     "NULL, ps_availqty INT NOT NULL,
	// ps_supplycost DECIMAL(15,2) NOT " 		     "NULL, ps_comment
	// VARCHAR(199) NOT NULL) ;"); 		EXEC("CREATE TABLE region (r_regionkey
	// INT NOT NULL, r_name VARCHAR(25) " 		     "NOT NULL, r_comment
	// VARCHAR(152) NOT NULL)
	// ;"); 		EXEC( 		    "CREATE TABLE nation (n_nationkey INT NOT
	// NULL, n_name VARCHAR(25) NOT " 		    "NULL, n_regionkey INT NOT NULL,
	// n_comment VARCHAR(152) NOT NULL)
	//;");
	//
	//		EXEC("select s_acctbal, s_name, n_name, p_partkey, p_mfgr,
	// s_address, " 		     "s_phone, s_comment from part, supplier,
	// partsupp, nation, region " 		     "where p_partkey = ps_partkey and
	// s_suppkey = ps_suppkey and p_size = " 		     "15 and p_type like
	// '%BRASS' and s_nationkey =
