...
void SQLLogicTestLogger::FillValues(QueryResult &result, vector<string> &out, bool &truncated, idx_t &rows,
                                    idx_t &columns) {
...
void SQLLogicTestLogger::ValueMismatch(QueryResult &result, const string &actual_value, const string &expected_value,
                                       idx_t row, idx_t column, const vector<string> &result_values,
                                       const vector<string> &values, idx_t expected_column_count, bool row_wise) {
	std::ostringstream oss;
