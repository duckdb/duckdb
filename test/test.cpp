...
int main() {
	...
	//l_linestatus " 	     "CHAR(1) NOT NULL, l_shipdate DATE NOT NULL, l_commitdate
	//DATE NOT " 	     "NULL, l_receiptdate DATE NOT NULL, l_shipinstruct CHAR(25) NOT
	//NULL, " 	     "l_shipmode CHAR(10) NOT NULL, l_comment VARCHAR(44) NOT NULL);");
