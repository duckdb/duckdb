...
//	con.Query("INSERT INTO test(val) VALUES ('query') RETURNING *")->Print();
//	con.Query("INSERT INTO test(val) VALUES (?) RETURNING *;", "query_arg")->Print();
	duckdb::vector<Value> input_one = {Value("prepared")};
	duckdb::vector<Value> input_two = {Value("prepared_arg")};
	con.Prepare("INSERT INTO test(val) VALUES (?) returning *;")->Execute(input_one, false)->Print();
	con.Prepare("INSERT INTO test(val) VALUES (?) returning *;")->Execute(input_two, false)->Print();
