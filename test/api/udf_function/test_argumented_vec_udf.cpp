...
TEST_CASE("Vectorized UDF functions using arguments", "[udf_function]") {
	...
	for(LogicalType sql_type: all_sql_types) {
		...
		case LogicalTypeId::BOOLEAN:
		{
			...
			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::BOOLEAN, LogicalType::BOOLEAN}, LogicalType::BOOLEAN,
										 &udf_binary_function<bool>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::BOOLEAN, LogicalType::BOOLEAN, LogicalType::BOOLEAN},
										 LogicalType::BOOLEAN, &udf_ternary_function<bool>);
			break;
		}
		case LogicalTypeId::TINYINT:
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::TINYINT}, LogicalType::TINYINT, &udf_unary_function<int8_t>);

			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::TINYINT, LogicalType::TINYINT}, LogicalType::TINYINT,
										 &udf_binary_function<int8_t>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::TINYINT, LogicalType::TINYINT, LogicalType::TINYINT},
                                         LogicalType::TINYINT, &udf_ternary_function<int8_t>);
			break;
		}
		case LogicalTypeId::SMALLINT:
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::SMALLINT}, LogicalType::SMALLINT, &udf_unary_function<int16_t>);

			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::SMALLINT, LogicalType::SMALLINT}, LogicalType::SMALLINT,
										 &udf_binary_function<int16_t>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::SMALLINT, LogicalType::SMALLINT, LogicalType::SMALLINT},
										 LogicalType::SMALLINT, &udf_ternary_function<int16_t>);
			break;
		}
		case LogicalTypeId::DATE:
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::DATE}, LogicalType::DATE, &udf_unary_function<date_t>);
		...
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::TIME}, LogicalType::TIME, &udf_unary_function<dtime_t>);
		...
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::INTEGER}, LogicalType::INTEGER, &udf_unary_function<int32_t>);

			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::INTEGER, LogicalType::INTEGER}, LogicalType::INTEGER,
										 &udf_binary_function<int32_t>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::INTEGER, LogicalType::INTEGER, LogicalType::INTEGER},
										 LogicalType::INTEGER, &udf_ternary_function<int32_t>);
			break;
		}
		case LogicalTypeId::BIGINT:
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::BIGINT}, LogicalType::BIGINT, &udf_unary_function<int64_t>);

			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::BIGINT, LogicalType::BIGINT}, LogicalType::BIGINT,
										 &udf_binary_function<int64_t>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::BIGINT, LogicalType::BIGINT, LogicalType::BIGINT},
										 LogicalType::BIGINT, &udf_ternary_function<int64_t>);
			break;
		}
		case LogicalTypeId::TIMESTAMP:
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::TIMESTAMP}, LogicalType::TIMESTAMP, &udf_unary_function<timestamp_t>);

			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::TIMESTAMP, LogicalType::TIMESTAMP}, LogicalType::TIMESTAMP,
										 &udf_binary_function<timestamp_t>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::TIMESTAMP, LogicalType::TIMESTAMP, LogicalType::TIMESTAMP},
		...
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::DOUBLE}, LogicalType::DOUBLE, &udf_unary_function<double>);

			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::DOUBLE, LogicalType::DOUBLE}, LogicalType::DOUBLE,
									     &udf_binary_function<double>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::DOUBLE, LogicalType::DOUBLE, LogicalType::DOUBLE},
		...
		{ 	con.CreateVectorizedFunction(func_name + "_1", {LogicalType::VARCHAR}, LogicalType::VARCHAR, &udf_unary_function<char *>);

			con.CreateVectorizedFunction(func_name + "_2", {LogicalType::VARCHAR, LogicalType::VARCHAR}, LogicalType::VARCHAR,
										 &udf_binary_function<char *>);

			con.CreateVectorizedFunction(func_name + "_3", {LogicalType::VARCHAR, LogicalType::VARCHAR, LogicalType::VARCHAR},
									     LogicalType::VARCHAR, &udf_ternary_function<char *>);
			break;
		}
		case LogicalTypeId::BLOB:
		{
			con.CreateVectorizedFunction(func_name + "_1", {LogicalType::BLOB}, LogicalType::BLOB, &udf_unary_function<char *>);
	...
	SECTION("Cheking Vectorized UDF functions with several input columns") {
		vector<LogicalType> sql_args = {LogicalType::INTEGER, LogicalType::INTEGER, LogicalType::INTEGER, LogicalType::INTEGER};
		// UDF with 4 input ints, return the last one
		con.CreateVectorizedFunction("udf_four_ints", sql_args, LogicalType::INTEGER, &udf_several_constant_input<int, 4>);
		...
		con.CreateVectorizedFunction("udf_five_ints", sql_args, LogicalType::INTEGER, &udf_several_constant_input<int, 5>);
		...
		con.CreateVectorizedFunction("udf_ten_ints", sql_args, LogicalType::INTEGER, &udf_several_constant_input<int, 10>);
	...
	SECTION("Cheking Vectorized UDF functions with varargs and constant values") {
		...
		con.CreateVectorizedFunction("udf_const_max_int", {LogicalType::INTEGER}, LogicalType::INTEGER, &udf_max_constant<int>, LogicalType::INTEGER);
		...
		con.CreateVectorizedFunction("udf_const_max_double", {LogicalType::DOUBLE}, LogicalType::DOUBLE, &udf_max_constant<double>, LogicalType::DOUBLE);
	...
	SECTION("Cheking Vectorized UDF functions with varargs and input columns") {
		...
		con.CreateVectorizedFunction("udf_flat_max_int", {LogicalType::INTEGER}, LogicalType::INTEGER, &udf_max_flat<int>, LogicalType::INTEGER);
		...
		con.CreateVectorizedFunction("udf_flat_max_double", {LogicalType::DOUBLE}, LogicalType::DOUBLE, &udf_max_flat<double>, LogicalType::DOUBLE);
