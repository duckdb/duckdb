...
#define FAKE_V_STR(avg, sd, cnt)             ADVANCE_STREAM(sd, (long)(Seed[sd].boundary * cnt))
#define ADVANCE_STREAM(stream_id, num_calls) NthElement(num_calls, &Seed[stream_id].value)
