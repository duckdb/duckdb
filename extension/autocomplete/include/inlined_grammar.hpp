...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"TopUniqueConstraint <- 'UNIQUE' UniqueConstraintSpec\n"
	...
	"ResultModifiers <- OrderByClause? LimitOffset? LockingClause?\n"
	"LockingClause <- 'FOR' ForLockingStrength\n"
	"ForLockingStrength <- ForNoKeyUpdate / ForKeyShare / ForUpdate / ForShare\n"
	...
	"SelectFromClause <- SelectClause IntoClause? FromClause?\n"
	"IntoClause <- 'INTO' QualifiedName\n"
