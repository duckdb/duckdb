...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"MethodExpression <- ColLabel Parens(DistinctOrAll? List(FunctionArgument)? OrderByClause? IgnoreNulls?)\n"
	...
	"	EncodingOption / QuoteAsOption / ForceQuoteOption / PartitionByOption / ForceNullOption / NullOption\n"
	...
	"CsvOption <- 'CSV'\n"
	"HeaderOption <- 'HEADER'\n"
	"NullOption <- 'NULL' 'AS'? StringLiteral\n"
	...
	"ExplainOptions <- GenericCopyOptionList\n"
