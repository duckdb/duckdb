...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"TablePivotClause <- 'PIVOT' Parens(TargetList 'FOR' PivotValueList+ GroupByClause?) TableAlias?\n"
	"TableUnpivotClause <- 'UNPIVOT' IncludeExcludeNulls? Parens(UnpivotHeader 'FOR' PivotValueList+) TableAlias?\n"
