...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"InnerTableRef <- PrefixAliasTableRef / ValuesRef / TableFunction / TableSubquery / BaseTableRef / ParensTableRef\n"
	"TableRef <- InnerTableRef JoinOrPivot*\n"
	"PrefixAliasTableRef <- TableAliasColon PrefixAliasTableRefBody\n"
	"PrefixAliasTableRefBody <- PrefixAliasTableFunction / PrefixAliasBaseTable / PrefixAliasSubquery / PrefixAliasParensTable\n"
