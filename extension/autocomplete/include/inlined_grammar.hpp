...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"WindowFrameContents <- BaseWindowName? WindowPartition? OrderByClause? FrameClause?\n"
	...
	"Parameter <- '?' / NumberedParameter / IdentifierParameter\n"
	...
	"SpecialFunctionExpression <- CoalesceExpression / ColumnsExpression / ExtractExpression / LambdaExpression / NullIfExpression / PositionExpression / RowExpression / SubstringExpression / TrimExpression\n"
