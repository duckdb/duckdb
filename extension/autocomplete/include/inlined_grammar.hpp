...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"Factor <- MultiplyOperator / DivisionOperator / ModuloOperator\n"
	"MultiplyOperator <- '*'\n"
	"DivisionOperator <- '/'\n"
	"ModuloOperator <- '%'\n"
	"ExponentiationExpression <- PrefixExpression ('^' ExponentiationExpression)*\n"
