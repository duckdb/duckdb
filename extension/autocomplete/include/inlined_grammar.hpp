...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"ExcludeList <- 'EXCLUDE'i (Parens(List(ColumnName)) / ColumnName)\n"
	"ReplaceList <- 'REPLACE'i (Parens(List(ReplaceEntry)) / ReplaceEntry)\n"
	"ReplaceEntry <- Expression 'AS'i ColumnName\n"
	"RenameList <- 'RENAME'i (Parens(List(RenameEntry)) / RenameEntry)\n"
	"RenameEntry <- ColumnName'AS'i Identifier\n"
	...
	"QualifiedName <- DottedIdentifier\n"
	...
	"Lateral <- 'LATERAL'i\n"
	"BaseTableName <- DottedIdentifier\n"
	...
	"CommentStatement <- 'COMMENT'i 'ON'i CommentOnType ColumnName'IS'i CommentValue\n"
