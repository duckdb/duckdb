...
FILENAME_TO_CATEGORY = {
    "reserved_keyword.list": "KEYWORD_RESERVED",
    "unreserved_keyword.list": "KEYWORD_UNRESERVED",
    "column_name_keyword.list": "KEYWORD_COL_NAME",
    "func_name_keyword.list": "KEYWORD_TYPE_FUNC",
    "type_name_keyword.list": "KEYWORD_TYPE_FUNC",
}

# Maps category names to their C++ map variable names
CPP_MAP_NAMES = {
    "KEYWORD_RESERVED": "reserved_keyword_map",
    "KEYWORD_UNRESERVED": "unreserved_keyword_map",
    "KEYWORD_COL_NAME": "colname_keyword_map",
    "KEYWORD_TYPE_FUNC": "typefunc_keyword_map",
}
...
with open(output_path, "w") as f:
    ...
    f.write("#include \"autocomplete_extension.hpp\"\n")
    f.write("#include \"duckdb/parser/parser_keyword_manager.hpp\"\n\n")
    f.write("namespace duckdb {\n")
    f.write("void AutocompleteExtension::RegisterKeywords(ExtensionLoader &loader) {\n")
    ...
    for i, (category, keywords) in enumerate(keyword_sets.items()):
        ...
        for kw in sorted(list(keywords)):
            ...
            f.write(f'\tloader.RegisterKeyword("{kw}", KeywordCategory::{category});\n')
