...
template <typename A>
static double cubicInterpolate(const double x0, const double y0, const double x1, const double y1, const double x2,
                               const double y2, const double x3, const double y3, const double x);
...
template <typename A>
static double interpolateUsingXArrAndYStride(const double xArr[], const double yStride, const int offset,
                                             const double x);
...
const double xArrComputed[numEntries] = {
    0.0,       1.0,       20.0,      400.0,     8000.0,    160000.0,  300000.0,  600000.0,  900000.0,  1200000.0,
    1500000.0, 1800000.0, 2100000.0, 2400000.0, 2700000.0, 3000000.0, 3300000.0, 3600000.0, 3900000.0, 4200000.0,
    4500000.0, 4800000.0, 5100000.0, 5400000.0, 5700000.0, 6000000.0, 6300000.0, 6600000.0, 6900000.0, 7200000.0,
    7500000.0, 7800000.0, 8100000.0, 8400000.0, 8700000.0, 9000000.0, 9300000.0, 9600000.0, 9900000.0, 10200000.0};
...
template <typename A>
double CubicInterpolation<A>::usingXAndYTables(const double xArr[], const double yArr[], const int len,
                                               const double x) {
	int offset;
...
template <typename A>
static double interpolateUsingXAndYTables(const double xArr[], const double yArr[], const int offset, const double x) {
	return (cubicInterpolate<A>(xArr[offset + 0], yArr[offset + 0], xArr[offset + 1], yArr[offset + 1],
	                            xArr[offset + 2], yArr[offset + 2], xArr[offset + 3], yArr[offset + 3], x));
}

template <typename A>
static inline double cubicInterpolate(const double x0, const double y0, const double x1, const double y1,
...
static int recursiveFindStraddle(const double xArr[], const int l, const int r, const double x) {
	...
	if (xArr[m] <= x)
		...
		return (recursiveFindStraddle<A>(xArr, l, m, x));
}
...
template <typename A>
double CubicInterpolation<A>::usingXArrAndYStride(const double xArr[], const int xArrLen, const double yStride,
                                                  const double x) {
...
static double interpolateUsingXArrAndYStride(const double xArr[], const double yStride, const int offset,
                                             const double x) {
	return cubicInterpolate<A>(xArr[offset + 0], yStride * (offset + 0), xArr[offset + 1], yStride * (offset + 1),
	                           xArr[offset + 2], yStride * (offset + 2), xArr[offset + 3], yStride * (offset + 3), x);
}
