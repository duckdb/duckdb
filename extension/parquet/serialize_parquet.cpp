...
void ParquetOptions::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<bool>(105, "force_direct_io", force_direct_io);
}
...
ParquetOptions ParquetOptions::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<bool>(105, "force_direct_io", result.force_direct_io);
	return result;
}
