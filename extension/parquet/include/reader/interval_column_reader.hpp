...
public:
	IntervalColumnReader(const ParquetReader &reader, const ParquetColumnSchema &schema, const ColumnIndex &column_id)
	    : TemplatedColumnReader<interval_t, IntervalValueConversion>(reader, schema, column_id) {
	}
};
