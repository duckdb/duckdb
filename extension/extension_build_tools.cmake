...
function(register_extension NAME DONT_LINK DONT_BUILD LOAD_TESTS PATH INCLUDE_PATH TEST_PATH LINKED_LIBS EXTENSION_VERSION)
    ...
    elseif(NOT ${GENERATE_EXTENSION_ENTRIES} AND ${EXTENSION_NAME_UPPERCASE} STREQUAL "CORE_FUNCTIONS")
        set(DUCKDB_EXTENSION_${EXTENSION_NAME_UPPERCASE}_SHOULD_BUILD TRUE PARENT_SCOPE)
    elseif(${EXTENSION_TESTS_ONLY} AND NOT ${GENERATE_EXTENSION_ENTRIES} AND ${EXTENSION_NAME_UPPERCASE} STREQUAL "JEMALLOC" AND NOT WIN32 AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        # In EXTENSION_TESTS_ONLY we skip most static extensions, but loadable extension binaries can still
        # depend on jemalloc allocator symbols from the host process.
        set(DUCKDB_EXTENSION_${EXTENSION_NAME_UPPERCASE}_SHOULD_BUILD TRUE PARENT_SCOPE)
