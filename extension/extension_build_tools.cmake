...
# Links what duckdb_resolve_static_link picks, capabilities first, into a DuckDB target.
function(link_extension_libraries LIBRARY LINKAGE)
    duckdb_resolve_static_link(CAPABILITIES EXTENSIONS)
    duckdb_link_extensions(${LIBRARY} ${LINKAGE} ${CAPABILITIES} ${EXTENSIONS})
endfunction()
...
duckdb_resolve_static_link(LOGGED_CAPABILITIES LOGGED_EXTENSIONS)
string(REPLACE ";"  ", " EXT_LIST_DEBUG_MESSAGE "${LOGGED_EXTENSIONS}")
string(REPLACE ";"  ", " CAPABILITY_LIST_DEBUG_MESSAGE "${LOGGED_CAPABILITIES}")
