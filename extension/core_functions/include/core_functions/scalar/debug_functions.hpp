...
struct IndexKeyFun {
	...
	static constexpr const char *Description = "Generate index keys for a named index on a table (specified by a path struct of catalog/schema/table) from key column arguments. Currently only supports ART indexes.";
