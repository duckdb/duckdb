...
struct BitPositionFun {
	...
	static constexpr const char *Description = "Returns first starting index of the specified substring within bits, "
	                                           "or zero if it’s not present. The first (leftmost) bit is indexed 1";
