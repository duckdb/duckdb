...
static const StaticFunctionDefinition core_functions[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET(ArrayDeterminantFun),
	...
	DUCKDB_SCALAR_FUNCTION(ArrayFlattenFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(ArrayMatmulFun),
	...
	DUCKDB_SCALAR_FUNCTION(ArrayReshapeFun),
	...
	DUCKDB_SCALAR_FUNCTION(ArrayTensorShapeFun),
	DUCKDB_SCALAR_FUNCTION_SET(ArrayTraceFun),
	DUCKDB_SCALAR_FUNCTION_ALIAS(ArrayTransformFun),
	DUCKDB_SCALAR_FUNCTION_SET(ArrayTransposeFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(MatmulFun),
	...
	DUCKDB_SCALAR_FUNCTION_ALIAS(ReshapeFun),
	...
	DUCKDB_SCALAR_FUNCTION_ALIAS(TensorShapeFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(TransposeFun),
