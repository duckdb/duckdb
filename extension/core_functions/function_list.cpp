...
static const StaticFunctionDefinition core_functions[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET(FormatreadabledecimalsizeFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(FormatreadablesizeFun),
	DUCKDB_SCALAR_FUNCTION_SET(FormatBytesFun),
