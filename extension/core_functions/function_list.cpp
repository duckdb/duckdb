...
static const StaticFunctionDefinition core_functions[] = {
	...
	DUCKDB_SCALAR_FUNCTION(AnonymizeFun),
	DUCKDB_SCALAR_FUNCTION_SET(AnonymizeAdvancedFun),
	DUCKDB_SCALAR_FUNCTION(AnonymizeEmailFun),
	DUCKDB_SCALAR_FUNCTION_SET(AnonymizePartialFun),
