...
static StaticFunctionDefinition internal_functions[] = {
    DUCKDB_SCALAR_FUNCTION(GetBitFun), DUCKDB_SCALAR_FUNCTION(SetBitFun), DUCKDB_SCALAR_FUNCTION(BitPositionFun),
    DUCKDB_SCALAR_FUNCTION(BitStringFun), FINAL_FUNCTION};
