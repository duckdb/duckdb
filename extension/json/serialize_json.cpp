...
void JSONScanData::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<idx_t>(116, "map_inference_threshold", map_inference_threshold, 10);
}
...
unique_ptr<JSONScanData> JSONScanData::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<idx_t>(116, "map_inference_threshold", result->map_inference_threshold, 10);
	return result;
}
