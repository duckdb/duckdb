...
void JSONScanData::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<double>(113, "field_appearance_threshold", field_appearance_threshold, 0.25);
...
unique_ptr<JSONScanData> JSONScanData::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<double>(113, "field_appearance_threshold", result->field_appearance_threshold, 0.25);
