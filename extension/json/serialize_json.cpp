...
void JSONScanData::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<double>(116, "map_inference_threshold", map_inference_threshold, 0.8);
}
...
unique_ptr<JSONScanData> JSONScanData::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<double>(116, "map_inference_threshold", result->map_inference_threshold, 0.8);
	return result;
}
