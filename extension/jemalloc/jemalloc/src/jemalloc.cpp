 ...
 */
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN void JEMALLOC_CXX_THROW JEMALLOC_ATTR(malloc)
JEMALLOC_ALLOC_SIZE(1) JEMALLOC_SYS_NOTHROW * je_malloc(size_t size) {
	return imalloc_fastpath(size, &malloc_default);
}

int JEMALLOC_CXX_THROW JEMALLOC_ATTR(nonnull(1)) JEMALLOC_SYS_NOTHROW
...
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN void JEMALLOC_CXX_THROW JEMALLOC_ATTR(malloc)
JEMALLOC_ALLOC_SIZE(2) JEMALLOC_SYS_NOTHROW * je_aligned_alloc(size_t alignment, size_t size) {
	void *ret;
...
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN void JEMALLOC_CXX_THROW JEMALLOC_ATTR(malloc)
JEMALLOC_ALLOC_SIZE2(1, 2) JEMALLOC_SYS_NOTHROW * je_calloc(size_t num, size_t size) {
	void *ret;
	static_opts_t sopts;
	dynamic_opts_t dopts;
...
void JEMALLOC_CXX_THROW JEMALLOC_SYS_NOTHROW je_free(void *ptr) {
...
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN
...
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN void  JEMALLOC_CXX_THROW JEMALLOC_ATTR(malloc)
JEMALLOC_SYS_NOTHROW * je_valloc(size_t size) {
	void *ret;
...
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN void JEMALLOC_ATTR(malloc) JEMALLOC_ALLOC_SIZE(1)
JEMALLOC_NOTHROW *je_mallocx(size_t size, int flags) {
	void *ret;
	static_opts_t sopts;
	dynamic_opts_t dopts;
...
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN void JEMALLOC_ALLOC_SIZE(2) JEMALLOC_NOTHROW
...
JEMALLOC_ALLOCATOR JEMALLOC_RESTRICT_RETURN void JEMALLOC_CXX_THROW JEMALLOC_ALLOC_SIZE(2)
JEMALLOC_SYS_NOTHROW * je_realloc(void *ptr, size_t size) {
...
size_t JEMALLOC_NOTHROW je_xallocx(void *ptr, size_t size, size_t extra, int flags) {
	tsd_t *tsd;
...
size_t JEMALLOC_ATTR(pure) JEMALLOC_NOTHROW je_sallocx(const void *ptr, int flags) {
	size_t usize;
	tsdn_t *tsdn;
...
void JEMALLOC_NOTHROW je_dallocx(void *ptr, int flags) {
...
void JEMALLOC_NOTHROW je_sdallocx(void *ptr, size_t size, int flags) {
...
size_t JEMALLOC_ATTR(pure) JEMALLOC_NOTHROW je_nallocx(size_t size, int flags) {
	size_t usize;
	tsdn_t *tsdn;
