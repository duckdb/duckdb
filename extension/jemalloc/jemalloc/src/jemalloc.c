...
jemalloc_constructor(void) {
	...
	snprintf(JE_MALLOC_CONF_BUFFER, JE_MALLOC_CONF_BUFFER_SIZE, "metadata_thp:always,oversize_threshold:4096,dirty_decay_ms:5000,muzzy_decay_ms:5000,narenas:%llu,max_background_threads:%llu", cpu_count, bgt_count);
