...
class DuckDBPyConnection:
    ...
    @overload
    def df(self, arg0: bool) -> pandas.DataFrame: ...
    @overload
    ...
    def fetch_df(self, date_as_datetime: bool = ...) -> pandas.DataFrame: ...
    def fetch_df_chunk(self, date_as_datetime: bool = ..., vectors_per_chunk: int = ...) -> pandas.DataFrame: ...
    def fetch_record_batch(self, chunk_size: int = ...) -> pyarrow.lib.RecordBatchReader: ...
    def fetchall(self) -> list: ...
    def fetchdf(self, date_as_datetime: bool = ...) -> pandas.DataFrame: ...
...
class DuckDBPyRelation:
    ...
    def df(self, date_as_datetime: bool = ...) -> pandas.DataFrame: ...
    ...
    def to_df(self, date_as_datetime: bool = ...) -> pandas.DataFrame: ...
...
class DuckDBPyResult:
    ...
    def fetch_arrow_table(self, chunk_size: int = ...) -> pyarrow.lib.Table: ...
    def fetch_df(self, date_as_datetime: bool = ...) -> pandas.DataFrame: ...
    def fetch_df_chunk(self, date_as_datetime: bool = ..., num_of_vectors: int = ...) -> pandas.DataFrame: ...
    def fetchall(self) -> list: ...
    def fetchdf(self, date_as_datetime: bool = ...) -> pandas.DataFrame: ...
    def fetchmany(self, size: int = ...) -> list: ...
    def fetchnumpy(self) -> dict: ...
