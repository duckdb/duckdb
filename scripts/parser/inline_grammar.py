...
def write_keyword_map(keyword_sets):
    ...
    with open(output_path, "w") as f:
        ...
        f.write("#include \"duckdb/parser/peg/keyword_helper/duckdb_keyword_helper.hpp\"\n\n")
        f.write("namespace duckdb {\n")
        f.write("DefaultKeywordMaps DuckDBKeywordHelper::InitializeKeywordMaps() {\n")
        f.write("\tDefaultKeywordMaps keyword_maps;\n\n")
