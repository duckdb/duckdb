...
def collect_generated(gram_stem, rules, rule_types, excluded_rules, identifier_override_rules):
...
def process_gram_file(gram_filename, rule_types, excluded_rules, identifier_override_rules):
    ...
    return collect_generated(gram_stem, rules, rule_types, excluded_rules, identifier_override_rules)
...
def main():
    ...
    results = [process_gram_file(f, rule_types, excluded_rules, identifier_override_rules) for f in gram_files_to_gen]
