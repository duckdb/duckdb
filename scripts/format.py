...
ignored_directories = ['.eggs', '__pycache__', 'icu', 'dbgen', os.path.join('tools', 'pythonpkg', 'duckdb'), os.path.join('tools', 'pythonpkg', 'build'), os.path.join('tools', 'rpkg', 'src', 'duckdb'), os.path.join('tools', 'rpkg', 'src', 'include', 'cpp11'), os.path.join('extension', 'tpcds', 'dsdgen')]
format_all = False
check_only = True
confirm = True
silent = False
