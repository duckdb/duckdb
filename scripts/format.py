...
ignored_files = ['tpch_constants.hpp', 'tpcds_constants.hpp', '_generated', 'tpce_flat_input.hpp',
                 ...
                 'nf_calendar.cpp', 'nf_calendar.h', 'nf_localedata.cpp', 'nf_localedata.h', 'nf_zformat.cpp', 'nf_zformat.h', 'expr.cc', 'driver_manager.cpp', 'driver_manager.hpp', 'adbc.h', 'adbc.cpp', 'adbc-init.hpp']
