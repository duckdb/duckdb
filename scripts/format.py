...
ignored_directories = ['.eggs', '__pycache__', 'icu', 'dbgen', os.path.join('tools', 'pythonpkg', 'duckdb'), os.path.join('tools', 'pythonpkg', 'build'), os.path.join('tools', 'rpkg', 'src', 'duckdb'), os.path.join('extension', 'tpcds', 'dsdgen'), os.path.join('examples', 'arrowir', 'flatbuffers'), os.path.join('examples', 'arrowir', 'schema')]
format_all = False
check_only = True
confirm = True
silent = False
