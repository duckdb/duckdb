...
###########################
AWS_DEFAULT_REGION=eu-west-1 AWS_ACCESS_KEY_ID=minio_duckdb_user AWS_SECRET_ACCESS_KEY=minio_duckdb_user_password S3_ENDPOINT_URL=http://duckdb-minio.com:9000 s5cmd sync "$LOCAL_EXTENSION_REPO_UPDATED/" s3://test-bucket-public/ci-test-repo
