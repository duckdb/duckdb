    ...
    with open(target_path, 'w+') as f:
        ...
        for class_name in class_name_list:
            ...
            for entry in serialize_data[class_name]:
                ...
                class_serialize += serialize_element.replace('${PROPERTY_NAME}', write_property_name).replace(
                    '${PROPERTY_KEY}', property_key).replace('WriteProperty', write_method)
                class_deserialize += deserialize_template_str.replace('${PROPERTY_NAME}', property_name).replace(
                    '${PROPERTY_KEY}', property_key).replace('ReadProperty', read_method)
