...
def generate_writer_header(source_path, classes, include_list):
    # The bodies go into the generated source of the same schema, so opting in needs no build change
...
for entry in file_list:
    ...
    writer_bodies = generate_writer_header(source_path, classes, include_list)
    if writer_bodies:
        include_list.append(writer_include_path(source_path))
