...
set(DUCKDB_VERSION "" CACHE STRING "Metadata field: path of file containing duckdb_version")
set(EXTENSION_VERSION "" CACHE STRING "Metadata field: path of file containing extension_version")
set(META5 "" CACHE STRING "Metadata field")
...
string(SUBSTRING "${DUCKDB_VERSION}${EMPTY_32}" 0 32 METADATA3)
string(SUBSTRING "${EXTENSION_VERSION}${EMPTY_32}" 0 32 METADATA4)
string(SUBSTRING "${META5}${EMPTY_32}" 0 32 METADATA5)
