...
# NOTE: NOTICE - first step toward C API (v2) generation tooling -- early test of generated v1 header
import sys

print(
    """Aborting C API (v1) generation; current src/include/duckdb.h is generated by new tooling.

If you have a problem with current duckdb.h, please report it!
If you need to remake the header with previous generator, just remove these lines from
