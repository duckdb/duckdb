...
postgis_json_dir = os.path.join('third_party', 'postgis', 'json')
postgis_json_include_dir = os.path.join('third_party', 'postgis', 'json', 'include')
postgis_dir = os.path.join('third_party', 'postgis')
postgis_include_dir = os.path.join('third_party', 'postgis', 'include')
...
include_paths = [include_dir, fmt_include_dir, re2_dir, miniz_dir, utf8proc_include_dir, hll_dir, fastpforlib_dir, tdigest_dir, utf8proc_dir, pg_query_include_dir, pg_query_dir, moodycamel_include_dir, pcg_include_dir, httplib_include_dir, postgis_json_include_dir, postgis_json_dir, postgis_include_dir, postgis_dir]
# paths of where to look for files to compile and include to the final amalgamation
compile_directories = [src_dir, fmt_dir, miniz_dir, re2_dir, hll_dir, fastpforlib_dir, utf8proc_dir, pg_query_dir, postgis_json_dir, postgis_dir]
