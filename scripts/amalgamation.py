...
def generate_duckdb_hpp(header_file):
    ...
    print("-----------------------")
    with open(temp_header, 'w+', encoding="utf8") as hfile:
        hfile.write("/*\n")
...
def generate_amalgamation(source_file, header_file):
    ...
    with open(temp_source, 'w+', encoding="utf8") as sfile:
...
def generate_amalgamation_splits(source_file, header_file, nsplits):
    ...
    with open(temp_internal_header, 'w+', encoding="utf8") as f:
        write_license(f)
    ...
    for partition in partitions:
        ...
        with open(temp_partition_name, 'w+', encoding="utf8") as f:
            write_license(f)
