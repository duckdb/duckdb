...
include_paths = [include_dir, fmt_include_dir, hll_dir, re2_dir, miniz_dir, pg_query_include_dir, pg_query_dir, utf8proc_include_dir]
# paths of where to look for files to compile and include to the final amalgamation
compile_directories = [src_dir, fmt_dir, hll_dir, miniz_dir, re2_dir, pg_query_dir, utf8proc_dir]
