...
for f in files:
    ...
    subprocess.call(['curl', '-s','--ftp-create-dirs', '--ftp-pasv','--ftp-method', 'multicwd','-m','60', '--retry', '10', '-T', f, 'ftp://ftp10635776-duckdb:%s@wp10635776.server-he.de/%s' % (secret_key, key)])
