...
OdbcException::OdbcException(const std::string &msg, const std::string &sqlstate, const std::string &server_name, SQLINTEGER col_number, SQLINTEGER sql_native, SQLLEN row_number) {
    diag_record.sql_diag_message_text = msg;
