...
std::vector<std::vector<std::string>> results = {
    {"true",     "true",
     ...
     EXPECTED_ERROR,         EXPECTED_ERROR,
     EXPECTED_ERROR,         EXPECTED_ERROR},
    {"F4F4F", "F4F4F", EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, "hex: 4634463446", EXPECTED_ERROR, "hex: 4634463446", EXPECTED_ERROR, EXPECTED_ERROR,
     EXPECTED_ERROR,      EXPECTED_ERROR,      EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR},
    {"x", "x", EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, "hex: 78", EXPECTED_ERROR, "hex: 78",
     EXPECTED_ERROR,  EXPECTED_ERROR,  EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR, EXPECTED_ERROR,        EXPECTED_ERROR, EXPECTED_ERROR},
    {"1234567890",
     "1234567890",
     EXPECTED_ERROR,
     EXPECTED_ERROR,
...
static void ConvertAndCheck(HSTMT &hstmt, std::vector<std::string> type,
	...
	if (results[type_index][sql_type_index] == EXPECTED_ERROR) {
