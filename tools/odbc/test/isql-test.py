...
test("""CREATE TABLE people(id INTEGER, name VARCHAR);
...
test("""PRAGMA enable_verification
...
test('SELECT cast(a AS VARCHAR) FROM test;',
out=(
"11\n"
"12\n"
"13")
...
test('SELECT cast(cast(a AS VARCHAR) as INTEGER) FROM test;',
out=(
"11\n"
"12\n"
"13")
...
test('SELECT t-t FROM timestamp',
out=(
"00:00:00\n"
"\n"
"00:00:00\n"
...
test("SELECT cast(i AS VARCHAR) FROM times",
out=(
"00:01:20\n"
"20:08:10.998\n"
"20:08:10.33\n"
...
test("SELECT cast(a AS BIGINT) FROM test;",
out=(
"11\n"
"\n"
"13")
...
test("SELECT '1701411834604692317316873037.1588410572'::DECIMAL(38,10)::VARCHAR;", out='1701411834604692317316873037.1588410572')
...
test("SELECT substring(s, 1, 1), substring(s, 2, 1) FROM emojis ORDER BY id",
out=(
"🦆|\n"
"🦆|🍞")
)
