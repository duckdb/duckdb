...
{                     "'CHAR'",                      SQL_CHAR,  1,  "''''", "''''",          "'length'", SQL_NULLABLE,  SQL_TRUE, SQL_SEARCHABLE,        -1, SQL_FALSE, SQL_FALSE,      "NULL", -1, -1,      SQL_CHAR,                        -1,  0, -1},
{                  "'BOOLEAN'",                       SQL_BIT,  1,  "NULL", "NULL",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,  SQL_TRUE,  SQL_TRUE, SQL_FALSE, "'boolean'", -1, -1,       SQL_BIT,                        -1,  0, -1},
...
{                     "'DATE'",                 SQL_TYPE_DATE, 10,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE, SQL_FALSE,      "NULL", -1, -1,  SQL_DATETIME,             SQL_CODE_DATE,  0, -1},
{                     "'TIME'",                 SQL_TYPE_TIME,  8,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE, SQL_FALSE,      "NULL",  0,  0,  SQL_DATETIME,             SQL_CODE_TIME,  0, -1},
{                "'TIMESTAMP'",            SQL_TYPE_TIMESTAMP, 26,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE, SQL_FALSE,      "NULL",  0,  0,  SQL_DATETIME,        SQL_CODE_TIMESTAMP,  0, -1},
...
{                  "'VARCHAR'",                   SQL_VARCHAR, -1,  "''''", "''''",          "'length'", SQL_NULLABLE,  SQL_TRUE, SQL_SEARCHABLE,        -1, SQL_FALSE,        -1,      "NULL", -1, -1,   SQL_VARCHAR,                        -1,  0, -1},
{                     "'BLOB'",                 SQL_VARBINARY, -1, "'x'''", "''''",          "'length'", SQL_NULLABLE,  SQL_TRUE, SQL_PRED_BASIC,        -1, SQL_FALSE, SQL_FALSE,      "NULL", -1, -1, SQL_VARBINARY,                        -1,  0, -1},
{            "'INTERVAL YEAR'",             SQL_INTERVAL_YEAR,  9,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,             SQL_CODE_YEAR,  0, -1},
{           "'INTERVAL MONTH'",            SQL_INTERVAL_MONTH, 10,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,            SQL_CODE_MONTH,  0, -1},
{             "'INTERVAL DAY'",              SQL_INTERVAL_DAY,  5,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,              SQL_CODE_DAY,  0, -1},
{            "'INTERVAL HOUR'",             SQL_INTERVAL_HOUR,  6,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,             SQL_CODE_HOUR,  0, -1},
{          "'INTERVAL MINUTE'",           SQL_INTERVAL_MINUTE,  8,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,           SQL_CODE_MINUTE,  0, -1},
{          "'INTERVAL SECOND'",           SQL_INTERVAL_SECOND, 10,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,           SQL_CODE_SECOND,  0, -1},
{   "'INTERVAL YEAR TO MONTH'",    SQL_INTERVAL_YEAR_TO_MONTH, 12,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,    SQL_CODE_YEAR_TO_MONTH,  0, -1},
{     "'INTERVAL DAY TO HOUR'",      SQL_INTERVAL_DAY_TO_HOUR,  8,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,      SQL_CODE_DAY_TO_HOUR,  0, -1},
{   "'INTERVAL DAY TO MINUTE'",    SQL_INTERVAL_DAY_TO_MINUTE, 11,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,    SQL_CODE_DAY_TO_MINUTE,  0, -1},
{   "'INTERVAL DAY TO SECOND'",    SQL_INTERVAL_DAY_TO_SECOND, 14,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,    SQL_CODE_DAY_TO_SECOND,  0, -1},
{  "'INTERVAL HOUR TO MINUTE'",   SQL_INTERVAL_HOUR_TO_MINUTE,  9,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,   SQL_CODE_HOUR_TO_MINUTE,  0, -1},
{  "'INTERVAL HOUR TO SECOND'",   SQL_INTERVAL_HOUR_TO_SECOND, 12,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL,   SQL_CODE_HOUR_TO_SECOND,  0, -1},
{"'INTERVAL MINUTE TO SECOND'", SQL_INTERVAL_MINUTE_TO_SECOND, 12,  "''''", "''''",              "NULL", SQL_NULLABLE, SQL_FALSE, SQL_PRED_BASIC,        -1, SQL_FALSE,        -1,      "NULL",  0,  0,  SQL_INTERVAL, SQL_CODE_MINUTE_TO_SECOND,  0, -1}
};
// clang-format on
