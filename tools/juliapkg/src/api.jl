...
function duckdb_string_is_inlined(string)
    return ccall((:duckdb_string_is_inlined, libduckdb), Bool, (duckdb_string,), string)
end
...
function duckdb_string_t_length(string)
    return ccall((:duckdb_string_t_length, libduckdb), UInt32, (duckdb_string,), string)
end
...
"""
    duckdb_create_struct_value(type_, values)
...
"""
    duckdb_create_list_value(type_, values, value_count)
...
"""
    duckdb_create_array_value(type_, values, value_count)
...
"""
    duckdb_create_enum_value(type_, value)
...
"""
function duckdb_create_enum_value(type_, value)
    return ccall((:duckdb_create_enum_value, libduckdb), duckdb_value, (duckdb_logical_type, UInt64), type_, value)
end
...
"""
    duckdb_create_logical_type(type_)
...
"""
function duckdb_create_logical_type(type_)
    return ccall((:duckdb_create_logical_type, libduckdb), duckdb_logical_type, (DUCKDB_TYPE,), type_)
end

"""
    duckdb_logical_type_get_alias(type_)
...
"""
function duckdb_logical_type_get_alias(type_)
    return ccall((:duckdb_logical_type_get_alias, libduckdb), Ptr{UInt8}, (duckdb_logical_type,), type_)
end

"""
    duckdb_logical_type_set_alias(type_, alias)
...
Returns: 
"""
function duckdb_logical_type_set_alias(type_, alias)
    return ccall((:duckdb_logical_type_set_alias, libduckdb), Cvoid, (duckdb_logical_type, Cstring), type_, alias)
end

"""
    duckdb_create_list_type(type_)
...
Returns: The logical type.
"""
function duckdb_create_list_type(type_)
    return ccall((:duckdb_create_list_type, libduckdb), duckdb_logical_type, (duckdb_logical_type,), type_)
end

"""
    duckdb_create_array_type(type_, array_size)
...
"""
function duckdb_get_type_id(type_)
    return ccall((:duckdb_get_type_id, libduckdb), DUCKDB_TYPE, (duckdb_logical_type,), type_)
end

"""
    duckdb_decimal_width(type_)
...
"""
function duckdb_decimal_width(type_)
    return ccall((:duckdb_decimal_width, libduckdb), UInt8, (duckdb_logical_type,), type_)
end

"""
    duckdb_decimal_scale(type_)
...
"""
function duckdb_decimal_scale(type_)
    return ccall((:duckdb_decimal_scale, libduckdb), UInt8, (duckdb_logical_type,), type_)
end

"""
    duckdb_decimal_internal_type(type_)
...
"""
function duckdb_decimal_internal_type(type_)
    return ccall((:duckdb_decimal_internal_type, libduckdb), DUCKDB_TYPE, (duckdb_logical_type,), type_)
end

"""
    duckdb_enum_internal_type(type_)
...
"""
function duckdb_enum_internal_type(type_)
    return ccall((:duckdb_enum_internal_type, libduckdb), DUCKDB_TYPE, (duckdb_logical_type,), type_)
end

"""
    duckdb_enum_dictionary_size(type_)
...
"""
function duckdb_enum_dictionary_size(type_)
    return ccall((:duckdb_enum_dictionary_size, libduckdb), UInt32, (duckdb_logical_type,), type_)
end

"""
    duckdb_enum_dictionary_value(type_, index)
...
"""
function duckdb_enum_dictionary_value(type_, index)
    return ccall((:duckdb_enum_dictionary_value, libduckdb), Ptr{UInt8}, (duckdb_logical_type, idx_t), type_, index - 1)
end

"""
    duckdb_list_type_child_type(type_)
...
"""
function duckdb_list_type_child_type(type_)
    return ccall((:duckdb_list_type_child_type, libduckdb), duckdb_logical_type, (duckdb_logical_type,), type_)
end

"""
    duckdb_array_type_child_type(type_)
...
"""
function duckdb_array_type_child_type(type_)
    return ccall((:duckdb_array_type_child_type, libduckdb), duckdb_logical_type, (duckdb_logical_type,), type_)
end

"""
    duckdb_array_type_array_size(type_)
...
"""
function duckdb_array_type_array_size(type_)
    return ccall((:duckdb_array_type_array_size, libduckdb), idx_t, (duckdb_logical_type,), type_)
end

"""
    duckdb_map_type_key_type(type_)
...
"""
function duckdb_map_type_key_type(type_)
    return ccall((:duckdb_map_type_key_type, libduckdb), duckdb_logical_type, (duckdb_logical_type,), type_)
end

"""
    duckdb_map_type_value_type(type_)
...
"""
function duckdb_map_type_value_type(type_)
    return ccall((:duckdb_map_type_value_type, libduckdb), duckdb_logical_type, (duckdb_logical_type,), type_)
end

"""
    duckdb_struct_type_child_count(type_)
...
Returns: The number of children of a struct type.
"""
function duckdb_struct_type_child_count(type_)
    return ccall((:duckdb_struct_type_child_count, libduckdb), idx_t, (duckdb_logical_type,), type_)
end

"""
    duckdb_struct_type_child_name(type_, index)
...
"""
    duckdb_struct_type_child_type(type_, index)
...
"""
    duckdb_union_type_member_count(type_)
...
"""
function duckdb_union_type_member_count(type_)
    return ccall((:duckdb_union_type_member_count, libduckdb), idx_t, (duckdb_logical_type,), type_)
end

"""
    duckdb_union_type_member_name(type_, index)
...
"""
    duckdb_union_type_member_type(type_, index)
...
Returns: 
"""
function duckdb_destroy_logical_type(type_)
    return ccall((:duckdb_destroy_logical_type, libduckdb), Cvoid, (Ref{duckdb_logical_type},), type_)
end

"""
    duckdb_register_logical_type(con, type_, info)
...
"""
    duckdb_scalar_function_set_varargs(scalar_function, type_)
...
"""
    duckdb_scalar_function_add_parameter(scalar_function, type_)
...
"""
    duckdb_scalar_function_set_return_type(scalar_function, type_)
...
"""
    duckdb_scalar_function_set_function(scalar_function, function_)
...
"""
    duckdb_add_scalar_function_to_set(set, function_)
...
"""
    duckdb_aggregate_function_add_parameter(aggregate_function, type_)
...
"""
    duckdb_aggregate_function_set_return_type(aggregate_function, type_)
...
"""
    duckdb_add_aggregate_function_to_set(set, function_)
...
"""
    duckdb_table_function_add_parameter(table_function, type_)
...
"""
    duckdb_table_function_add_named_parameter(table_function, name, type_)
...
"""
    duckdb_table_function_set_function(table_function, function_)
...
"""
    duckdb_register_table_function(con, function_)
...
"""
    duckdb_bind_add_result_column(info, name, type_)
...
"""
    duckdb_cast_function_set_function(cast_function, function_)
