...
function duckdb_struct_type_child_name(_type, index)
    return ccall((:duckdb_struct_type_child_name, libduckdb), Ptr{UInt8}, (duckdb_logical_type, idx_t), _type, index - 1)
end
...
function duckdb_union_type_member_name(_type, index)
    return ccall((:duckdb_union_type_member_name, libduckdb), Ptr{UInt8}, (duckdb_logical_type, idx_t), _type, index - 1)
end
...
function duckdb_struct_type_child_type(_type, index)
    return ccall((:duckdb_struct_type_child_type, libduckdb), duckdb_logical_type, (duckdb_logical_type, idx_t), _type, index - 1)
end
...
function duckdb_union_type_member_type(_type, index)
    return ccall((:duckdb_union_type_member_type, libduckdb), duckdb_logical_type, (duckdb_logical_type, idx_t), _type, index - 1)
end
...
function duckdb_table_function_add_parameter(table_function, _type)
    return ccall((:duckdb_table_function_add_parameter, libduckdb), Cvoid, (duckdb_table_function, duckdb_logical_type), table_function, _type)
end
...
function duckdb_table_function_set_function(table_function, _function)
    return ccall((:duckdb_table_function_set_function, libduckdb), Cvoid, (duckdb_table_function, duckdb_table_function), table_function, _function)
end
...
function duckdb_register_table_function(con, _function)
    return ccall((:duckdb_register_table_function, libduckdb), duckdb_state, (duckdb_connection, duckdb_table_function), con, _function)
end
...
function duckdb_bind_add_result_column(info, name, _type)
    return ccall((:duckdb_bind_add_result_column, libduckdb), Cvoid, (duckdb_bind_info, Cstring, duckdb_logical_type), info, name, _type)
end
...
function duckdb_scalar_function_add_parameter(scalar_function, _type)
    return ccall((:duckdb_scalar_function_add_parameter, libduckdb), Cvoid, (duckdb_scalar_function, duckdb_logical_type), scalar_function, _type)
end
...
function duckdb_scalar_function_set_return_type(scalar_function, _type)
    return ccall((:duckdb_scalar_function_set_return_type, libduckdb), Cvoid, (duckdb_scalar_function, duckdb_logical_type), scalar_function, _type)
end
...
function duckdb_scalar_function_set_function(scalar_function, _function)
    return ccall((:duckdb_scalar_function_set_function, libduckdb), Cvoid, (duckdb_scalar_function, duckdb_scalar_function), scalar_function, _function)
end
...
function duckdb_table_function_add_named_parameter(table_function, name, _type)
    return ccall((:duckdb_table_function_add_named_parameter, libduckdb), Cvoid, (duckdb_table_function, Cstring, duckdb_logical_type), table_function, name, _type)
end
...
function duckdb_create_struct_value(_type, values)
    return ccall((:duckdb_create_struct_value, libduckdb), duckdb_value, (duckdb_logical_type, Ref{duckdb_value}), _type, values)
end
...
function duckdb_create_list_value(_type, values, value_count)
    return ccall((:duckdb_create_list_value, libduckdb), duckdb_value, (duckdb_logical_type, Ref{duckdb_value}, idx_t), _type, values, value_count)
end
...
function duckdb_create_array_value(_type, values, value_count)
    return ccall((:duckdb_create_array_value, libduckdb), duckdb_value, (duckdb_logical_type, Ref{duckdb_value}, idx_t), _type, values, value_count)
end
...
function duckdb_create_array_type(_type, array_size)
    return ccall((:duckdb_create_array_type, libduckdb), duckdb_logical_type, (duckdb_logical_type, idx_t), _type, array_size)
end
...
function duckdb_register_logical_type(con, _type, info)
    return ccall((:duckdb_register_logical_type, libduckdb), duckdb_state, (duckdb_connection, duckdb_logical_type, duckdb_create_type_info), con, _type, info)
end
...
function duckdb_cast_function_set_function(cast_function, _function)
    return ccall((:duckdb_cast_function_set_function, libduckdb), Cvoid, (duckdb_cast_function, duckdb_cast_function), cast_function, _function)
end
...
function duckdb_aggregate_function_add_parameter(aggregate_function, _type)
    return ccall((:duckdb_aggregate_function_add_parameter, libduckdb), Cvoid, (duckdb_aggregate_function, duckdb_logical_type), aggregate_function, _type)
end
...
function duckdb_aggregate_function_set_return_type(aggregate_function, _type)
    return ccall((:duckdb_aggregate_function_set_return_type, libduckdb), Cvoid, (duckdb_aggregate_function, duckdb_logical_type), aggregate_function, _type)
end
...
function duckdb_add_aggregate_function_to_set(set, _function)
    return ccall((:duckdb_add_aggregate_function_to_set, libduckdb), duckdb_state, (duckdb_aggregate_function_set, duckdb_aggregate_function), set, _function)
end
...
function duckdb_scalar_function_set_varargs(scalar_function, _type)
    return ccall((:duckdb_scalar_function_set_varargs, libduckdb), Cvoid, (duckdb_scalar_function, duckdb_logical_type), scalar_function, _type)
end
...
function duckdb_add_scalar_function_to_set(set, _function)
    return ccall((:duckdb_add_scalar_function_to_set, libduckdb), duckdb_state, (duckdb_scalar_function_set, duckdb_scalar_function), set, _function)
end
