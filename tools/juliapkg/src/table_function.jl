...
function AddResultColumn(bind_info::BindInfo, name::AbstractString, type::LogicalType)
	duckdb_bind_add_result_column(bind_info.handle, name, type.handle)
end
...
function _table_main_function(info::duckdb_function_info, chunk::duckdb_data_chunk)
	...
	main_info.main_func(binfo, DataChunk(chunk))
end
...
mutable struct TableFunction
    ...
    function TableFunction(name::AbstractString, parameters::Vector{LogicalType}, bind_func::Function, init_func::Function, main_func::Function)
		...
		duckdb_table_function_set_function(handle, @cfunction(_table_main_function, Cvoid, (duckdb_function_info,duckdb_data_chunk)))
...
function CreateTableFunction(con::Connection, name::AbstractString, parameters::Vector{LogicalType}, bind_func::Function, init_func::Function, main_func::Function)
