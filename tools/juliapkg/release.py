...
parser.add_argument('--yggdrassil-fork', dest='yggdrassil',
                     action='store', help='Fork of the Julia Yggdrassil repository (https://github.com/JuliaPackaging/Yggdrasil)', default='/Users/myth/Programs/Yggdrasil')
...
run_syscall(f'gh pr create --title "[DuckDB] Bump to {tag}" --repo "https://github.com/JuliaPackaging/Yggdrasil" --body ""')
