...
test_that("substrait extension json test", {
  ...
  on.exit(dbDisconnect(con, shutdown = TRUE))
  dbExecute(con, "CREATE TABLE integers (i INTEGER)")
  expected_json <- "{\"relations\":[{\"root\":{\"input\":{\"fetch\":{\"input\":{\"project\":{\"input\":{\"project\":{\"input\":{\"read\":{\"baseSchema\":{\"names\":[\"i\"]},\"namedTable\":{\"names\":[\"integers\"]}}},\"expressions\":[{\"selection\":{\"directReference\":{\"structField\":{}}}}]}},\"expressions\":[{\"selection\":{\"directReference\":{\"structField\":{}}}}]}},\"count\":\"5\"}},\"names\":[\"i\"]}}]}"
