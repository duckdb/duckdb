...
// relational.cpp
SEXP rapi_expr_reference(std::string ref);
extern "C" SEXP _duckdb_rapi_expr_reference(SEXP ref) {
  BEGIN_CPP11
    return cpp11::as_sexp(rapi_expr_reference(cpp11::as_cpp<cpp11::decay_t<std::string>>(ref)));
  END_CPP11
}
// relational.cpp
