...
// relational.cpp
SEXP rapi_expr_constant(sexp val, bool experimental);
extern "C" SEXP _duckdb_rapi_expr_constant(SEXP val, SEXP experimental) {
  BEGIN_CPP11
    return cpp11::as_sexp(rapi_expr_constant(cpp11::as_cpp<cpp11::decay_t<sexp>>(val), cpp11::as_cpp<cpp11::decay_t<bool>>(experimental)));
  END_CPP11
}
// relational.cpp
