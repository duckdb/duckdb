...
ArrayWrapper::ArrayWrapper(const LogicalType &type, ClientProperties client_properties_p)
    : requires_mask(false), client_properties(std::move(client_properties_p)) {
