...
unique_ptr<DuckDBPyRelation>
PyConnectionWrapper::ReadJSON(const py::object &filename, shared_ptr<DuckDBPyConnection> conn,
                              const Optional<py::object> &columns, const Optional<py::object> &sample_size,
