...
def parse_argv(extensions, libraries):
    ...
    if {'pytest', 'test', 'ptr'}.intersection(sys.argv):
        ...
        setup_requires = []
    return toolchain_args, libraries, existing_duckdb_dir, setup_requires


def get_libduckdb(extensions, libraries):
    extra_files = []
    header_files = []
    toolchain_args, libraries, existing_duckdb_dir, setup_requires = parse_argv(extensions, libraries)
    ...
    return libduckdb, extra_files, header_files, setup_requires
