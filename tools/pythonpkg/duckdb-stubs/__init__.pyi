...
class InvalidTypeException(Error): ...

class NotSupportedError(Error): ...

class OutOfMemoryException(Error): ...

class OutOfRangeException(Error): ...
...
class SerializationException(Error): ...

class StandardException(Error): ...

class SyntaxException(Error): ...

class TransactionException(Error): ...

class TypeMismatchException(Error): ...
