...
class DuckDBPyConnection:
    ...
    def register_scalar(self, name: str, func: Callable, return_type: DuckDBPyType, parameters: Optional[List[DuckDBPyType]]) -> DuckDBPyConnection: ...
...
class DuckDBPyRelation:
    ...
    def columns_by_type(self, types: List[Union[str, DuckDBPyType]]) -> DuckDBPyRelation: ...
...
def register_scalar(self, name: str, func: Callable, args: List[DuckDBPyType], return_type: DuckDBPyType, connection: DuckDBPyConnection = ...) -> DuckDBPyConnection: ...
