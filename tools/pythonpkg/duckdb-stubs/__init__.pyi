...
class DuckDBPyType:
    def __init__(self, type_str: str, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
...
class DuckDBPyRelation:
    ...
    def project(self, project_expr: Union[str, List[Union[str, DuckDBPyType]]]) -> DuckDBPyRelation: ...
...
def sqltype(self, type_str: str, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def dtype(self, type_str: str, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def type(self, type_str: str, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def struct_type(self, fields: Union[Dict[str, DuckDBPyType], List[str]], connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def row_type(self, fields: Union[Dict[str, DuckDBPyType], List[str]], connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def union_type(self, members: Union[Dict[str, DuckDBPyType], List[str]], connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def string_type(self, collation: str = "", connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def enum_type(self, name: str, type: DuckDBPyType, values: list, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def decimal_type(self, width: int, scale: int, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def array_type(self, type: DuckDBPyType, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def list_type(self, type: DuckDBPyType, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
def map_type(self, key: DuckDBPyType, value: DuckDBPyType, connection: DuckDBPyConnection = ...) -> DuckDBPyType: ...
