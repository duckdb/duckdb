...
class DuckDBPyConnection:
    ...
    @overload
    def df(self, date_as_object: bool) -> pandas.DataFrame: ...
    @overload
    ...
    def fetch_df(self, date_as_object: bool) -> pandas.DataFrame: ...
    def fetch_df_chunk(self, vectors_per_chunk: int = ..., date_as_object: bool) -> pandas.DataFrame: ...
    def fetch_record_batch(self, chunk_size: int = ...) -> pyarrow.lib.RecordBatchReader: ...
    def fetchmany(self, size: int = ...) -> list: ...
    def fetchall(self) -> list: ...
    def fetchdf(self, date_as_object: bool) -> pandas.DataFrame: ...
...
class DuckDBPyRelation:
    ...
    def query(self, *args, **kwargs) -> DuckDBPyRelation: ...
    ...
    def to_df(self, date_as_object: bool) -> pandas.DataFrame: ...
    @overload
...
class DuckDBPyResult:
    ...
    def fetch_arrow_table(self, chunk_size: int = ...) -> pyarrow.lib.Table: ...
    def fetch_df(self, date_as_object: bool) -> pandas.DataFrame: ...
    def fetch_df_chunk(self, num_of_vectors: int = ..., date_as_object: bool) -> pandas.DataFrame: ...
    def fetchall(self) -> list: ...
    def fetchdf(self, date_as_object: bool) -> pandas.DataFrame: ...
    def fetchnumpy(self) -> dict: ...
    def fetchmany(self, size: int = ...) -> list: ...
