...
class DuckDBPyConnection:
    ...
    def read_json(file_name: str, columns = dict[str,str]) -> DuckDBPyRelation: ...
...
def read_json(file_name: str, columns = dict[str,str], connection: DuckDBPyConnection = ...) -> DuckDBPyRelation: ...
