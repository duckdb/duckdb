...
class DuckDBPyConnection:
    ...
    def __enter__(self, database: str = ..., read_only: bool = ..., config: dict = ..., check_same_thread: bool = ...) -> DuckDBPyConnection: ...
...
def connect(database: str = ..., read_only: bool = ..., config: dict = ..., check_same_thread: bool = ...) -> DuckDBPyConnection: ...
