...
from typing import Any, ClassVar, Set, Optional, Tuple, Callable
...
class DuckDBPyConnection:
    ...
    def create_function(
        ...
        *,
        ...
        ] = PythonExceptionHandling.DEFAULT,
    ...
    def enum_type(
        self, name: str, type: DuckDBPyType, values: List[Any]
    ) -> DuckDBPyType: ...
    def decimal_type(self, width: int, scale: int) -> DuckDBPyType: ...
    def struct_type(
        self, fields: Union[Dict[str, DuckDBPyType], List[str]]
    ) -> DuckDBPyType: ...
    def row_type(
        self, fields: Union[Dict[str, DuckDBPyType], List[str]]
    ) -> DuckDBPyType: ...
    ...
    def executemany(
        self, query: object, parameters: object = None
    ) -> DuckDBPyConnection: ...
    def close(self) -> None: ...
    ...
    def fetch_record_batch(
        self, rows_per_batch: int = 1000000
    ...
    def append(
        self, table_name: str, df: pandas.DataFrame, *, by_name: bool = False
    ) -> DuckDBPyConnection: ...
    ...
    def table_function(
        self, name: str, parameters: object = None
    ) -> DuckDBPyRelation: ...
    def read_json(
        self,
        name: str,
    ...
    def sql(
        self, query: str, *, alias: str = "", params: object = None
    ) -> DuckDBPyRelation: ...
    def query(
        self, query: str, *, alias: str = "", params: object = None
    ) -> DuckDBPyRelation: ...
...
class DuckDBPyRelation:
    ...
    def cume_dist(
        self, window_spec: str, projected_columns: str = ...
    ) -> DuckDBPyRelation: ...
    def dense_rank(
        self, window_spec: str, projected_columns: str = ...
    ) -> DuckDBPyRelation: ...
    ...
    def mode(
        self, aggregation_columns: str, group_columns: str = ...
    ) -> DuckDBPyRelation: ...
    def n_tile(
        self, window_spec: str, num_buckets: int, projected_columns: str = ...
    ) -> DuckDBPyRelation: ...
    def quantile_cont(
        self,
        column: str,
    ...
    def df(self, *args: Any, **kwargs: Any) -> pandas.DataFrame: ...
    def distinct(self) -> DuckDBPyRelation: ...
    def except_(self, other_rel: DuckDBPyRelation) -> DuckDBPyRelation: ...
    def execute(self, *args: Any, **kwargs: Any) -> DuckDBPyRelation: ...
    def explain(
        self, type: Optional[Literal["standard", "analyze"] | int] = "standard"
    ) -> str: ...
    def fetchall(self) -> List[Any]: ...
    def fetchmany(self, size: int = ...) -> List[Any]: ...
    def fetchnumpy(self) -> Dict[str, np.ndarray]: ...
    def fetchone(self) -> Optional[tuple[Any]]: ...
    def fetchdf(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def join(
        self, other_rel: DuckDBPyRelation, condition: str, how: str = ...
    ) -> DuckDBPyRelation: ...
    def limit(self, n: int, offset: int = ...) -> DuckDBPyRelation: ...
    def map(
        self,
        map_function: FunctionType,
        schema: Optional[Dict[str, DuckDBPyType]] = None,
    ) -> DuckDBPyRelation: ...
    ...
    def pl(
        self, rows_per_batch: int = ..., connection: DuckDBPyConnection = ...
    ) -> polars.DataFrame: ...
    ...
    def select_types(
        self, types: List[Union[str, DuckDBPyType]]
    ) -> DuckDBPyRelation: ...
    def select_dtypes(
        self, types: List[Union[str, DuckDBPyType]]
    ) -> DuckDBPyRelation: ...
    ...
    def to_df(self, *args: Any, **kwargs: Any) -> pandas.DataFrame: ...
    def to_parquet(self, file_name: str, compression: Optional[str] = None) -> None: ...
    def fetch_df_chunk(
        self, vectors_per_chunk: int = 1, *, date_as_object: bool = False
    ) -> pandas.DataFrame: ...
    def to_table(self, table_name: str) -> None: ...
    def to_view(self, view_name: str, replace: bool = ...) -> DuckDBPyRelation: ...
    def torch(self, connection: DuckDBPyConnection = ...) -> Dict[str, Any]: ...
    def tf(self, connection: DuckDBPyConnection = ...) -> Dict[str, Any]: ...
    ...
    def write_parquet(
        ...
        file_name: str,
        compression: Optional[str] = None,
        field_ids: Optional[Dict[str, Any] | str] = None,
...
class token_type:
    ...
    __entries: ClassVar[Dict[str, Any]] = ...
...
def connect(
    database: str = ..., read_only: bool = ..., config: dict = ...
) -> DuckDBPyConnection: ...
...
def list_filesystems(*, connection: DuckDBPyConnection) -> List[str]: ...
...
def array_type(
    type: DuckDBPyType, size: int, *, connection: DuckDBPyConnection
) -> DuckDBPyType: ...
def list_type(
    type: DuckDBPyType, *, connection: DuckDBPyConnection
) -> DuckDBPyType: ...
def union_type(
    members: DuckDBPyType, *, connection: DuckDBPyConnection
) -> DuckDBPyType: ...
def string_type(
    collation: str = "", *, connection: DuckDBPyConnection
) -> DuckDBPyType: ...
def enum_type(
    name: str, type: DuckDBPyType, values: List[Any], *, connection: DuckDBPyConnection
) -> DuckDBPyType: ...
def decimal_type(
    width: int, scale: int, *, connection: DuckDBPyConnection
) -> DuckDBPyType: ...
def struct_type(
...
def map_type(
    key: DuckDBPyType, value: DuckDBPyType, *, connection: DuckDBPyConnection
) -> DuckDBPyType: ...
...
def fetchone(*, connection: DuckDBPyConnection) -> Optional[tuple[Any]]: ...
def fetchmany(size: int = 1, *, connection: DuckDBPyConnection) -> List[Any]: ...
def fetchall(*, connection: DuckDBPyConnection) -> List[Any]: ...
def fetchnumpy(*, connection: DuckDBPyConnection) -> Dict[str, np.ndarray]: ...
def fetchdf(
    *, date_as_object: bool = False, connection: DuckDBPyConnection
) -> pandas.DataFrame: ...
def fetch_df(
    *, date_as_object: bool = False, connection: DuckDBPyConnection
) -> pandas.DataFrame: ...
...
def torch(*, connection: DuckDBPyConnection) -> Dict[str, Any]: ...
def tf(*, connection: DuckDBPyConnection) -> Dict[str, Any]: ...
...
def register(
    view_name: str, python_object: object, *, connection: DuckDBPyConnection
) -> DuckDBPyConnection: ...
def unregister(
    view_name: str, *, connection: DuckDBPyConnection
) -> DuckDBPyConnection: ...
...
def values(
    values: List[Any], *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def table_function(
...
def extract_statements(
    query: str, *, connection: DuckDBPyConnection
) -> List[Statement]: ...
def sql(
    query: str,
    *,
...
def from_df(
    df: pandas.DataFrame, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def from_arrow(
    arrow_object: object, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def from_parquet(
    file_glob: str,
    binary_as_string: bool = False,
...
def from_substrait(
    proto: str, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def get_substrait(
    query: str, *, enable_optimizer: bool = True, connection: DuckDBPyConnection
) -> str: ...
def get_substrait_json(
    query: str, *, enable_optimizer: bool = True, connection: DuckDBPyConnection
) -> str: ...
def from_substrait_json(
    json: str, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def get_table_names(query: str, *, connection: DuckDBPyConnection) -> List[str]: ...
def install_extension(
    extension: str, *, force_install: bool = False, connection: DuckDBPyConnection
) -> None: ...
def load_extension(extension: str, *, connection: DuckDBPyConnection) -> None: ...
def project(
    df: pandas.DataFrame, project_expr: str, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def distinct(
    df: pandas.DataFrame, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def write_csv(
    df: pandas.DataFrame, *args: Any, connection: DuckDBPyConnection
) -> None: ...
def aggregate(
    df: pandas.DataFrame,
    aggr_expr: str,
...
def alias(
    df: pandas.DataFrame, alias: str, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def filter(
    df: pandas.DataFrame, filter_expr: str, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def limit(
    df: pandas.DataFrame, n: int, offset: int = 0, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def order(
    df: pandas.DataFrame, order_expr: str, *, connection: DuckDBPyConnection
) -> DuckDBPyRelation: ...
def query_df(
    df: pandas.DataFrame,
