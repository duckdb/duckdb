...
class DuckDBPyConnection:
    ...
    def unregister_function(self, name: str) -> DuckDBPyConnection: ...
    def register_scalar(
        self,
        name: str,
        func: Callable,
...
def unregister_function(name: str, connection : DuckDBPyConnection = ...) -> DuckDBPyConnection: ...
def register_scalar(
    name: str,
    func: Callable,
    args: Optional[List[DuckDBPyType]],
