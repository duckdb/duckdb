...
class DuckDBPyConnection:
    ...
    def arrow(self, approx_rows_per_batch: int = ...) -> pyarrow.lib.Table: ...
    ...
    def fetch_arrow_table(self, approx_rows_per_batch: int = ...) -> pyarrow.lib.Table: ...
    def fetch_df(self, *args, **kwargs) -> pandas.DataFrame: ...
    def fetch_df_chunk(self, *args, **kwargs) -> pandas.DataFrame: ...
    def fetch_record_batch(self, approx_rows_per_batch: int = ...) -> pyarrow.lib.RecordBatchReader: ...
    ...
    def pl(self, approx_rows_per_batch: int = ..., connection: DuckDBPyConnection = ...) -> polars.DataFrame: ...
...
def arrow(approx_rows_per_batch: int = ..., connection: DuckDBPyConnection = ...) -> pyarrow.lib.Table: ...
...
def fetch_arrow_table(approx_rows_per_batch: int = ..., connection: DuckDBPyConnection = ...) -> pyarrow.lib.Table: ...
...
def fetch_record_batch(approx_rows_per_batch: int = ..., connection: DuckDBPyConnection = ...) -> pyarrow.lib.RecordBatchReader: ...
...
def pl(approx_rows_per_batch: int = ..., connection: DuckDBPyConnection = ...) -> polars.DataFrame: ...
