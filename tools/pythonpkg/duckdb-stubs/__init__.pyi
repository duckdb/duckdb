...
class DuckDBPyConnection:
    ...
    def create_function(self, name: str, function: function, parameters: Optional[List[DuckDBPyType]] = None, return_type: Optional[DuckDBPyType] = None, **kwargs) -> DuckDBPyConnection: ...
    ...
    def fetchdf(self, **kwargs) -> pandas.DataFrame: ...
    def fetch_df(self, **kwargs) -> pandas.DataFrame: ...
    def df(self, **kwargs) -> pandas.DataFrame: ...
    def fetch_df_chunk(self, vectors_per_chunk: int = 1, **kwargs) -> pandas.DataFrame: ...
    ...
    def append(self, table_name: str, df: pandas.DataFrame, **kwargs) -> DuckDBPyConnection: ...
    ...
    def read_json(self, name: str, **kwargs) -> DuckDBPyRelation: ...
    ...
    def read_csv(self, path_or_buffer: Union[str, StringIO, TextIOBase], **kwargs) -> DuckDBPyRelation: ...
    ...
    def from_parquet(self, file_glob: str, binary_as_string: bool = False, **kwargs) -> DuckDBPyRelation: ...
    ...
    def get_substrait(self, query: str, **kwargs) -> str: ...
    def get_substrait_json(self, query: str, **kwargs) -> str: ...
    def from_substrait_json(self, json: str) -> DuckDBPyRelation: ...
    def get_table_names(self, query: str) -> List[str]: ...
    def install_extension(self, extension: str, **kwargs) -> None: ...
...
def cursor(**kwargs) -> DuckDBPyConnection: ...
def register_filesystem(filesystem: str, **kwargs) -> None: ...
def unregister_filesystem(name: str, **kwargs) -> None: ...
def list_filesystems(**kwargs) -> list: ...
def filesystem_is_registered(name: str, **kwargs) -> bool: ...
def create_function(name: str, function: function, parameters: Optional[List[DuckDBPyType]] = None, return_type: Optional[DuckDBPyType] = None, **kwargs) -> DuckDBPyConnection: ...
def remove_function(name: str, **kwargs) -> DuckDBPyConnection: ...
def sqltype(type_str: str, **kwargs) -> DuckDBPyType: ...
def dtype(type_str: str, **kwargs) -> DuckDBPyType: ...
def type(type_str: str, **kwargs) -> DuckDBPyType: ...
def array_type(type: DuckDBPyType, size: int, **kwargs) -> DuckDBPyType: ...
def list_type(type: DuckDBPyType, **kwargs) -> DuckDBPyType: ...
def union_type(members: DuckDBPyType, **kwargs) -> DuckDBPyType: ...
def string_type(collation: str = "", **kwargs) -> DuckDBPyType: ...
def enum_type(name: str, type: DuckDBPyType, values: List[Any], **kwargs) -> DuckDBPyType: ...
def decimal_type(width: int, scale: int, **kwargs) -> DuckDBPyType: ...
def struct_type(fields: Union[Dict[str, DuckDBPyType], List[str]], **kwargs) -> DuckDBPyType: ...
def row_type(fields: Union[Dict[str, DuckDBPyType], List[str]], **kwargs) -> DuckDBPyType: ...
def map_type(key: DuckDBPyType, value: DuckDBPyType, **kwargs) -> DuckDBPyType: ...
def duplicate(**kwargs) -> DuckDBPyConnection: ...
def execute(query: object, parameters: object = None, multiple_parameter_sets: bool = False, **kwargs) -> DuckDBPyConnection: ...
def executemany(query: object, parameters: object = None, **kwargs) -> DuckDBPyConnection: ...
def close(**kwargs) -> None: ...
def interrupt(**kwargs) -> None: ...
def fetchone(**kwargs) -> Optional[tuple]: ...
def fetchmany(size: int = 1, **kwargs) -> List[Any]: ...
def fetchall(**kwargs) -> List[Any]: ...
def fetchnumpy(**kwargs) -> dict: ...
def fetchdf(**kwargs) -> pandas.DataFrame: ...
def fetch_df(**kwargs) -> pandas.DataFrame: ...
def df(**kwargs) -> pandas.DataFrame: ...
def fetch_df_chunk(vectors_per_chunk: int = 1, **kwargs) -> pandas.DataFrame: ...
def pl(rows_per_batch: int = 1000000, **kwargs) -> polars.DataFrame: ...
def fetch_arrow_table(rows_per_batch: int = 1000000, **kwargs) -> pyarrow.lib.Table: ...
def arrow(rows_per_batch: int = 1000000, **kwargs) -> pyarrow.lib.Table: ...
def fetch_record_batch(rows_per_batch: int = 1000000, **kwargs) -> pyarrow.lib.RecordBatchReader: ...
def torch(**kwargs) -> dict: ...
def tf(**kwargs) -> dict: ...
def begin(**kwargs) -> DuckDBPyConnection: ...
...
def table_function(name: str, parameters: object = None, **kwargs) -> DuckDBPyRelation: ...
def read_json(name: str, **kwargs) -> DuckDBPyRelation: ...
def extract_statements(query: str, **kwargs) -> List[Statement]: ...
def sql(query: str, **kwargs) -> DuckDBPyRelation: ...
...
def get_substrait(query: str, **kwargs) -> str: ...
def get_substrait_json(query: str, **kwargs) -> str: ...
def from_substrait_json(json: str, **kwargs) -> DuckDBPyRelation: ...
def get_table_names(query: str, **kwargs) -> List[str]: ...
def install_extension(extension: str, **kwargs) -> None: ...
def load_extension(extension: str, **kwargs) -> None: ...
def project(df: pandas.DataFrame, project_expr: str, **kwargs) -> DuckDBPyRelation: ...
def distinct(df: pandas.DataFrame, **kwargs) -> DuckDBPyRelation: ...
def write_csv(df: pandas.DataFrame, *args: Any, **kwargs) -> None: ...
def aggregate(df: pandas.DataFrame, aggr_expr: str, group_expr: str = "", **kwargs) -> DuckDBPyRelation: ...
...
def description(**kwargs) -> Optional[List[Any]]: ...
def rowcount(**kwargs) -> int: ...
