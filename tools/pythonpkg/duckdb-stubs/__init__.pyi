...
class DuckDBPyConnection:
    ...
    def install_extension(self, extension: str, force_install: bool = ...) -> None: ...
...
def install_extension(extension: str, force_install: bool = ..., connection: DuckDBPyConnection = ...) -> None: ...
