...
class DuckDBPyRelation:
    ...
    def fetch_arrow_reader(self, batch_size: int = ...) -> object: ...
    def fetch_arrow_table(self, batch_size: int = ...) -> object: ...
    def fetch_df(self) -> object: ...
...
class DuckDBPyResult:
    ...
    def fetch_arrow_table(self, chunk_size: int = ...) -> object: ...
    def fetch_df(self) -> object: ...
    def fetch_df_chunk(self, num_of_vectors: int = ...) -> object: ...
    def fetchall(self) -> list: ...
    def fetchdf(self) -> object: ...
    def fetchnumpy(self) -> dict: ...
    def fetchone(self) -> object: ...
    def record_batch(self, approx_batch_size: int) -> object: ...
    def to_arrow_table(self, chunk_size: int = ...) -> object: ...
    def to_df(self) -> object: ...
