...
class DuckDBPyConnection:
    ...
    def fetchdf(self, *, date_as_object: bool = False, prefer_nullable_dtypes: bool = False) -> pandas.DataFrame: ...
    def fetch_df(self, *, date_as_object: bool = False, prefer_nullable_dtypes: bool = False) -> pandas.DataFrame: ...
    def df(self, *, date_as_object: bool = False, prefer_nullable_dtypes: bool = False) -> pandas.DataFrame: ...
    def fetch_df_chunk(self, vectors_per_chunk: int = 1, *, date_as_object: bool = False, prefer_nullable_dtypes: bool = False) -> pandas.DataFrame: ...
...
def fetchdf(*, date_as_object: bool = False, prefer_nullable_dtypes: bool = False, connection: DuckDBPyConnection = ...) -> pandas.DataFrame: ...
def fetch_df(*, date_as_object: bool = False, prefer_nullable_dtypes: bool = False, connection: DuckDBPyConnection = ...) -> pandas.DataFrame: ...
def df(*, date_as_object: bool = False, prefer_nullable_dtypes: bool = False, connection: DuckDBPyConnection = ...) -> pandas.DataFrame: ...
def fetch_df_chunk(vectors_per_chunk: int = 1, *, date_as_object: bool = False, prefer_nullable_dtypes: bool = False, connection: DuckDBPyConnection = ...) -> pandas.DataFrame: ...
