...
class TestPandasNA(object):
    def test_pandas_na(self, duckdb_cursor):
        ...
        nan_df = pd.DataFrame({'a': [1.123, 5.23234, np.NaN, 7234.0000124, 0.000000124, 0000000000000.0000001, np.NaN, -2342349234.00934580345]})
        na_df = pd.DataFrame({'a': [1.123, 5.23234, pd.NA, 7234.0000124, 0.000000124, 0000000000000.0000001, pd.NA, -2342349234.00934580345]})
