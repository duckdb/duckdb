...
class TestFetchNested(object):
    ...
    def test_map_df(self,duckdb_cursor):
        ...
        with pytest.raises(RuntimeError, match="Invalid Input Error: Map keys have to be unique"):
        ...
        with pytest.raises(RuntimeError, match="Invalid Input Error: Map keys can not be NULL"):
