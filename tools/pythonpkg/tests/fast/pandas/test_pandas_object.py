...
class TestPandasObject(object):
    ...
    def test_2499(self, duckdb_cursor):  
        df = pd.DataFrame([[array([{'a': 0.881040697801939}, {'a': 0.9922600577751953},
                       {'a': 0.1589674833259317}, {'a': 0.8928451262745073},
                       {'a': 0.07022897889168278}], dtype=object)           ],
               [array([{'a': 0.8759413504156746}, {'a': 0.055784331256246156},
                       {'a': 0.8605151517439655}, {'a': 0.40807139339337695},
                       {'a': 0.8429048322459952}], dtype=object)              ],
               [array([{'a': 0.9697093934032401}, {'a': 0.9529257667149468},
                       {'a': 0.21398182248591713}, {'a': 0.6328512122275955},
                       {'a': 0.5146953214092728}], dtype=object)             ]], columns=['col'])
