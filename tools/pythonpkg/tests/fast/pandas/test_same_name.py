...
class TestMultipleColumnsSameName(object):
    ...
    def test_multiple_columns_with_same_name_relation(self, duckdb_cursor):
        ...
        with pytest.raises(duckdb.InvalidInputException):
            rel.query("df_view","DESCRIBE df_view;").fetchall()
        assert(rel.describe().fetchall() == [('a', 'BIGINT', 'YES', None, None, None), ('a_1', 'BIGINT', 'YES', None, None, None), ('d', 'BIGINT', 'YES', None, None, None)])
