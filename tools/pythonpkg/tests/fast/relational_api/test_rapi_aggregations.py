...
class TestRAPIAggregations(object):
    ...
    def test_unique(self, table):
        aggregation_generic(
            ...
            [
                [(1,), (2,), (None,)],
                [(1, Decimal('2.10')), (2, Decimal('3.20')), (None, None)],
                [('a',), ('b',), (None,)],
            ],
        )
    ...
    def test_abs(self, table):
        aggregation_generic(
            table.abs, [[(1,), (2,), (None,)], [(1, Decimal('2.10')), (2, Decimal('3.20')), (None, None)]]
        )
    ...
    def test_skew(self, duckdb_cursor, table):
        ...
        munge_compare(
            rel.skew('k,v,v2').execute().fetchall(), [(-3.316624790355393, -0.16344366935199223, 0.3654008511025841)]
        )
    ...
    def test_kurt(self, duckdb_cursor, table):
        ...
        rel = duckdb_cursor.table('aggr')
        munge_compare(
            rel.kurt('k,v,v2').execute().fetchall(), [(10.99999999999836, -1.9614277138467147, -1.445119691585509)]
        )
        duckdb_cursor.execute("drop table aggr")

    def test_cum_sum(self, table):
        aggregation_generic(
            table.cumsum, [[(1,), (3,), (3,)], [(1, Decimal('2.10')), (3, Decimal('5.30')), (3, Decimal('5.30'))]]
        )

    def test_cum_prod(self, table):
        aggregation_generic(
            table.cumprod, [[(1.0,), (2.0,), (2.0,)], [(1.0, 2.1), (2.0, 6.720000000000001), (2.0, 6.720000000000001)]]
        )
    ...
    def test_cum_max(self, table):
        aggregation_generic(
            ...
            [
                [(1,), (2,), (2,)],
                [(1, Decimal('2.10')), (2, Decimal('3.20')), (2, Decimal('3.20'))],
                [('a',), ('b',), ('b',)],
            ],
        )
    ...
    def test_cum_min(self, table):
        aggregation_generic(
            ...
            [
                [(1,), (1,), (1,)],
                [(1, Decimal('2.10')), (1, Decimal('2.10')), (1, Decimal('2.10'))],
                [('a',), ('a',), ('a',)],
            ],
        )
