...
@pytest.mark.xfail(reason="Ibis Consumption: pop from an empty deque")
...
@pytest.mark.xfail(reason="Ibis Consumption: 'is_not_distinct_from'")
...
@pytest.mark.xfail(reason="Ibis Consumption: Arguments with datatype !int32 and !string are not comparable")
...
@pytest.mark.xfail(reason="ValueError: Ibis Consumption: pop from an empty deque")
...
@pytest.mark.xfail(reason="Arguments with datatype !int32 and string are not comparable")
